...
export async function GET(req: Request) {
  ...
  const dims: [string, string, string[], (r: any) => Row][] = [
    ...
    ['noc_categories', 'noc_categories', ['broad', 'mid', 'fine', 'teer', 'mid_en', 'mid_ko', 'fine_en', 'fine_ko'],
      (r) => ({ broad: r.broad, mid: r.mid, fine: r.fine, teer: r.teer, mid_en: r.midEn, mid_ko: r.midKo, fine_en: r.fineEn, fine_ko: r.fineKo })],

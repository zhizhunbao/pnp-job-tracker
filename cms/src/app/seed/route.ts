...
export async function GET(req: Request) {
  ...
  const dims: [string, string, string[], (r: any) => Row][] = [
    ...
    ['designated_employers', 'designated_employers', ['name', 'province', 'location', 'is_tech', 'source', 'nocs'],
      (r) => ({ name: r.name, province: r.province, location: r.location, is_tech: r.isTech, source: r.source, nocs: r.nocs ?? '' })],

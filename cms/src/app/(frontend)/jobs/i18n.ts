...
const zh: Dict = {
  ...
  'ps.extraN': '{n} 项',
  'ps.back': '返回', 'ps.q.multi': '以下哪些符合你的情况?', 'ps.q.multiHint': '可多选，也可以都不选', 'ps.finish': '完成',
...
const en: Dict = {
  ...
  'ps.extraN': '{n} items',
  'ps.back': 'Back', 'ps.q.multi': 'Which of these apply to you?', 'ps.q.multiHint': 'Select any that apply, or none', 'ps.finish': 'Finish',
...
const ko: Dict = {
  ...
  'ps.extraN': '{n}개',
  'ps.back': '뒤로', 'ps.q.multi': '해당되는 항목을 모두 선택하세요', 'ps.q.multiHint': '해당 없으면 선택하지 않아도 됩니다', 'ps.finish': '완료',

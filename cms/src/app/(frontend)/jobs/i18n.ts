...
const zh: Dict = {
  ...
  'sl.needProv': '先选目标省份,可以多选', 'sl.pickProv': '选目标省份', 'sl.editProv': '改省份', 'sl.date': '抽选日', 'sl.stream': '通道', 'sl.cutoff': '分数线', 'sl.you': '你', 'sl.cutoffN': '分数线 {n}',
...
const en: Dict = {
  ...
  'sl.needProv': 'Pick your target provinces first, more than one is fine', 'sl.pickProv': 'Pick provinces', 'sl.editProv': 'Change', 'sl.date': 'Draw date', 'sl.stream': 'Stream', 'sl.cutoff': 'Cutoff', 'sl.you': 'You', 'sl.cutoffN': 'Cutoff {n}',
...
const ko: Dict = {
  ...
  'sl.needProv': '목표 주를 먼저 선택하세요. 복수 선택 가능', 'sl.pickProv': '목표 주 선택', 'sl.editProv': '변경', 'sl.date': '선발일', 'sl.stream': '스트림', 'sl.cutoff': '커트라인', 'sl.you': '나', 'sl.cutoffN': '커트라인 {n}',

...
const zh: Dict = {
  ...
  'dp.occCompNote': '在招与新增来自本站每日抓取的职位库;平均在招天数 = 岗位挂出到撤下的天数,越短越抢手;名额竞争是省级数,与职业无关', 'dp.compStudy': '学签持有', 'dp.compWork': '工签持有', 'dp.compFlowP': '截至 {p} 累计', 'dp.authGate': '注册后答案自动存档',
...
const en: Dict = {
  ...
  'dp.occCompNote': 'Openings and new postings come from our daily job crawl. Average days open is how long a posting stays up — shorter means tighter. Nomination competition is a province-level figure, not occupation-specific', 'dp.compStudy': 'Study permits', 'dp.compWork': 'Work permits', 'dp.compFlowP': 'YTD to {p}', 'dp.authGate': 'Sign up to save your answers',
...
const ko: Dict = {
  ...
  'dp.occCompNote': '공고 수와 신규는 매일 수집한 채용 데이터 기준. 평균 게시 일수는 공고가 내려가기까지의 일수로 짧을수록 경쟁이 치열. 지명 경쟁은 주 단위 수치로 직업과 무관', 'dp.compStudy': '학생비자', 'dp.compWork': '취업비자', 'dp.compFlowP': '{p}까지 누적', 'dp.authGate': '가입하면 답변이 자동 저장됩니다',

...
const zh: Dict = {
  ...
  'rm.btn': '简历对照', 'rm.eyebrow': 'AI 工具', 'rm.title': '简历对照这个岗',
  ...
  'rm.note': '简历不保存,对照完即弃。免费每天 3 次', 'rm.tooShort': '简历文本太短,贴完整一些',
...
const en: Dict = {
  ...
  'rm.btn': 'Resume match', 'rm.eyebrow': 'AI tool', 'rm.title': 'Match my resume to this job',
  ...
  'rm.note': 'Your resume is never stored. Free 3 times a day', 'rm.tooShort': 'Resume text too short, paste more',
...
const ko: Dict = {
  ...
  'rm.btn': '이력서 대조', 'rm.eyebrow': 'AI 도구', 'rm.title': '이 공고와 이력서 대조',
  ...
  'rm.note': '이력서는 저장되지 않음. 무료 하루 3회', 'rm.tooShort': '이력서 텍스트가 너무 짧음',

...
const zh: Dict = {
  ...
  'plan.pr.title': '拿 PR 评估', 'plan.pr.sub': '答 4 道基本题,出你的粗版报告;答案随时可改,报告立刻重算',
  ...
  'plan.toReport': '出报告', 'plan.back': '改答案', 'plan.answered': '已答 {n}/4',
...
const en: Dict = {
  ...
  'plan.pr.title': 'PR assessment', 'plan.pr.sub': 'Answer 4 basic questions for a first-pass report; change any answer and it recomputes instantly',
  ...
  'plan.toReport': 'See my report', 'plan.back': 'Change answers', 'plan.answered': '{n}/4 answered',
...
const ko: Dict = {
  ...
  'plan.pr.title': 'PR 평가', 'plan.pr.sub': '기본 4문항에 답하면 1차 보고서가 나옵니다. 답을 바꾸면 즉시 다시 계산됩니다',
  ...
  'plan.toReport': '보고서 보기', 'plan.back': '답 수정', 'plan.answered': '{n}/4 답변',

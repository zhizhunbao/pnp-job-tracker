...
const zh: Dict = {
  ...
  'rpt.s.alt.band': '改选 {prov}:自算至少 {total} 分;该省近 {n} 次抽选线 {lo}–{hi} 分',
...
const en: Dict = {
  ...
  'rpt.s.alt.band': 'Switch to {prov}: at least {total}; its last {n} draws cut off at {lo}–{hi}',
...
const ko: Dict = {
  ...
  'rpt.s.alt.band': '{prov}로 변경: 최소 {total}점; 최근 {n}회 커트라인 {lo}–{hi}점',

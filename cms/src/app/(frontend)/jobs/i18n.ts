...
const zh: Dict = {
  ...
  'price.pA': '我的通道报告', 'price.pA.d': '按你的档案算哪个省够线、差多少分:AI 顾问带档案分析、跨省对比、全量「与我的匹配」',
...
const en: Dict = {
  ...
  'price.pA': 'My pathway report', 'price.pA.d': 'Which province you clear and by how many points: profile-aware AI advisor, province comparison, full "Match for me"',
...
const ko: Dict = {
  ...
  'price.pA': '내 이민 경로 리포트', 'price.pA.d': '어느 주에서 커트라인을 넘고 몇 점 부족한지: 프로필 기반 AI 상담, 주 간 비교, 전체 "나에게 맞는 공고"',

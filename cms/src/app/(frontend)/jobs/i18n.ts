...
const zh: Dict = {
  ...
  'dp.basicCount': '已答 {done}/{total}', 'dp.scoreCount': '估分 {done}/{total}',
  'dp.scoreEntry': '按官方分值表估分', 'dp.scoreEntryHint': '还有 {n} 题', 'dp.scoreStart': '开始估分',
  ...
  'ps.f.adaptDemand': '曼省需求', 'ps.f.adaptConnection': '曼省联系', 'ps.f.adaptRegional': '温尼伯以外定居', 'ps.f.risk': '风险评估',
  ...
  'tv.lockN': '{n} 条结论已锁',
  'tv.g.occ': '职业匹配', 'tv.g.emp': '雇主资质', 'tv.g.you': '省提名政策', 'tv.g.youCard': '省提名政策', 'tv.filled': '已填写',
  ...
  'tv.occ.teerCoarse': '本站初筛:TEER {teer} 未被排除', 'tv.occ.teerCoarseNo': '本站初筛:TEER {teer} 已被排除',
  ...
  'tv.f.employer': '雇主', 'tv.f.place': '地点', 'tv.f.noc': '职业代码', 'tv.f.teer': '技能等级',
...
const en: Dict = {
  ...
  'dp.basicCount': '{done}/{total} answered', 'dp.scoreCount': 'Score {done}/{total}',
  'dp.scoreEntry': 'Score against the official tables', 'dp.scoreEntryHint': '{n} questions left', 'dp.scoreStart': 'Start',
  ...
  'ps.f.adaptDemand': 'Manitoba demand', 'ps.f.adaptConnection': 'Manitoba connection', 'ps.f.adaptRegional': 'Outside Winnipeg', 'ps.f.risk': 'Risk assessment',
  ...
  'tv.g.occ': 'Occupation match', 'tv.g.emp': 'Employer eligibility', 'tv.g.you': 'Provincial policy', 'tv.g.youCard': 'Provincial policy', 'tv.filled': 'Provided',
  ...
  'tv.occ.teerCoarse': 'Site screen: TEER {teer} not ruled out', 'tv.occ.teerCoarseNo': 'Site screen: TEER {teer} ruled out',
  ...
  'tv.f.employer': 'Employer', 'tv.f.place': 'Location', 'tv.f.noc': 'NOC', 'tv.f.teer': 'Skill level',
...
const ko: Dict = {
  ...
  'dp.basicCount': '{done}/{total} 답변', 'dp.scoreCount': '점수 {done}/{total}',
  'dp.scoreEntry': '공식 점수표로 계산', 'dp.scoreEntryHint': '{n}문항 남음', 'dp.scoreStart': '시작',
  // 판정 코어 문구층(pv.*)
  ...
  'ps.f.adaptDemand': '매니토바 수요', 'ps.f.adaptConnection': '매니토바 연고', 'ps.f.adaptRegional': '위니펙 외 정착', 'ps.f.risk': '리스크 평가',
  ...
  'tv.lockN': '{n}개 결론 잠김',
  'tv.g.occ': '직업 적합성', 'tv.g.emp': '고용주 자격', 'tv.g.you': '주정부 정책', 'tv.g.youCard': '주정부 정책', 'tv.filled': '입력 완료',
  ...
  'tv.occ.teerCoarse': '사이트 1차 선별: TEER {teer} 미배제', 'tv.occ.teerCoarseNo': '사이트 1차 선별: TEER {teer} 배제',
  ...
  'tv.f.employer': '고용주', 'tv.f.place': '지역', 'tv.f.noc': 'NOC', 'tv.f.teer': '숙련 등급',

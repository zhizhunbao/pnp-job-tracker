...
const zh: Dict = {
  ...
  'plan.pdf': '存为 PDF', 'occ.cat.hot': '热门', 'plan.reset': '重置答题', 'plan.reset.ok': '确认重置',
...
const en: Dict = {
  ...
  'plan.pdf': 'Save as PDF', 'occ.cat.hot': 'Popular', 'plan.reset': 'Reset answers', 'plan.reset.ok': 'Confirm reset',
...
const ko: Dict = {
  ...
  'plan.pdf': 'PDF로 저장', 'occ.cat.hot': '인기', 'plan.reset': '답변 초기화', 'plan.reset.ok': '초기화 확인',

...
const zh: Dict = {
  ...
  'se.col.lmia': 'LMIA 获批(近两年)', 'se.myFilter': '按我的档案筛', 'se.export': '导出名单 CSV', 'rpt.emp.all': '在担保雇主页看全部', 'se.col.named': 'PNP 担保记录', 'se.pr': 'PR {n}', 'se.col.pr': '担保过 PR', 'se.col.namedJobs': '省清单岗',
...
const en: Dict = {
  ...
  'se.col.lmia': 'LMIA approved (2 yrs)', 'se.myFilter': 'Filter by my profile', 'se.export': 'Export CSV', 'rpt.emp.all': 'See all on the sponsor employers page', 'se.col.named': 'PNP sponsorship record', 'se.pr': 'PR {n}', 'se.col.pr': 'PR-support LMIAs', 'se.col.namedJobs': 'Provincial-list jobs',
...
const ko: Dict = {
  ...
  'se.col.lmia': 'LMIA 승인(2년)', 'se.myFilter': '내 프로필로 필터', 'se.export': 'CSV 내보내기', 'rpt.emp.all': '스폰서 고용주 페이지에서 전체 보기', 'se.col.named': 'PNP 스폰서 이력', 'se.pr': 'PR {n}', 'se.col.pr': 'PR 지원 LMIA', 'se.col.namedJobs': '주 목록 공고',

...
const zh: Dict = {
  ...
  'sl.title': '估分与抽选线', 'sl.sub': '你的分对照最近抽选', 'sl.check': '算我的分', 'sl.edit': '改答案',
  'sl.empty': '答完 {n} 道估分题看你够不够线', 'sl.noTable': '本站未收录该省的官方分值表',
  ...
  'sl.needProv': '先选目标省份,可以多选', 'sl.pickProv': '选目标省份', 'sl.needBasic': '答完上面的申请人条件后出你的分', 'sl.editProv': '改省份', 'sl.date': '抽选日', 'sl.stream': '通道', 'sl.cutoff': '分数线', 'sl.you': '你', 'sl.cutoffN': '分数线 {n}',
...
const en: Dict = {
  ...
  'sl.title': 'Score and draw cutoffs', 'sl.sub': 'Your score against recent draws', 'sl.check': 'Check my score', 'sl.edit': 'Edit answers',
  'sl.empty': 'Answer {n} questions to see whether you clear these cutoffs', 'sl.noTable': 'No official points grid on record for this province',
  ...
  'sl.needProv': 'Pick your target provinces first, more than one is fine', 'sl.pickProv': 'Pick provinces', 'sl.needBasic': 'Complete the applicant profile above to get your score', 'sl.editProv': 'Change', 'sl.date': 'Draw date', 'sl.stream': 'Stream', 'sl.cutoff': 'Cutoff', 'sl.you': 'You', 'sl.cutoffN': 'Cutoff {n}',
...
const ko: Dict = {
  ...
  'sl.title': '점수와 커트라인', 'sl.sub': '최근 선발 대비 내 점수', 'sl.check': '내 점수 계산', 'sl.edit': '답변 수정',
  'sl.empty': '{n}개 문항에 답하면 커트라인 통과 여부를 확인합니다', 'sl.noTable': '이 주의 공식 배점표는 아직 수집되지 않았습니다',
  ...
  'sl.needProv': '목표 주를 먼저 선택하세요. 복수 선택 가능', 'sl.pickProv': '목표 주 선택', 'sl.needBasic': '위의 신청인 조건을 완료하면 점수가 나옵니다', 'sl.editProv': '변경', 'sl.date': '선발일', 'sl.stream': '스트림', 'sl.cutoff': '커트라인', 'sl.you': '나', 'sl.cutoffN': '커트라인 {n}',

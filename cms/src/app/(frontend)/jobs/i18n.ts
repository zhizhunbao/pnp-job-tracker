...
const zh: Dict = {
  ...
  'loc.cityJobs': '该市就业市场', 'loc.openJobs': '在招职位', 'loc.new7d': '近 7 日新增', 'loc.medSal': '帖面中位年薪', 'loc.topBroads': '热门方向', 'loc.distOpen': '本区在招({d})',
...
const en: Dict = {
  ...
  'loc.cityJobs': 'City job market', 'loc.openJobs': 'Open jobs', 'loc.new7d': 'Posted in last 7 days', 'loc.medSal': 'Median posted salary', 'loc.topBroads': 'Top fields', 'loc.distOpen': 'Open in {d}',
...
const ko: Dict = {
  ...
  'loc.cityJobs': '해당 도시 채용 시장', 'loc.openJobs': '채용 중', 'loc.new7d': '최근 7일 게시', 'loc.medSal': '게시 급여 중위값(연봉)', 'loc.topBroads': '인기 분야', 'loc.distOpen': '{d} 채용 중',

...
const zh: Dict = {
  ...
  'fact.emp': '职位类型', 'fact.edu': '学历要求', 'fact.cert': '证书/执照',
  ...
  'loading': '更新中…',
  'nav.library': '资料库', 'nav.schoolsSoon': '学校名录(规划中)', 'tl.tabNews': '最新公告',
  ...
  'ss.save': '保存此筛选', 'ss.name': '给这个筛选起个名字:', 'ss.saved': '已保存;日更后有新命中会邮件提醒(账户页可管理)', 'ss.err': '保存失败(可能已达上限)', 'ss.pro': '免费可存 2 个筛选,Pro 可存 5 个', 'ss.title': '已保存的筛选(邮件提醒)', 'ss.none': '还没有保存的筛选 —— 在职位板设好筛选后点「保存此筛选」', 'ss.del': '删除', 'ss.note': 'Pro+已建档会自动收「命中我的路径」日报;保存筛选是额外的自定义提醒',
...
const en: Dict = {
  ...
  'fact.emp': 'Job type', 'fact.edu': 'Education', 'fact.cert': 'Certificates / licences',
  ...
  'loading': 'Updating…',
  'nav.library': 'Library', 'nav.schoolsSoon': 'School directory (planned)', 'tl.tabNews': 'Latest updates',
  ...
  'ss.save': 'Save this search', 'ss.name': 'Name this search:', 'ss.saved': 'Saved — you will get an email when new jobs match (manage on account page)', 'ss.err': 'Save failed (limit may be reached)', 'ss.pro': 'Free saves 2 searches — Pro saves 5', 'ss.title': 'Saved searches (email alerts)', 'ss.none': 'No saved searches yet — set filters on the job board and hit Save this search', 'ss.del': 'Delete', 'ss.note': 'Pro users with a profile also get a daily matches-my-path email; saved searches add custom alerts',
...
const ko: Dict = {
  ...
  'subtitle.proof': 'PNP 목록 해당 {named}건 · LMIA 기록 고용주 {lmia}곳 · 공식 공개 데이터',
  ...
  'chart.common': '주요 차트', 'chart.custom': '사용자 지정 차트', 'chart.dim': '차원', 'chart.metric': '지표', 'chart.dimProv': '주별', 'chart.dimCat': '직업 대분류별', 'chart.all': '전체', 'chart.medianNote': '중위값은 주 간 병합하지 않습니다 — 주를 선택해 대분류별 중위값을 확인하세요.',
  ...
  'term.permanent': '정규', 'term.term': '계약', 'term.casual': '임시', 'term.seasonal': '계절',
  'fact.emp': '고용 형태', 'fact.edu': '학력 요건', 'fact.cert': '자격증/면허',
  ...
  'cell.elig.no_sponsorship': '🚫 스폰서 없음 명시', 'cell.elig.pr_required': '🚫 시민권/PR 한정',
  'eligOnly': '스폰서 불가/PR 한정 제외', 'eligOnly.tip': 'JD에 「스폰서 불가」「시민권/PR 한정」이 명시된 공고 제외; 미검출≠스폰서 보장, 명시가 없을 뿐',
  'fact.elig': '비자 플래그', 'fact.eligQuote': 'JD 원문', 'fact.eligNote': 'JD 원문 기반 검출(정밀도 우선); 「—」=해당 표현 미검출이며 스폰서 제공을 뜻하지 않음',
  ...
  'col.actions': '작업', 'act.descTitle': '직무 설명', 'act.site': '웹사이트', 'act.addr': '주소', 'act.jobsHere': '이 회사의 공고', 'act.showAll': '나머지 {n}개 펼치기 ▾', 'act.noText': '이 공고의 본문이 아직 수집되지 않았습니다 — 신규 공고는 보통 다음날 도착하며 일부 소스는 제공하지 않습니다.', 'act.loadingText': '로딩 중…',
  'chart.back': '← 뒤로', 'chart.drillHint': '막대를 클릭하면 드릴다운', 'chart.jobsHint': '막대를 클릭하면 공고 보드로', 'nav.account': '계정', 'nav.acctTab': '내 계정',
  ...
  'advisor.loading': '⏳ 열심히 생각 중…',
  'advisor.failed': '생성 실패 ({code})',
  'advisor.offline': '네트워크 문제 — AI 판단을 일시적으로 사용할 수 없습니다. 위의 사실과 공식 링크는 영향 없음.',
  ...
  'advisor.sug.title': '이 공고, 고용주 오퍼 → 주정부 지명(PNP) 루트로 갈 때 가장 큰 함정은?', 'advisor.sug.company': '이 회사는 외국인 고용 이력이 있나요? 지원자 입장에서 믿을 만한가요?', 'advisor.sug.generic': '이 시그널이 제 주정부 지명에 어떤 의미인가요?',
  ...
  'acct.toReg': '계정이 없나요? 무료 가입 →', 'acct.toLogin': '계정이 있나요? 로그인 →',
  ...
  'match.r.lmia.skilled': '고용주가 최근 2년간 숙련 스트림(High Wage/GTS) 승인 LMIA 포지션 {n}건 보유(전체 스트림 {total}건, 최근 {q}, ESDC 공개 데이터) — 과거 사실이며 스폰서 보장이 아님',
  'match.r.lmia.lowOnly': '고용주의 최근 2년 승인 LMIA {n}건(최근 {q})은 전부 농업/저임금 스트림 — 대부분 계절성 고용으로 숙련 스폰서 근거가 약해 가점 없음',
  ...
  'prof.status': '지금 어떤 상황이신가요?',
  'prof.st.overseas': '아직 캐나다 밖',
  'prof.st.studying': '캐나다 유학 중',
  'prof.st.working': '취업 중(워크퍼밋)',
  'prof.st.jobhunting': '캐나다에서 구직 중',
  'prof.st.pr': 'PR / 구직만',
  'prof.noc': '어떤 일을 하고 싶으세요?',
  'prof.jobPopular': '인기 직업(탭하면 선택):',
  'prof.nocSearch': '없나요? 직업명으로 검색…',
  'prof.job.software': '소프트웨어 개발', 'prof.job.accountant': '회계', 'prof.job.nurse': '간호사', 'prof.job.psw': 'PSW / 요양보호',
  'prof.job.cook': '요리사', 'prof.job.truck': '트럭 운전', 'prof.job.electrician': '전기공', 'prof.job.welder': '용접공',
  'prof.job.ece': '유아교육', 'prof.job.retail': '소매 판매', 'prof.job.warehouse': '창고', 'prof.job.server': '식음료 서버',
  'prof.job.admin': '행정 보조', 'prof.job.cashier': '계산원',
  'prof.clb': '영어 수준은 대략?',
  'prof.clbOpt.basic': '초급(일상)', 'prof.clbOpt.mid': '중급(업무 가능)', 'prof.clbOpt.fluent': '유창', 'prof.clbOpt.high': '고득점(IELTS/CELPIP)',
  'prof.crs': 'EE(CRS) 점수를 계산해 봤나요?',
  ...
  // B4-01 디렉터리
  'dir.title': '고용주 디렉터리', 'dir.sub': '실제로 외국인을 고용한 고용주 — 전부 공식 공개 데이터',
  'dir.tab.lmia': 'LMIA 기록 고용주', 'dir.tab.aip': 'AIP 지정 고용주',
  ...
  'dir.occ.colStream': '스트림', 'dir.occ.colNoc': 'NOC', 'dir.occ.colName': '직업', 'dir.occ.fetched': '수집 {d}', 'dir.occ.src': '공식 리스트 ↗',
  'dir.bnAip': 'AIP 지정', 'dir.bnLmia': 'LMIA 기록', 'dir.bnOcc': '리스트 직업',
  // C6-01 타임라인
  'tl.title': '추첨·정책 타임라인', 'tl.sub': '주 추첨 + 연방 EE 추첨 + 공식 정책 공지를 한 타임라인으로',
  'tl.note': '기준: 전부 공식 출처의 과거 사실; 주 점수는 각 주 자체 척도(CRS 아님); 「주기」는 과거 통계일 뿐 다음 추첨 예측이 아닙니다.',
  ...
  'loading': '업데이트 중…',
  'nav.library': '자료실', 'nav.schoolsSoon': '학교 디렉터리(예정)', 'tl.tabNews': '최신 공지',
  ...
  'ob.resume.btn': '이력서 업로드로 자동 입력', 'ob.resume.hint': 'PDF/DOCX — 10초 만에 직업 방향 인식(원본 저장 안 함)',
  'ob.resume.busy': '분석 중… 약 10초', 'ob.resume.done': '직업 방향 {n}개 인식 — 다음 단계에 미리 입력됨',
  'ob.resume.fail': '분석 실패 — 직접 선택도 빠릅니다', 'ob.resume.scan': '텍스트를 읽을 수 없음(스캔본?) — 다른 파일 또는 직접 입력',
  'ob.resume.limit': '오늘의 분석 횟수 소진(하루 5회) — 내일 다시 또는 직접 입력', 'ob.resume.from': '이력서에서 인식됨:',
  'news.entry': '이민 소식',
  'news.title': '이민 정책 동향',
  'news.sub': '연방 IRCC 및 7개 주 공식 발표 모음 · 12시간마다 갱신 · 공식 출처만 수록',
  'news.federal': '연방 IRCC',
  'news.qcNote': '퀘벡은 자체 이민 체계를 운영합니다(PNP 아님)',
  'news.copy': '© {who} · 비공식 전재본 — 공식 원문을 기준으로 하세요',
  ...
  'news.empty': '아직 소식이 없습니다',
  'news.imp': '중요', 'news.topTitle': '주요 소식', 'news.watch': '관심', 'news.impN': '중요도 {n}/5',
  'news.aiSum': 'AI 요약', 'news.read': '전문 보기 →', 'news.cmt.n': '댓글 {n}',
  'news.cmt.title': '댓글 ({n})', 'news.cmt.login': '로그인 후 토론에 참여 →',
  'news.cmt.ph': '예의를 지켜주세요. 댓글은 검토 후 표시되며 광고·중개 유인은 삭제됩니다.',
  'news.cmt.send': '등록', 'news.cmt.sent': '제출됨 · 검토 후 표시됩니다', 'news.cmt.err': '등록 실패 — 잠시 후 다시 시도하세요',
  'news.zhOn': '중국어 대역 보기', 'news.zhOff': '중국어 대역 접기', 'news.aiNote': 'AI 번역 · 원문 기준', 'news.aiScore': '중요도는 구직/이민 독자에 대한 영향을 AI가 평가한 것으로 열람 참고용입니다',
  'news.trOn': '한국어 번역 보기', 'news.trOff': '한국어 번역 접기', 'news.trBusy': '번역 중… 약 15초', 'news.sumBusy': '요약 생성 중…', 'news.aiGen': 'AI 생성 · 원문 기준', 'news.trErr': '번역을 잠시 사용할 수 없습니다',
  'pw.entry': '이민 경로',
  'pw.title': '이민 경로',
  'pw.sub': '내 상황에 맞춰 정리한 경로 정보: 단계 · 내 신호 · 부족한 점과 보완 방법 — 모두 공식 출처 포함.',
  'pw.disc': '아래는 공개 정책 정보를 자가 보고 프로필과 대조한 것으로, 이민 자문이나 자격 판정이 아닙니다(본 사이트는 공인 컨설턴트가 아님). 정책은 수시로 바뀌니 공식 페이지를 기준으로 하세요.',
  'pw.forYou': '내 상황과 관련', 'pw.other': '기타 경로',
  'pw.loginCta': '로그인·프로필 작성 후 내 매칭과 부족한 점 보기 →', 'pw.buildCta': '프로필 완성 후 내 매칭과 부족한 점 보기 →',
  'pw.steps': '단계', 'pw.signals': '내 신호', 'pw.gaps': '부족한 점과 보완', 'pw.sources': '출처', 'pw.reviewed': '{d} 확인',
  'pw.direct.name': '바로 취업 · 고용주 지원 → 주정부 지명(유학 없이)',
  'pw.direct.s1': '본 사이트에서 「스폰서 신호」 공고 필터: 고용주 직접 게시 · 최근 2년 LMIA 승인 기록 · AIP 지정 고용주 · 주 공개 목록 해당 직업',
  'pw.direct.s2': '풀타임 오퍼 확보: 해외 지원자는 오퍼로 워크퍼밋 신청, 캐나다 체류자는 경력 축적(퍼밋 규정은 공식 페이지)',
  'pw.direct.s3': '목표 주의 주정부 지명 스트림에 지원 — 직업이 해당 주 공개 목록에 있는 것이 핵심 신호(주별 요건은 공식 페이지)',
  'pw.direct.s4': '지명 후 PR 신청; 연방 EE 카테고리 선발은 이와 별개의 병행 경로(공식 페이지 참조)',
  'pw.hcw.name': '홈케어 워커(낮은 문턱 경로)',
  'pw.hcw.s1': '목표 직업이 홈케어류인지 확인(NOC 44100 가정 보육 / 44101 가정 지원)',
  'pw.hcw.s2': 'Home Care Worker 이민 파일럿 요건 대조 — 언어/학력 문턱이 비교적 낮음; 정확한 기준은 공식 페이지',
  'pw.hcw.s3': '홈케어류 풀타임 오퍼 확보(본 사이트에서 필터 가능)',
  'pw.hcw.s4': '파일럿 요건에 따라 신청; 접수 상태·정원은 공식 페이지 기준',
  'pw.health.name': '보건의료 부족 직군 스트림(주별 전용)',
  'pw.health.s1': '규제 직종은 자격 인증부터: 간호사는 NNAS 평가 + 목표 주 간호협회 등록 필요 — 해외 면허만으로는 진료 불가',
  'pw.health.s2': '어학 시험: 스트림별 요건 상이 — 공식 인정 시험 페이지 참조',
  'pw.health.s3': '본 사이트에서 보건의료 부족 목록 해당 공고 필터(예: SK 보건 / NS 긴급 목록)',
  'pw.health.s4': '오퍼 확보 후 주정부 보건 스트림으로 지원 → PR',
  'pw.trades.name': '기능직 trades(자격 인증 경로)',
  'pw.trades.s1': '기능직 인증: 주별 견습/인증 체계(Red Seal이 주간 표준) — 요건은 공식 페이지',
  'pw.trades.s2': '본 사이트에서 trades 공고 필터(주 목록 해당 / EE trades 카테고리가 신호)',
  'pw.trades.s3': '오퍼 → 워크퍼밋 → 주정부 지명 → PR',
  'pw.sig.branchNoc': '내 목표 직업({noc})이 이 경로의 직군에 속함',
  'pw.sig.branchOther': '보고한 직업이 이 경로 직군 밖 — 아래 정보는 참고용',
  'pw.sig.named': '내 NOC {noc}이(가) {prov} 공개 목록 "{label}"에 있음',
  'pw.sig.excluded': '내 NOC {noc}이(가) {prov} 제외 목록 "{label}"에 있음',
  'pw.sig.noneNamed': '보고한 직업이 현재 어느 주 공개 목록에도 없음(목록은 변경됨; 공식 확인 필요)',
  'pw.sig.ee': '내 NOC {noc}은(는) 연방 EE 카테고리 "{cat}" — 최근 선발 커트라인 {draw}({date}); CRS 미보고',
  'pw.sig.eeAbove': '자가 보고 CRS {crs}, "{cat}" 최근 커트라인 {draw}({date})보다 {diff}점 높음',
  'pw.sig.eeBelow': '자가 보고 CRS {crs}, "{cat}" 최근 커트라인 {draw}({date})보다 {gap}점 낮음',
  'pw.gap.build': '프로필을 만들면 여기에 내 매칭과 부족한 점이 표시됨(직업/목표 주/언어, 2분 탭 선택)',
  'pw.gap.noNoc': '목표 직업 미보고 — 추가하면 주 목록·EE 카테고리와 대조 가능',
  'pw.gap.noProv': '목표 주 미선택 — 선택하면 주별 정보가 집중됨',
  'pw.gap.offerFirst': '해외 지원자의 1단계는 워크퍼밋을 뒷받침할 풀타임 오퍼 — 본 사이트에서 「스폰서 신호」 공고 필터 가능',
  'pw.gap.lang': '영어 수준 미보고 — 모든 스트림에 언어 요건이 있음; 인정 시험은 공식 페이지',
  'pw.gap.nnas': '간호사 진료는 NNAS 평가 + 주 간호협회 등록이 선행(해외 면허만으로는 불가) — 절차는 공식 페이지',
  'pw.gap.cert': '기능직 대부분 주 인증/견습 체계 필요(Red Seal이 주간 표준) — 요건은 공식 페이지',
  'pw.study.name': '유학 → PGWP → 주정부 지명(유학 경로)',
  'pw.study.s1': 'IRCC 명단에서 「PGWP 가능」 표시된 학교/프로그램 선택 — 모든 DLI가 해당되는 건 아님',
  'pw.study.s2': '학생비자로 입학·과정 이수(비자 요건은 공식 페이지)',
  'pw.study.s3': '졸업 후 PGWP 신청, 오픈 워크퍼밋으로 캐나다 경력 축적',
  'pw.study.s4': '경력이 쌓이면 CEC(연방) 또는 목표 주 졸업생 스트림으로 지원(주별 세칙은 공식 페이지)',
  'pw.aip-trades.name': '유학 → AIP 대서양(trades 실례)',
  'pw.aip.s1': '대서양 4주(NS/NB/PE/NL) 공립 학교에서 trades 등 디플로마 이수(학교는 공식 DLI 명단)',
  'pw.aip.s2': '졸업 후 AIP 「지정 고용주」 풀타임 오퍼 확보 — 본 사이트에서 필터 가능',
  'pw.aip.s3': '주 배서 + 언어/학력/정착 요건은 공식 페이지 기준 → PR 신청',
  'pw.sig.dliProv': '{prov}에 PGWP 가능 공립 학교 {n}곳(IRCC 공식 명단)',
  'pw.sig.dliTotal': '전국 PGWP 가능 공립 학교 {n}곳(IRCC 공식 명단); 목표 주 선택 시 주별 표시',
  'pw.sig.dliAtl': '대서양 4주에 PGWP 가능 공립 학교 {n}곳, {names} 등 포함',
  ...
  'price.plusFree': '무료 플랜 전체 포함, 추가:', 'price.same90': '30일권과 동일 기능, 90일간',
  ...
  'ss.save': '이 필터 저장', 'ss.name': '필터 이름:', 'ss.saved': '저장됨 — 새 공고가 매칭되면 이메일로 알립니다(계정 페이지에서 관리)', 'ss.err': '저장 실패(상한 도달 가능)', 'ss.pro': '무료는 필터 2개, Pro는 5개 저장', 'ss.title': '저장된 필터(이메일 알림)', 'ss.none': '저장된 필터가 없습니다 — 채용 보드에서 필터 설정 후 「이 필터 저장」', 'ss.del': '삭제', 'ss.note': '프로필이 있는 Pro는 「내 경로 매칭」 일일 메일도 받습니다. 저장 필터는 추가 맞춤 알림',

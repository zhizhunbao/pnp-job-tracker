...
const zh: Dict = {
  ...
  'dp.planAsk': '按我已经填写的条件，把最适合的 PR 路径拆成具体步骤和先后顺序。', 'dp.planAskCta': '查看详细行动方案',
  ...
  'dp.hookJobs': '看在招岗', 'dp.hookAdvisor': '问 AI 顾问',
  'dp.ask': '按我的条件,走雇主担保拿 PR 有哪些路?',
  'dp.toScore': '生成我的方案',
  ...
  'dp.cases': '常见处境', 'dp.caseAnswer': '看完整答案',
...
const en: Dict = {
  ...
  'dp.planAsk': 'Using the details I already provided, turn my best PR pathways into concrete steps in the right order.', 'dp.planAskCta': 'See detailed action plan',
  ...
  'dp.hookJobs': 'See open jobs', 'dp.hookAdvisor': 'Ask the AI advisor',
  'dp.ask': 'Given my details, what employer-sponsored paths to PR do I have?',
  ...
  'dp.cases': 'Common situations', 'dp.caseAnswer': 'See the full answer',
...
const ko: Dict = {
  ...
  'dp.planAsk': '제가 입력한 조건을 바탕으로 가장 적합한 PR 경로를 순서가 있는 구체적인 단계로 정리해 주세요.', 'dp.planAskCta': '상세 실행 계획 보기',
  ...
  'dp.hookJobs': '채용 공고 보기', 'dp.hookAdvisor': 'AI 상담사에게 묻기',
  'dp.ask': '제 조건으로 고용주 스폰서 영주권 경로가 어떤 게 있나요?',
  ...
  'dp.cases': '자주 있는 상황', 'dp.caseAnswer': '전체 답변 보기',

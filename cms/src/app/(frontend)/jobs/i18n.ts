...
const zh: Dict = {
  ...
  'quiz.browse': '进职位板',
  'loading': '更新中…',
  'nav.library': '资料库', 'nav.employers': '雇主', 'tl.tabNews': '最新公告',
...
const en: Dict = {
  ...
  'loading': 'Updating…',
  'nav.library': 'Library', 'nav.employers': 'Employers', 'tl.tabNews': 'Latest updates',
...
const ko: Dict = {
  ...
  'quiz.browse': '채용 보드로',
  'loading': '업데이트 중…',
  'nav.library': '자료실', 'nav.employers': '고용주', 'tl.tabNews': '최신 공지',

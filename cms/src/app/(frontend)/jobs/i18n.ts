...
const zh: Dict = {
  ...
  'plan.pdf': '存为 PDF', 'occ.cat.hot': '热门', 'plan.reset': '清空重填', 'plan.reset.ok': '确认清空',
...
const en: Dict = {
  ...
  'plan.pdf': 'Save as PDF', 'occ.cat.hot': 'Popular', 'plan.reset': 'Clear all', 'plan.reset.ok': 'Confirm clear',
...
const ko: Dict = {
  ...
  'plan.pdf': 'PDF로 저장', 'occ.cat.hot': '인기', 'plan.reset': '전체 지우기', 'plan.reset.ok': '지우기 확인',

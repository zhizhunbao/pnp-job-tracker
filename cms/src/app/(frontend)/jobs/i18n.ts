...
const zh: Dict = {
  ...
  'dp.occCompNote': '在招与新增来自本站每日抓取的职位库;平均在招天数 = 岗位挂出到撤下的天数,越短越抢手;名额竞争是省级数,与职业无关', 'dp.compFlowNote': '新发学签是当期流量,只看趋势不参与上面的比值;官方年末存量最新只到 2024-12', 'dp.compNoteShort': '名额竞争 = 该省临时居民存量 ÷ 省提名名额;临时居民来自 IRCC 开放数据,名额为本站人工核对表',
  'dp.compRatio': '名额竞争 {n}:1', 'dp.compNote': '名额竞争 = 该省临时居民存量 ÷ {year} 年省提名名额;临时居民来自 IRCC 开放数据,名额为本站人工核对表',
  ...
  'dp.federal': '联邦', 'dp.atlantic': '大西洋地区', 'dp.ruralCommunities': '参与试点的社区', 'dp.verifyJobTitle': '已有 offer 或看中的岗位？', 'dp.verifyJobHint': '再验证这份岗位、雇主和通道门槛；不影响上面的初步方案。', 'dp.verifyJob': '验证具体岗位',
  'dp.toScore': '生成我的方案',
  ...
  'ps.unscoredTitle': '其余所选省份', 'ps.unscoredHint': '{provs} 不在本页进行统一分数估算，但仍会参与你的路径方案。',
  ...
  'tv.occ.teerCoarse': 'TEER {teer} 未被排除', 'tv.occ.teerCoarseNo': 'TEER {teer} 已被排除',
  ...
  'tv.f.title': '职位名', 'tv.f.employer': '雇主', 'tv.f.place': '地点', 'tv.f.noc': '职业代码', 'tv.f.teer': '技能等级',
...
const en: Dict = {
  ...
  'dp.occCompNote': 'Openings and new postings come from our daily job crawl. Average days open is how long a posting stays up — shorter means tighter. Nomination competition is a province-level figure, not occupation-specific', 'dp.compFlowNote': 'New study permits are current-period inflow, shown for trend only and not used in the ratio. Official year-end stock is available only through 2024-12', 'dp.compNoteShort': 'Nomination competition = temporary residents ÷ nomination allocation. Residents come from IRCC open data; allocations are our manually verified table',
  'dp.compRatio': '{n}:1 per nomination', 'dp.compNote': 'Nomination competition = temporary residents ÷ the {year} nomination allocation. Residents from IRCC open data; allocations from our manually verified table',
  ...
  'dp.federal': 'Federal', 'dp.atlantic': 'Atlantic region', 'dp.ruralCommunities': 'Participating communities', 'dp.verifyJobTitle': 'Already have an offer or a job in mind?', 'dp.verifyJobHint': 'Verify that job, employer, and pathway requirements next. This does not block your initial plan above.', 'dp.verifyJob': 'Verify a specific job',
  ...
  'ps.unscoredTitle': 'Other selected provinces', 'ps.unscoredHint': '{provs} are not given a standardized score on this page, but remain included in your pathway plan.',
  ...
  'tv.occ.teerCoarse': 'TEER {teer} not ruled out', 'tv.occ.teerCoarseNo': 'TEER {teer} ruled out',
  ...
  'tv.emp.yearsHave': 'Operating {have} years', 'tv.emp.yearsNeed': '{prov} requires {need} years', 'tv.emp.yearsNa': '{prov} requires {need} years; founding year not on file',
  'tv.emp.staffHave': '{have} employees', 'tv.emp.staffNeed': '{prov} requires {need}', 'tv.emp.staffNa': '{prov} requires {need}; headcount not on file',
  ...
  'tv.f.title': 'Job title', 'tv.f.employer': 'Employer', 'tv.f.place': 'Location', 'tv.f.noc': 'Occupation code', 'tv.f.teer': 'Skill level',
  ...
  'tv.next.jobs': 'Jobs at this employer', 'tv.next.paths': 'All pathways',
  ...
  'tv.k.screen': 'Site pre-screen', 'tv.k.occList': 'Occupation list', 'tv.k.desig': 'Designated employer', 'tv.k.years': 'Years in business',
...
const ko: Dict = {
  ...
  'dp.occCompNote': '공고 수와 신규는 매일 수집한 채용 데이터 기준. 평균 게시 일수는 공고가 내려가기까지의 일수로 짧을수록 경쟁이 치열. 지명 경쟁은 주 단위 수치로 직업과 무관', 'dp.compFlowNote': '신규 학생비자는 당기 유입량으로 추세 참고용이며 위 비율에 포함되지 않습니다. 공식 연말 재고는 2024-12까지만 공개', 'dp.compNoteShort': '지명 경쟁 = 임시 거주자 ÷ 주 지명 쿼터. 거주자는 IRCC 공개 데이터, 쿼터는 본 사이트 수기 검증 표',
  'dp.compRatio': '지명 경쟁 {n}:1', 'dp.compNote': '지명 경쟁 = 임시 거주자 ÷ {year}년 주 지명 쿼터. 거주자는 IRCC 공개 데이터, 쿼터는 본 사이트 수기 검증 표',
  ...
  'dp.federal': '연방', 'dp.atlantic': '대서양 지역', 'dp.ruralCommunities': '참여 시범 지역', 'dp.verifyJobTitle': '이미 오퍼나 관심 공고가 있나요?', 'dp.verifyJobHint': '해당 공고·고용주·경로 요건을 다음 단계에서 검증하세요. 위의 1차 계획을 막지 않습니다.', 'dp.verifyJob': '특정 공고 검증',
  ...
  'ps.unscoredTitle': '그 밖에 선택한 주', 'ps.unscoredHint': '{provs}는 이 페이지에서 통합 점수를 계산하지 않지만 경로 계획에는 계속 포함됩니다.',
  ...
  'tv.occ.teerCoarse': 'TEER {teer} 미배제', 'tv.occ.teerCoarseNo': 'TEER {teer} 배제',
  ...
  'tv.f.title': '직무명', 'tv.f.employer': '고용주', 'tv.f.place': '지역', 'tv.f.noc': '직업 코드', 'tv.f.teer': '숙련 등급',
  ...
  'tv.next.jobs': '이 고용주 채용 공고', 'tv.next.paths': '전체 가능 통로',
  ...
  'tv.k.screen': '사이트 1차 선별', 'tv.k.occList': '직업 리스트', 'tv.k.desig': '지정 고용주', 'tv.k.years': '운영 연수',

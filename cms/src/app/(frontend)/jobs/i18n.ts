...
const zh: Dict = {
  ...
  'news.empty': '暂无动态',
  'news.imp': '重要', 'news.watch': '关注', 'news.impOnly': '只看重要', 'news.impN': '重要 {n}/5',
...
const en: Dict = {
  ...
  'news.imp': 'Important', 'news.watch': 'Watch', 'news.impOnly': 'Important only', 'news.impN': 'Importance {n}/5',
...
const ko: Dict = {
  ...
  'news.imp': '중요', 'news.watch': '관심', 'news.impOnly': '중요만 보기', 'news.impN': '중요도 {n}/5',

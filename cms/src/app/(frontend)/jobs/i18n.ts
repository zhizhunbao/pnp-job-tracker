...
const zh: Dict = {
  ...
  'pulse.col.tier': '通道档', 'pulse.tier.both': '省+联邦紧缺清单', 'pulse.tier.prov': '省紧缺清单',
  'pulse.tier.fed': '联邦紧缺清单', 'pulse.tier.ee': '可走 EE', 'pulse.tier.employer': '仅雇主担保',
  'pulse.dr.read': '解读',
  'pulse.col.range': '薪资区间',
  'pulse.total': '共 {n} 个职业', 'pulse.totalEmp': '共 {n} 家',
  'pulse.s4': '分省概览',
  ...
  'se.chip.all': '全部', 'se.chip.aip': 'AIP 指定', 'se.where.sep': '、', 'se.chip.lmia': 'LMIA 获批', 'se.chip.named': 'PNP 担保记录',
  'se.col.open': '在招', 'se.col.where': '所在地', 'se.where.multi': '{n} 省',
  'se.col.lmia': 'LMIA 获批(近两年)', 'se.myFilter': '按我的档案筛', 'se.export': '导出名单 CSV', 'rpt.emp.all': '在担保雇主页看全部', 'se.col.named': 'PNP 担保记录', 'se.pr': 'PR {n}', 'se.col.pr': '担保过 PR', 'se.col.alias': '中文名', 'se.col.grade': '担保档', 'se.all.city': '全部城市', 'se.col.w1': 'LMIA 最近一季', 'se.col.w2': 'LMIA 近半年', 'se.col.w4': 'LMIA 近一年', 'se.occSearch': '搜职业名或 NOC…', 'se.col.namedJobs': '省清单岗',
...
const en: Dict = {
  ...
  'pulse.total': '{n} occupations', 'pulse.totalEmp': '{n} employers',
  ...
  'se.title': 'Sponsor employers hiring now', 'se.sub': 'Hiring now with sponsorship records',
  'se.chip.all': 'All', 'se.chip.aip': 'AIP designated', 'se.where.sep': ', ', 'se.chip.lmia': 'LMIA approved', 'se.chip.named': 'PNP sponsorship record',
  'se.col.open': 'Open jobs', 'se.col.where': 'Location', 'se.where.multi': '{n} provinces',
  'se.col.lmia': 'LMIA approved (2 yrs)', 'se.myFilter': 'Filter by my profile', 'se.export': 'Export CSV', 'rpt.emp.all': 'See all on the sponsor employers page', 'se.col.named': 'PNP sponsorship record', 'se.pr': 'PR {n}', 'se.col.pr': 'PR-support LMIAs', 'se.col.alias': 'Alias', 'se.col.grade': 'Sponsor grade', 'se.all.city': 'All cities', 'se.col.w1': 'LMIA last quarter', 'se.col.w2': 'LMIA 6 months', 'se.col.w4': 'LMIA 1 year', 'se.occSearch': 'Occupation or NOC…', 'se.col.namedJobs': 'Provincial-list jobs',
...
const ko: Dict = {
  ...
  'pulse.total': '총 {n}개 직업', 'pulse.totalEmp': '총 {n}곳',
  'pulse.s4': '주별 개요',
  ...
  'se.chip.all': '전체', 'se.chip.aip': 'AIP 지정', 'se.where.sep': '、', 'se.chip.lmia': 'LMIA 승인', 'se.chip.named': 'PNP 스폰서 이력',
  'se.col.open': '채용 중', 'se.col.where': '지역', 'se.where.multi': '{n}개 주',
  'se.col.lmia': 'LMIA 승인(2년)', 'se.myFilter': '내 프로필로 필터', 'se.export': 'CSV 내보내기', 'rpt.emp.all': '스폰서 고용주 페이지에서 전체 보기', 'se.col.named': 'PNP 스폰서 이력', 'se.pr': 'PR {n}', 'se.col.pr': 'PR 지원 LMIA', 'se.col.alias': '한국어 이름', 'se.col.grade': '스폰서 등급', 'se.all.city': '모든 도시', 'se.col.w1': 'LMIA 최근 분기', 'se.col.w2': 'LMIA 6개월', 'se.col.w4': 'LMIA 1년', 'se.occSearch': '직업명 또는 NOC…', 'se.col.namedJobs': '주 목록 공고',

...
const zh: Dict = {
  ...
  'plan.occ': '你的职业', 'plan.occ.none': '还没选职业——清单命中/抽选/薪资都要靠它', 'plan.occ.pick': '选职业',
  ...
  'rpt.g.noNoc': '档案里还没有职业——清单命中/抽选/薪资全都算不了,先选职业',
...
const en: Dict = {
  ...
  'plan.occ': 'Your occupation', 'plan.occ.none': 'No occupation yet - list hits, draws and wages all hinge on it', 'plan.occ.pick': 'Pick occupation',
...
const ko: Dict = {
  ...
  'plan.occ': '내 직업', 'plan.occ.none': '아직 직업을 선택하지 않았습니다 - 목록 매칭/추첨/임금 모두 직업 기준입니다', 'plan.occ.pick': '직업 선택',
  ...
  'rpt.g.noNoc': '프로필에 직업이 없습니다 - 목록/추첨/임금 모두 계산 불가. 먼저 직업을 선택하세요',

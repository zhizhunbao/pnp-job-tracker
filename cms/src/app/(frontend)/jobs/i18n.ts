...
const zh: Dict = {
  ...
  'home.ctaQuiz': '开始个性化评估', 'home.ctaBrowse': '先浏览数据',
  'home.goals': '你想做什么决定?',
  ...
  'plan.pdf': '存为 PDF', 'occ.az.all': '全部', 'occ.cat.hot': '热门', 'plan.reset': '清空重填', 'plan.reset.ok': '确认清空',
  ...
  'rpt.c.window': '你的签证约剩 {months} 个月;按近 {n} 次抽选平均 {days} 天一轮,窗口内大约还有 {rounds} 轮',
  ...
  'rpt.lock.req': '差多少、按什么顺序补', 'rpt.lock.score': '换省会不会更有利:各省自算分与门槛差距', 'rpt.lock.window': '时间窗:还赶得上几轮',
...
const en: Dict = {
  ...
  'home.ctaQuiz': 'Start my assessment', 'home.ctaBrowse': 'Browse the data',
  ...
  'plan.pdf': 'Save as PDF', 'occ.az.all': 'All', 'occ.cat.hot': 'Popular', 'plan.reset': 'Clear all', 'plan.reset.ok': 'Confirm clear',
  ...
  'rpt.c.window': 'Your permit has ~{months} months left; at the last {n} draws pace (avg {days} days apart) that is roughly {rounds} more rounds in your window',
  ...
  'rpt.lock.req': 'How far short you are and what to fix first', 'rpt.lock.score': 'Would another province be better — your score in each and the gap', 'rpt.lock.window': 'Time window: how many rounds you can still catch',
...
const ko: Dict = {
  ...
  'home.ctaQuiz': '맞춤 평가 시작', 'home.ctaBrowse': '데이터 먼저 보기',
  ...
  'plan.pdf': 'PDF로 저장', 'occ.az.all': '전체', 'occ.cat.hot': '인기', 'plan.reset': '전체 지우기', 'plan.reset.ok': '지우기 확인',
  ...
  'rpt.c.window': '비자 잔여 약 {months}개월. 최근 {n}회 추첨 평균 {days}일 간격 기준 창구 내 약 {rounds}회 남음',
  ...
  'rpt.lock.req': '얼마나 부족한지와 보완 순서', 'rpt.lock.score': '주를 바꾸면 유리한가 — 주별 점수와 기준 격차', 'rpt.lock.window': '체류 기간 내 남은 회차',

...
const zh: Dict = {
  ...
  'pulse.unit.days': '{n} 天',
  'pulse.b1': '不在任何省紧缺清单的职业',
  'pulse.b2': '在紧缺清单但岗位收缩中',
  'pulse.b3': '在紧缺清单且岗位增长中',
  // E13-08 雷区榜(强负断言,口径=ETL any_pr_path:PNP∪联邦EE∪AIP∪保育专项全无才判死)
  'pulse.b1a': '部分省份完全无路可走的职业',
  'pulse.col.alive': '有路可走的省', 'pulse.col.dead': '完全走不了的省',
  ...
  'pulse.tier.fed': '联邦点名', 'pulse.tier.ee': '可走 EE', 'pulse.tier.employer': '仅雇主担保',
  'pulse.dr.read': '解读',
...
const en: Dict = {
  ...
  'pulse.b1': 'Occupations on no provincial in-demand list',
  'pulse.b2': 'On an in-demand list but contracting',
  'pulse.b3': 'On an in-demand list and growing',
  ...
  'pulse.b1a': 'Occupations with no route at all in some provinces',
  'pulse.col.alive': 'Provinces with a route', 'pulse.col.dead': 'No-route provinces',
  ...
  'pulse.tier.fed': 'Federal named', 'pulse.tier.ee': 'EE open', 'pulse.tier.employer': 'Employer offer only',
  'pulse.dr.read': 'Read',
...
const ko: Dict = {
  ...
  'pulse.unit.days': '{n}일',
  'pulse.b1': '어느 주 수요 목록에도 없는 직업',
  'pulse.b2': '수요 목록에 있지만 공고 감소세',
  'pulse.b3': '수요 목록에 있고 공고 증가세',
  // E13-08 지뢰밭 랭킹(강한 부정 판정; 기준 = ETL any_pr_path: PNP·연방 EE·AIP·돌봄 파일럿 전부 불가일 때만)
  'pulse.b1a': '일부 주에서 갈 길이 전혀 없는 직업',
  'pulse.col.alive': '갈 수 있는 주', 'pulse.col.dead': '갈 수 없는 주',
  ...
  'pulse.tier.fed': '연방 지명', 'pulse.tier.ee': 'EE 가능', 'pulse.tier.employer': '고용주 오퍼만',
  'pulse.dr.read': '해석',

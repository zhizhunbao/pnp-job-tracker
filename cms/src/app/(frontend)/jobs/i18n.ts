...
const zh: Dict = {
  ...
  'cell.pnpYes': '✅ 可省提名', 'cell.pnpSkilled': '技能岗', 'cell.pnpIndemand': '紧缺', 'cell.pnpQc': '魁省', 'cell.aipYes': '🏅 指定雇主', 'cell.closed': '已下架', 'cell.open': '在招',
  // 列名
...
const en: Dict = {
  ...
  'cell.pnpYes': '✅ PNP-eligible', 'cell.pnpSkilled': 'Skilled', 'cell.pnpIndemand': 'In-demand', 'cell.pnpQc': 'Quebec', 'cell.aipYes': '🏅 Designated', 'cell.closed': 'Closed', 'cell.open': 'Open',
...
const ko: Dict = {
  ...
  'cell.pnpYes': '✅ PNP 가능', 'cell.pnpSkilled': '기술직', 'cell.pnpIndemand': '부족직종', 'cell.pnpQc': '퀘벡', 'cell.aipYes': '🏅 지정 고용주', 'cell.closed': '마감', 'cell.open': '채용중',

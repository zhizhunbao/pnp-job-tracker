...
const zh: Dict = {
  ...
  'rpt.r.emp.staff': '雇主侧:大温地区的雇主要有 {metro} 名全职雇员(大温以外 {rest} 名)—— 这项只有雇主拿得出材料',
...
const en: Dict = {
  ...
  'rpt.r.emp.staff': 'Employer-side: {metro} full-time staff inside Metro Vancouver ({rest} outside) - only the employer can evidence this',
...
const ko: Dict = {
  ...
  'rpt.r.emp.staff': '고용주 요건: 메트로 밴쿠버 내 정규직 {metro}명(외부 {rest}명) - 고용주만 증빙 가능',

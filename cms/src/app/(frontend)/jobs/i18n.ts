...
const zh: Dict = {
  ...
  'advisor.tag': 'AI 顾问', 'advisor.generating': ' · 思考中…',
  ...
  'news.empty': '暂无动态',
  'news.imp': '重要', 'news.topTitle': '重要动态', 'news.watch': '关注', 'news.impOnly': '只看重要', 'news.impN': '重要 {n}/5',
  ...
  'news.trOn': '显示中文对照', 'news.trOff': '收起中文对照', 'news.trBusy': '翻译中…约 15 秒', 'news.trErr': '翻译暂不可用,请稍后再试',
...
const en: Dict = {
  ...
  'advisor.tag': 'AI Advisor', 'advisor.generating': ' · thinking…',
  ...
  'news.imp': 'Important', 'news.topTitle': 'Top updates', 'news.watch': 'Watch', 'news.impOnly': 'Important only', 'news.impN': 'Importance {n}/5',
  ...
  'news.trOn': 'Show translation', 'news.trOff': 'Hide translation', 'news.trBusy': 'Translating… ~15s', 'news.trErr': 'Translation unavailable — try again later',
  'pw.entry': 'Pathways',
...
const ko: Dict = {
  ...
  'advisor.tag': 'AI 어드바이저', 'advisor.generating': ' · 생각 중…',
  ...
  'news.imp': '중요', 'news.topTitle': '주요 소식', 'news.watch': '관심', 'news.impOnly': '중요만 보기', 'news.impN': '중요도 {n}/5',
  ...
  'news.trOn': '한국어 번역 보기', 'news.trOff': '한국어 번역 접기', 'news.trBusy': '번역 중… 약 15초', 'news.trErr': '번역을 잠시 사용할 수 없습니다',
  'pw.entry': '이민 경로',
  'pw.title': '이민 경로',

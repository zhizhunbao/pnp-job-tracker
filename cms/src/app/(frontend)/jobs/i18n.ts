...
const zh: Dict = {
  ...
  'rpt.lock.req': '差多少、按什么顺序补', 'rpt.lock.score': '你的省估分分差与补分路径', 'rpt.lock.window': '时间窗:还赶得上几轮',
...
const en: Dict = {
  ...
  'rpt.lock.req': 'How far short you are and what to fix first', 'rpt.lock.score': 'Your provincial score gap and how to close it', 'rpt.lock.window': 'Time window: how many rounds you can still catch',
...
const ko: Dict = {
  ...
  'rpt.lock.req': '얼마나 부족한지와 보완 순서', 'rpt.lock.score': '내 주 점수 격차와 보완 경로', 'rpt.lock.window': '체류 기간 내 남은 회차',

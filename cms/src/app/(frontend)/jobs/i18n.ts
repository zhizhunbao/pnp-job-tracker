...
const zh: Dict = {
  ...
  'home.goals': '我能帮你做这些决定',
  'home.g.jobs': '找工作', 'home.g.jobs.n': '{n} 个在招岗位,日更',
  'home.g.pr': '拿 PR', 'home.g.pr.n': '通道判定与分数对照',
  'home.g.prov': '选省份', 'home.g.prov.n': '{n} 省规则与竞争',
  'home.g.city': '选城市', 'home.g.city.n': '{n} 城在招与薪资',
  ...
  'plan.job.title': '找工作', 'plan.job.sub': '填 2 项条件,看你这行在目标省的在招与薪资',
  ...
  'jd.rep.open': '{prov} 同职业在招', 'jd.rep.elig': '其中粗筛可提名', 'jd.rep.med': '全国帖面中位年薪', 'jd.rep.go': '看这行的完整报告',
  'jd.rep.vsHi': '这个岗比同职业中位高 {pct}%', 'jd.rep.vsLo': '这个岗比同职业中位低 {pct}%',
  'jd.rep.lock': '{n} 家雇主发过能走省提名的岗', 'jd.rep.lock.sub': '公司名、命中岗数、LMIA 记录',
  'plan.prov.title': '选省份', 'plan.prov.sub': '填 1 项条件,看哪个省对你这行最合适',
  'rpt.p.best': '{prov} 最合适:你这行在其公开清单「{label}」上,当地在招 {open} 岗,其中 {named} 个是省提名清单岗',
  ...
  'rpt.hero.jobs': '{prov} 在招岗位', 'rpt.hero.self': '你这行全国在招岗位',
  ...
  'plan.q.exp': '在加拿大做过这行多久?', 'plan.exp.a1': '没有', 'plan.exp.a2': '不到 1 年', 'plan.exp.a3': '1-2 年', 'plan.exp.a4': '2 年以上',
  ...
  'rpt.q.gap': '还缺哪些条件?', 'rpt.q.next': '建议的下一步', 'rpt.q.alt': '其他可考虑的省',
  ...
  'rpt.r.income.pass': '{prov} 要求家庭年收入不低于 ${need};你这行在当地的官方中位年薪 ${have} —— 高于门槛',
  'rpt.r.income.fail': '{prov} 要求家庭年收入不低于 ${need};你这行在当地的官方中位年薪 ${have} —— 最低那档也差 ${short}',
  'rpt.r.income.failFree': '{prov} 要求家庭年收入不低于 ${need};你这行在当地的官方中位年薪 ${have} —— 低于门槛',
  'rpt.r.income.unknown': '{prov} 的最低家庭收入门槛看你住哪、家里几口人:${needLow}–${need};你这行当地官方中位年薪 ${have}',
  'rpt.r.exp.pass': '{prov} 技术工人通道要求 {need} 个月技术工作经验;你填的加拿大经验 {have} 个月 —— 达标',
  'rpt.r.exp.unknown': '{prov} 技术工人通道要 {need} 个月技术工作经验(境内外都算);本站只问了加拿大经验,判不了',
  'rpt.r.langExempt': '{prov} 另有免考条款:近 {n} 年从当地院校拿到指定学历可免语言考试;本站没问学历,这条不参与判定',
  ...
  'rpt.r.none': '{prov} 的官方门槛本站还没收录,这一条对照不了',
  // 换省对照(L2-08):下界口径 —— 「至少 N 分」与「已答 x/y 项」两样都不许省
  'rpt.s.cur': '当前选择 {prov}:按官方 {system},你已答的 {have}/{all} 项自算至少 {total} 分',
  'rpt.s.cur.free': '当前选择 {prov}:该省公布了官方分值表({system})',
  'rpt.s.cur.noTable': '当前选择 {prov}:该省未公布官方分值表,自算不了分数',
  'rpt.s.alt.pass': '改选 {prov}:按官方 {system} 自算至少 {total} 分,已过官方申请门槛 {mark} 分',
  'rpt.s.alt.mark': '改选 {prov}:按官方 {system} 自算至少 {total} 分;官方申请门槛 {mark} 分,还差 {rest} 项才判得了',
  'rpt.s.alt.mark.free': '改选 {prov}:该省官方申请门槛 {mark} 分(按官方 {system})',
  'rpt.s.alt.band': '改选 {prov}:按官方 {system} 自算至少 {total} 分;近 {n} 次抽选线 {lo}–{hi} 分',
  'rpt.s.alt.band.free': '改选 {prov}:近 {n} 次抽选线 {lo}–{hi} 分(按官方 {system})',
  'rpt.s.alt.plain': '改选 {prov}:按官方 {system} 自算至少 {total} 分(该省尚无门槛与抽选记录)',
  'rpt.s.alt.plain.free': '改选 {prov}:该省公布了官方分值表({system})',
  'rpt.s.alt.noTable': '改选 {prov}:该省未公布官方分值表,自算不了分数',
  'rpt.s.alt.noDraw': '改选 {prov}:按官方 {system} 自算至少 {total} 分;该省这条通道还没有抽选记录',
  'rpt.s.alt.noDraw.free': '改选 {prov}:该省有官方分值表,但这条通道还没有抽选记录',
  'rpt.s.partial': '以上只用到你已答的语言与加拿大经验;学历、年龄、二语、工资与地区本页没问,补齐可提高精度',
  'rpt.s.note': '分数依据各省官方分值表自算,不代表官方审核结果;各省分制互不相通,分数之间不可直接比较',
  'rpt.conf': '置信度', 'rpt.conf.low': '低', 'rpt.conf.mid': '中', 'rpt.conf.high': '高',
  'rpt.asOf': '数据日期 {d}', 'rpt.src': '出处',
  ...
  'rpt.lock.req': '差多少、按什么顺序补', 'rpt.lock.score': '你在各省的自算分与够不够门槛', 'rpt.lock.window': '时间窗:还赶得上几轮',
  'rpt.lock.alts': '备选省完整对照', 'rpt.lock.ee': '你与 EE 类别抽选线的分差', 'rpt.lock.more': '其余结论全文',
  ...
  'rpt.j.sponsors': '有 {n} 家雇主发过能走省提名的岗',
  ...
  'home.cta2.t': '答三道题,看你的职业在哪个省最好走', 'home.cta2.s': '结果全部来自上面这些库内数据,免费',
...
const en: Dict = {
  ...
  'home.goals': 'Decisions we can help with',
  'home.g.jobs': 'Find a job', 'home.g.jobs.n': '{n} open jobs, updated daily',
  'home.g.pr': 'Get PR', 'home.g.pr.n': 'Stream checks & score benchmarks',
  'home.g.prov': 'Pick a province', 'home.g.prov.n': 'Rules & competition, {n} provinces',
  'home.g.city': 'Pick a city', 'home.g.city.n': 'Openings & wages, {n} cities',
  ...
  'rpt.q.gap': 'What is still missing?', 'rpt.q.next': 'Suggested next steps', 'rpt.q.alt': 'Other provinces worth considering',
  ...
  'rpt.r.income.unknown': '{prov} sets the bar by where you live and family size: ${needLow} to ${need}; the official median wage for your occupation there is ${have}',
  'rpt.r.exp.pass': "{prov}'s skilled worker stream requires {need} months of skilled work experience; you report {have} months in Canada - meets it",
  'rpt.r.exp.unknown': "{prov}'s skilled worker stream requires {need} months of skilled work experience (in or outside Canada); only Canadian months are on file, so this cannot be judged",
  'rpt.r.langExempt': '{prov} waives the test if you earned an eligible {prov} credential in the last {n} years; education is not on file, so this is not applied here',
  ...
  'rpt.r.none': "{prov}'s official thresholds are not covered by this site yet - no comparison possible",
  ...
  'rpt.s.cur.free': 'Currently targeting {prov}: this province publishes an official points grid ({system})',
  'rpt.s.cur.noTable': 'Currently targeting {prov}: this province publishes no points grid, so no score can be computed',
  'rpt.s.alt.pass': 'Switch to {prov}: at least {total} on the official {system} — already past its {mark}-point application threshold',
  'rpt.s.alt.mark': 'Switch to {prov}: at least {total} on the official {system}; threshold is {mark} — {rest} more factor(s) needed to judge',
  'rpt.s.alt.mark.free': 'Switch to {prov}: official application threshold {mark} points ({system})',
  'rpt.s.alt.band': 'Switch to {prov}: at least {total} on the official {system}; last {n} draws cut off at {lo}–{hi}',
  'rpt.s.alt.band.free': 'Switch to {prov}: last {n} draws cut off at {lo}–{hi} ({system})',
  'rpt.s.alt.plain': 'Switch to {prov}: at least {total} on the official {system} (no threshold or draw record yet)',
  'rpt.s.alt.plain.free': 'Switch to {prov}: this province publishes an official points grid ({system})',
  'rpt.s.alt.noTable': 'Switch to {prov}: this province publishes no points grid, so no score can be computed',
  'rpt.s.alt.noDraw': 'Switch to {prov}: at least {total} on the official {system}; this stream has no draw record yet',
  'rpt.s.alt.noDraw.free': 'Switch to {prov}: it has an official points grid, but this stream has no draw record yet',
  'rpt.s.partial': 'The above uses only your language and Canadian experience answers; education, age, second language, wage and location are not asked here — fill them in for a sharper estimate',
  'rpt.s.note': 'Scores are self-computed from each province official grid and are not an official assessment; the grids are separate systems and cannot be compared with each other',
  'rpt.conf': 'Confidence', 'rpt.conf.low': 'low', 'rpt.conf.mid': 'medium', 'rpt.conf.high': 'high',
  'rpt.asOf': 'Data as of {d}', 'rpt.src': 'Source',
  ...
  'rpt.lock.req': 'How far short you are and what to fix first', 'rpt.lock.score': 'Your self-computed score in each province and whether it clears the bar', 'rpt.lock.window': 'Time window: how many rounds you can still catch',
  'rpt.lock.alts': 'Full comparison of alternative provinces', 'rpt.lock.ee': 'Your gap to the EE category cutoff', 'rpt.lock.more': 'The remaining conclusions in full',
  ...
  'rpt.j.sponsors': '{n} employers have posted jobs that can go through a PNP',
  ...
  'home.cta2.t': 'Answer 3 questions — see which province suits your occupation', 'home.cta2.s': 'Free, computed from the data above',
...
const ko: Dict = {
  ...
  'home.goals': '이런 결정을 도와드립니다',
  'home.g.jobs': '일자리 찾기', 'home.g.jobs.n': '채용 중 {n}건, 매일 갱신',
  'home.g.pr': '영주권(PR)', 'home.g.pr.n': '경로 판정과 점수 대조',
  'home.g.prov': '주 선택', 'home.g.prov.n': '{n}개 주 규칙과 경쟁',
  'home.g.city': '도시 선택', 'home.g.city.n': '{n}개 도시 채용과 임금',
  ...
  'rpt.q.gap': '아직 부족한 조건은?', 'rpt.q.next': '권장 다음 단계', 'rpt.q.alt': '고려할 만한 다른 주',
  ...
  'rpt.r.income.unknown': '{prov}는 거주 지역과 가구원 수로 기준이 갈림: ${needLow}~${need}. 해당 직종 현지 공식 중위 연봉 ${have}',
  'rpt.r.exp.pass': '{prov} 숙련인력 스트림은 숙련 경력 {need}개월 요구. 신고한 캐나다 경력 {have}개월 - 충족',
  'rpt.r.exp.unknown': '{prov} 숙련인력 스트림은 숙련 경력 {need}개월 요구(국내외 무관). 본 사이트는 캐나다 경력만 수집 - 판정 불가',
  'rpt.r.langExempt': '{prov}는 최근 {n}년 내 현지 지정 학력 취득 시 어학시험 면제. 본 사이트는 학력을 수집하지 않아 판정에 반영하지 않음',
  ...
  'rpt.r.none': '{prov}의 공식 요건은 아직 수록되지 않아 대조 불가',
  // 주 변경 대조 (L2-08): 하한 점수 — '최소 N점'과 '답한 x/y항'은 절대 생략 금지
  'rpt.s.cur': '현재 선택 {prov}: 공식 {system} 배점표 기준, 답한 {have}/{all}항으로 최소 {total}점',
  'rpt.s.cur.free': '현재 선택 {prov}: 이 주는 공식 배점표를 공개함({system})',
  'rpt.s.cur.noTable': '현재 선택 {prov}: 이 주는 공식 배점표가 없어 점수 산출 불가',
  'rpt.s.alt.pass': '{prov}로 변경: 공식 {system} 기준 최소 {total}점 — 신청 기준 {mark}점을 이미 넘음',
  'rpt.s.alt.mark': '{prov}로 변경: 공식 {system} 기준 최소 {total}점; 신청 기준 {mark}점, {rest}개 항목을 더 채워야 판단 가능',
  'rpt.s.alt.mark.free': '{prov}로 변경: 공식 신청 기준 {mark}점({system} 배점표)',
  'rpt.s.alt.band': '{prov}로 변경: 공식 {system} 기준 최소 {total}점; 최근 {n}회 커트라인 {lo}–{hi}점',
  'rpt.s.alt.band.free': '{prov}로 변경: 최근 {n}회 커트라인 {lo}–{hi}점({system} 배점표)',
  'rpt.s.alt.plain': '{prov}로 변경: 공식 {system} 기준 최소 {total}점(기준선·추첨 기록 아직 없음)',
  'rpt.s.alt.plain.free': '{prov}로 변경: 이 주는 공식 배점표를 공개함({system})',
  'rpt.s.alt.noTable': '{prov}로 변경: 이 주는 공식 배점표가 없어 점수 산출 불가',
  'rpt.s.alt.noDraw': '{prov}로 변경: 공식 {system} 기준 최소 {total}점; 이 스트림은 아직 추첨 기록 없음',
  'rpt.s.alt.noDraw.free': '{prov}로 변경: 공식 배점표는 있으나 이 스트림은 아직 추첨 기록 없음',
  'rpt.s.partial': '위 점수는 답한 언어·캐나다 경력만 반영; 학력·나이·제2언어·임금·지역은 여기서 묻지 않음 — 채우면 정확도 상승',
  'rpt.s.note': '점수는 각 주 공식 배점표로 자체 산출한 값이며 공식 심사 결과가 아님; 주별 배점 체계가 달라 서로 비교 불가',
  'rpt.conf': '신뢰도', 'rpt.conf.low': '낮음', 'rpt.conf.mid': '중간', 'rpt.conf.high': '높음',
  'rpt.asOf': '데이터 기준일 {d}', 'rpt.src': '출처',
  ...
  'rpt.lock.req': '얼마나 부족한지와 보완 순서', 'rpt.lock.score': '주별 자체 산출 점수와 기준 충족 여부', 'rpt.lock.window': '체류 기간 내 남은 회차',
  'rpt.lock.alts': '대체 주 전체 대조', 'rpt.lock.ee': 'EE 카테고리 커트라인과의 격차', 'rpt.lock.more': '나머지 결론 전문',
  ...
  'rpt.j.sponsors': '주정부 지명 경로가 가능한 채용을 낸 고용주 {n}곳',
  ...
  'home.cta2.t': '세 문항으로 내 직업에 유리한 주 확인', 'home.cta2.s': '위 데이터로 계산, 무료',

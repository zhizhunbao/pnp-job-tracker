...
const zh: Dict = {
  ...
  'th.tip': '点击表头排序', 'resize.tip': '拖动改本列宽(左列不动,右列平移) · 双击平均分配各列',
  'empty': '无匹配职位', 'more': '下滑加载更多 · 已显示 {x} / {total}', 'allShown': '已全部显示 {total} 个',
  'cell.uncat': '未分类', 'cell.first': '第一方', 'cell.repost': '转贴',
  'cell.pnpYes': '✅ 可省提名', 'cell.aipYes': '🏅 指定雇主', 'cell.closed': '已下架', 'cell.open': '在招',
  // 列名
  ...
  'col.salary': '薪资', 'col.salaryYr': '年薪(折算)', 'col.source': '来源', 'col.origin': '渠道', 'col.direct': '发布',
...
const en: Dict = {
  ...
  'th.tip': 'Click to sort', 'resize.tip': 'Drag to resize this column (left fixed, right shifts) · double-click to equalize',
  'empty': 'No matching jobs', 'more': 'Scroll for more · showing {x} / {total}', 'allShown': 'All {total} shown',
  'cell.uncat': 'Uncategorized', 'cell.first': 'Direct', 'cell.repost': 'Repost',
  'cell.pnpYes': '✅ PNP-eligible', 'cell.aipYes': '🏅 Designated', 'cell.closed': 'Closed', 'cell.open': 'Open',
  ...
  'col.salary': 'Salary', 'col.salaryYr': 'Annual (est.)', 'col.source': 'Source', 'col.origin': 'Channel', 'col.direct': 'Posting',
...
const ko: Dict = {
  ...
  'th.tip': '클릭하여 정렬', 'resize.tip': '드래그로 열 너비 조정(왼쪽 고정, 오른쪽 이동) · 더블클릭 시 균등 분배',
  'empty': '일치하는 공고 없음', 'more': '스크롤하여 더 보기 · {x} / {total} 표시', 'allShown': '전체 {total}개 표시',
  'cell.uncat': '미분류', 'cell.first': '직접', 'cell.repost': '재게시',
  'cell.pnpYes': '✅ PNP 가능', 'cell.aipYes': '🏅 지정 고용주', 'cell.closed': '마감', 'cell.open': '채용중',
  ...
  'col.salary': '급여', 'col.salaryYr': '연봉(환산)', 'col.source': '출처', 'col.origin': '채널', 'col.direct': '게시',

...
const zh: Dict = {
  ...
  'dp.planCoarse': '按职业粗筛', 'dp.planCoarseSub': '职业:{occ};答完 8 题出个人初评', 'dp.planCoarseNote': '按职业粗筛,非资格认定;答完 8 题按你的条件排出个人通道', 'dp.planGateSame': '以上通道门槛相同:{s}', 'dp.planGate': '门槛', 'dp.planPath': '通道', 'dp.planOpen': '在招', 'dp.planJobsN': '{n} 岗',
  ...
  'ch.pilot.on': '所在社区参与试点', 'ch.pilot.na': '不在试点社区', 'fact.pilotGate': '试点为社区推荐制,雇主须先获社区指定;命中≠资格认定', 'fact.pilotEmp': '雇主在该社区官方指定名单',
...
const en: Dict = {
  ...
  'dp.planCoarse': 'Occupation pre-screen', 'dp.planCoarseSub': 'Occupation: {occ}; answer all 8 questions for your personal assessment', 'dp.planCoarseNote': 'Screened by occupation only, not an eligibility decision; answer all 8 questions to rank pathways by your profile', 'dp.planGateSame': 'All pathways share the same gate: {s}', 'dp.planGate': 'Gate', 'dp.planPath': 'Pathway', 'dp.planOpen': 'Open jobs', 'dp.planJobsN': '{n} jobs',
  ...
  'ch.pilot.on': 'In a participating community', 'ch.pilot.na': 'Not in a pilot community', 'fact.pilotGate': 'Community-driven pilots; employers must be designated by the community first. A hit is not an eligibility decision', 'fact.pilotEmp': 'On this community’s official designated employer list',
...
const ko: Dict = {
  ...
  'dp.planCoarse': '직업 기준 사전 선별', 'dp.planCoarseSub': '직업: {occ}; 8문항 완료 시 개인 평가 제공', 'dp.planCoarseNote': '직업 기준 사전 선별로 자격 판정이 아님; 8문항 완료 시 조건에 맞춰 경로 정렬', 'dp.planGateSame': '모든 경로의 관문 동일: {s}', 'dp.planGate': '관문', 'dp.planPath': '경로', 'dp.planOpen': '채용 중', 'dp.planJobsN': '{n}건',
  ...
  'ch.pilot.on': '시범 참여 커뮤니티 소재', 'ch.pilot.na': '시범 커뮤니티 아님', 'fact.pilotGate': '커뮤니티 추천제 시범으로 고용주가 먼저 커뮤니티 지정을 받아야 함; 해당 여부는 자격 판정이 아님', 'fact.pilotEmp': '해당 커뮤니티 공식 지정 고용주 명단에 있음',

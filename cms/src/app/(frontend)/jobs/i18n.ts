...
const zh: Dict = {
  ...
  'ch.pilot.on': '所在社区参与试点', 'ch.pilot.na': '不在试点社区', 'fact.pilotGate': '试点为社区推荐制,雇主须先获社区指定;命中≠资格认定',
...
const en: Dict = {
  ...
  'ch.pilot.on': 'In a participating community', 'ch.pilot.na': 'Not in a pilot community', 'fact.pilotGate': 'Community-driven pilots; employers must be designated by the community first. A hit is not an eligibility decision',
...
const ko: Dict = {
  ...
  'ch.pilot.on': '시범 참여 커뮤니티 소재', 'ch.pilot.na': '시범 커뮤니티 아님', 'fact.pilotGate': '커뮤니티 추천제 시범으로 고용주가 먼저 커뮤니티 지정을 받아야 함; 해당 여부는 자격 판정이 아님',

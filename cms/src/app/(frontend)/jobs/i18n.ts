...
const zh: Dict = {
  ...
  'pulse.entry': '就业把脉',
  'pulse.h1.down': '{occ}:近 14 天新增岗位环比 {n}',
  'pulse.h1.flat': '{occ}:近 14 天新增岗位与前期持平',
  'pulse.h1.up': '{occ}:近 14 天新增岗位环比 {n}',
  'pulse.card.total': '全国在架岗位', 'pulse.card.total.tip': '全站在架有效岗位总数,与职位板同一口径',
  'pulse.card.new14': '近14天新增', 'pulse.card.mom14': '较前14天 {n}',
  'pulse.card.days': '平均在架天数', 'pulse.card.pnp': '紧缺清单岗',
  'pulse.card.new14.tip': '全国近 14 天发布的岗位数,环比 = 与前 14 天相比',
  'pulse.card.days.tip': '只按实测下架的岗算(发布日到下架日);样本不足的职业不计入',
  'pulse.card.pnp.tip': '在架岗中命中省具名紧缺清单的岗数;粗筛信号,不等于资格认定',
  'pulse.unit.days': '{n} 天',
  'pulse.b1': '不在紧缺清单但可走雇主担保', 'pulse.b1.note': '在架 ≥100;不在任何省具名紧缺清单——TEER 0-3 仍可走雇主担保类通道或联邦 EE,TEER 4-5 两者皆无、仅剩部分省的雇主担保通道',
  'pulse.b2': '在紧缺清单但岗位收缩中', 'pulse.b2.note': '在架 ≥100,按跌幅排序',
  'pulse.b3': '在紧缺清单且岗位增长中', 'pulse.b3.note': '在架 ≥100,按涨幅排序',
  'pulse.provs.none': '无', 'pulse.provs.none.tip': '不在任何省具名紧缺清单;TEER 0-3 仍可走雇主担保类通道或联邦 EE,TEER 4-5 仅剩部分省的雇主担保通道',
  'pulse.provs.n': '{n} 省',
  'pulse.col.occ': '职业', 'pulse.col.open': '在架', 'pulse.col.mom': '14 天新增环比',
  'pulse.col.provs': '紧缺清单省份', 'pulse.col.provs.tip': '该职业进省具名紧缺清单且有在架岗命中的省份;排除式省与雇主担保类通用通道不算在内;粗筛信号,不等于资格认定',
  'pulse.col.pnpProvs': '雇主担保可提名省份', 'pulse.col.pnpProvs.tip': '按各省规则(排除式省默认可、具名清单、雇主担保类)逐省判定的可走省提名省份;QC 不属 PNP;粗筛信号,不等于资格认定',
  'pulse.col.teer': 'TEER 档', 'pulse.col.teer.tip': '国家职业分类的技能层级,0 最高;TEER 0-3 才可走联邦 EE,4-5 基本依赖省清单或雇主担保',
  'pulse.s4b': '省内职业榜', 'pulse.s4.prov': '省份', 'pulse.s4.diff': '竞争度',
  'pulse.col.tier': '通道档', 'pulse.tier.both': '省+联邦点名', 'pulse.tier.prov': '省点名',
  'pulse.tier.fed': '联邦点名', 'pulse.tier.ee': '无点名(EE 可)', 'pulse.tier.employer': '仅雇主担保',
  'pulse.col.gap': 'vs ESDC 中位', 'pulse.dr.read': '解读',
  'pulse.col.sal': '帖面中位年薪', 'pulse.col.sal.tip': '帖面标注薪资的中位数(年化),样本少于 5 个岗不显示;数值悬停可见与 ESDC 官方中位的偏离',
  'pulse.col.range': '薪资区间', 'pulse.col.range.tip': 'ESDC 官方薪资区间(年化,低档到高档);数值悬停可见本站帖面中位年薪(样本 ≥5 才带)',
  'pulse.total': '共 {n} 个职业',
  'pulse.col.mom.tip': '近 14 天新发岗位数 ÷ 前 14 天新发岗位数 − 1;前 14 天不足 5 个岗不算',
  'pulse.s4': '分省概览', 'pulse.s4.rank': '{prov} 职业榜前 20', 'pulse.s4.note': '在架 ≥10 的职业',
  ...
  'plan.pdf': '存为 PDF', 'occ.az.all': '全部', 'occ.cat.hot': '热门', 'occ.max': '最多选 3 个职业',
  'plan.reset': '清空重填', 'plan.reset.ok': '确认清空',
  ...
  'quiz.pickOne': '先选一项', 'plan.reportUpd': '更新报告',
...
const en: Dict = {
  ...
  'pulse.h1.down': '{occ}: new postings {n} over the last 14 days',
  'pulse.h1.flat': '{occ}: new postings flat over the last 14 days',
  'pulse.h1.up': '{occ}: new postings {n} over the last 14 days',
  'pulse.card.total': 'Open jobs now', 'pulse.card.total.tip': 'All live postings site-wide, same caliber as the job board',
  'pulse.card.new14': 'New in 14d', 'pulse.card.mom14': '{n} vs prior',
  ...
  'pulse.b1': 'No in-demand list but employer-offer PNP remains', 'pulse.b1.note': '100+ open postings; on no named in-demand list. TEER 0-3 can still use employer-offer streams or federal EE; TEER 4-5 has neither, only employer-offer streams in some provinces',
  'pulse.b2': 'On an in-demand list but contracting', 'pulse.b2.note': '100+ open postings, steepest decline first',
  'pulse.b3': 'On an in-demand list and growing', 'pulse.b3.note': '100+ open postings, strongest growth first',
  'pulse.provs.none': 'None', 'pulse.provs.none.tip': 'On no named provincial in-demand list. TEER 0-3 can still use employer-offer streams or federal EE; TEER 4-5 only employer-offer streams in some provinces',
  'pulse.provs.n': '{n} provinces',
  'pulse.col.occ': 'Occupation', 'pulse.col.open': 'Open', 'pulse.col.mom': '14d posting change',
  'pulse.col.provs': 'In-demand list provinces', 'pulse.col.provs.tip': 'Provinces whose named in-demand lists cover this occupation with open postings. Exclusion-based provinces and general employer-offer streams are not counted. A rough signal, not an eligibility ruling',
  'pulse.col.pnpProvs': 'Employer-offer PNP provinces', 'pulse.col.pnpProvs.tip': 'Provinces where an employer-offer PNP route applies (exclusion-based default, named list, or employer-sponsored stream). Excludes QC. A rough signal, not an eligibility ruling',
  'pulse.col.teer': 'TEER', 'pulse.col.teer.tip': 'NOC skill tier, 0 is highest. Federal EE takes TEER 0-3 only; TEER 4-5 mostly relies on provincial lists or employer-offer streams',
  'pulse.s4b': 'Occupations by province', 'pulse.s4.prov': 'Province', 'pulse.s4.diff': 'Competition',
  'pulse.col.tier': 'Route tier', 'pulse.tier.both': 'Prov + federal named', 'pulse.tier.prov': 'Province named',
  'pulse.tier.fed': 'Federal named', 'pulse.tier.ee': 'Not named (EE open)', 'pulse.tier.employer': 'Employer offer only',
  'pulse.col.gap': 'vs ESDC median', 'pulse.dr.read': 'Read',
  'pulse.col.sal': 'Posted median', 'pulse.col.sal.tip': 'Median of posted salaries, annualized; hidden when fewer than 5 postings state pay. Hover a value for the gap vs the ESDC median',
  'pulse.col.range': 'Salary range', 'pulse.col.range.tip': 'ESDC official wage range, annualized (low to high). Hover a value for the posted median on this site (shown with 5+ samples)',
  'pulse.total': '{n} occupations',
  'pulse.col.mom.tip': 'New postings in the last 14 days divided by the 14 days before that, minus 1. Skipped when the earlier window has fewer than 5 postings',
  'pulse.s4': 'Province overview', 'pulse.s4.rank': '{prov} top 20 occupations', 'pulse.s4.note': 'Occupations with 10+ open postings',
  ...
  'plan.pdf': 'Save as PDF', 'occ.az.all': 'All', 'occ.cat.hot': 'Popular', 'occ.max': 'Pick up to 3 occupations',
  'plan.reset': 'Clear all', 'plan.reset.ok': 'Confirm clear',
  ...
  'quiz.pickOne': 'Pick one to continue', 'plan.reportUpd': 'Update my report',
...
const ko: Dict = {
  ...
  'pulse.entry': '취업 진단',
  'pulse.h1.down': '{occ}, 최근 14일 신규 공고 {n}',
  'pulse.h1.flat': '{occ}, 최근 14일 신규 공고 직전과 동일',
  'pulse.h1.up': '{occ}: 최근 14일 신규 공고 {n}',
  'pulse.card.total': '현재 게시 공고', 'pulse.card.total.tip': '사이트 전체 유효 공고 수, 잡보드와 동일 기준',
  'pulse.card.new14': '최근 14일 신규', 'pulse.card.mom14': '직전 14일 {n}',
  ...
  'pulse.unit.days': '{n}일',
  'pulse.b1': '수요 목록에는 없지만 고용주 오퍼로는 가능', 'pulse.b1.note': '게시 100건 이상; 수요직업 목록 미등재. TEER 0-3은 고용주 오퍼 스트림이나 연방 EE 가능, TEER 4-5는 둘 다 불가하며 일부 주의 고용주 오퍼 스트림만 남음',
  'pulse.b2': '수요 목록에 있지만 공고 감소세', 'pulse.b2.note': '게시 100건 이상, 감소폭 순',
  'pulse.b3': '수요 목록에 있고 공고 증가세', 'pulse.b3.note': '게시 100건 이상, 증가폭 순',
  'pulse.provs.none': '없음', 'pulse.provs.none.tip': '어느 주 수요직업 목록에도 없음. TEER 0-3은 고용주 오퍼 스트림이나 연방 EE 가능, TEER 4-5는 일부 주의 고용주 오퍼 스트림만 남음',
  'pulse.provs.n': '{n}개 주',
  'pulse.col.occ': '직업', 'pulse.col.open': '게시', 'pulse.col.mom': '14일 신규 증감률',
  'pulse.col.provs': '수요 목록 등재 주', 'pulse.col.provs.tip': '이 직업이 주정부 수요직업 목록에 올라 있고 게시 공고가 있는 주. 제외식 주와 고용주 오퍼 일반 스트림은 포함하지 않음. 참고 신호이며 자격 판정이 아닙니다',
  'pulse.col.pnpProvs': '고용주 오퍼 PNP 가능 주', 'pulse.col.pnpProvs.tip': '고용주 오퍼 기반 PNP 경로가 적용되는 주(제외식 주 기본 가능, 지정 목록, 고용주 후원 스트림). QC 제외. 참고 신호이며 자격 판정이 아닙니다',
  'pulse.col.teer': 'TEER 등급', 'pulse.col.teer.tip': 'NOC 숙련 등급, 0이 최고. 연방 EE는 TEER 0-3만 해당, 4-5는 주 목록이나 고용주 오퍼 스트림에 의존',
  'pulse.s4b': '주별 직업 랭킹', 'pulse.s4.prov': '주', 'pulse.s4.diff': '경쟁도',
  'pulse.col.tier': '경로 등급', 'pulse.tier.both': '주+연방 지명', 'pulse.tier.prov': '주 지명',
  'pulse.tier.fed': '연방 지명', 'pulse.tier.ee': '지명 없음(EE 가능)', 'pulse.tier.employer': '고용주 오퍼만',
  'pulse.col.gap': 'vs ESDC 중위', 'pulse.dr.read': '해석',
  'pulse.col.sal': '공고 중위 연봉', 'pulse.col.sal.tip': '공고에 명시된 급여의 중위값(연 환산), 표본 5건 미만이면 표시하지 않음. 값에 마우스를 올리면 ESDC 중위 대비 편차 표시',
  'pulse.col.range': '급여 범위', 'pulse.col.range.tip': 'ESDC 공식 급여 범위(연 환산, 하한-상한). 값에 마우스를 올리면 본 사이트 공고 중위 연봉 표시(표본 5건 이상)',
  'pulse.total': '총 {n}개 직업',
  'pulse.col.mom.tip': '최근 14일 신규 공고 수를 직전 14일 신규 공고 수로 나눈 뒤 1을 뺀 값. 직전 14일이 5건 미만이면 계산하지 않음',
  'pulse.s4': '주별 개요', 'pulse.s4.rank': '{prov} 직업 상위 20', 'pulse.s4.note': '게시 10건 이상 직업',
  ...
  'plan.pdf': 'PDF로 저장', 'occ.az.all': '전체', 'occ.cat.hot': '인기', 'occ.max': '직업은 최대 3개까지 선택',
  'plan.reset': '전체 지우기', 'plan.reset.ok': '지우기 확인',
  ...
  'quiz.pickOne': '하나를 선택하세요', 'plan.reportUpd': '보고서 갱신',

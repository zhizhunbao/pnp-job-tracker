...
const zh: Dict = {
  ...
  'sl.pickProv': '选目标省份', 'sl.needBasic': '答完上面的申请人条件后出你的分', 'sl.editProv': '改省份', 'sl.date': '抽选日', 'sl.stream': '通道', 'sl.cutoff': '分数线', 'sl.you': '你', 'sl.cutoffN': '分数线 {n}',
...
const en: Dict = {
  ...
  'sl.pickProv': 'Pick provinces', 'sl.needBasic': 'Complete the applicant profile above to get your score', 'sl.editProv': 'Change', 'sl.date': 'Draw date', 'sl.stream': 'Stream', 'sl.cutoff': 'Cutoff', 'sl.you': 'You', 'sl.cutoffN': 'Cutoff {n}',
...
const ko: Dict = {
  ...
  'sl.pickProv': '목표 주 선택', 'sl.needBasic': '위의 신청인 조건을 완료하면 점수가 나옵니다', 'sl.editProv': '변경', 'sl.date': '선발일', 'sl.stream': '스트림', 'sl.cutoff': '커트라인', 'sl.you': '나', 'sl.cutoffN': '커트라인 {n}',

...
const zh: Dict = {
  ...
  'pulse.col.sal': '中位年薪', 'pulse.col.sal.tip': '帖面标注薪资的中位数(年化),样本少于 5 个岗不显示;数值悬停可见与 ESDC 官方中位的偏离',
  'pulse.total': '共 {n} 个职业',
...
const en: Dict = {
  ...
  'pulse.col.sal': 'Median salary', 'pulse.col.sal.tip': 'Median of posted salaries, annualized; hidden when fewer than 5 postings state pay. Hover a value for the gap vs the ESDC median',
...
const ko: Dict = {
  ...
  'pulse.col.sal': '중위 연봉', 'pulse.col.sal.tip': '공고에 명시된 급여의 중위값(연 환산), 표본 5건 미만이면 표시하지 않음. 값에 마우스를 올리면 ESDC 중위 대비 편차 표시',

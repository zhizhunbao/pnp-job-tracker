...
const zh: Dict = {
  ...
  'mkt.y2.off': '不显示', 'mkt.sort': '排序', 'mkt.sort.desc': '从高到低', 'mkt.sort.asc': '从低到高',
...
const en: Dict = {
  ...
  'mkt.y2.off': 'Hide', 'mkt.sort': 'Sort', 'mkt.sort.desc': 'High to low', 'mkt.sort.asc': 'Low to high',
...
const ko: Dict = {
  ...
  'mkt.y2.off': '숨기기', 'mkt.sort': '정렬', 'mkt.sort.desc': '높은 순', 'mkt.sort.asc': '낮은 순',

...
const zh: Dict = {
  ...
  'rpt.sec.emp': '雇主线索', 'rpt.emp.note': '这些雇主的在招岗命中了省提名清单;是否愿意担保只有雇主自己知道,下面全是可核验的公开事实',
  'rpt.emp.named': '{n} 个清单岗', 'rpt.emp.lmia': 'ESDC 批过 {n} 个 LMIA 岗位({q})', 'rpt.emp.aip': 'AIP 指定雇主', 'rpt.emp.last': '最近发布 {d}',
  ...
  'rpt.j.sponsors': '有 {n} 家雇主发过省提名清单岗',
...
const en: Dict = {
  ...
  'rpt.sec.emp': 'Employer leads', 'rpt.emp.note': 'These employers have open postings that hit a named PNP stream. Whether they will support a nomination is up to them - everything below is verifiable public record',
  'rpt.emp.named': '{n} named-stream postings', 'rpt.emp.lmia': '{n} LMIA positions approved ({q})', 'rpt.emp.aip': 'AIP designated employer', 'rpt.emp.last': 'last posted {d}',
  ...
  'rpt.j.sponsors': '{n} employers have posted jobs hitting a named stream',
...
const ko: Dict = {
  ...
  'rpt.sec.emp': '고용주 단서', 'rpt.emp.note': '아래 고용주의 채용 공고가 주정부 지명 목록에 해당합니다. 실제 지원 의사는 고용주만 알 수 있으며, 아래는 모두 검증 가능한 공개 기록입니다',
  'rpt.emp.named': '목록 해당 공고 {n}건', 'rpt.emp.lmia': 'LMIA 승인 {n}건({q})', 'rpt.emp.aip': 'AIP 지정 고용주', 'rpt.emp.last': '최근 게시 {d}',
  ...
  'rpt.j.sponsors': '지정 스트림 채용을 낸 고용주 {n}곳',

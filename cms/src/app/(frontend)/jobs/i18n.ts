...
const zh: Dict = {
  ...
  'rpt.r.langNone': '{prov} 对 TEER {teer} 的岗在注册阶段不强制交语言成绩(审批时仍可能要)',
...
const en: Dict = {
  ...
  'rpt.r.langNone': '{prov} does not require a language test at registration for TEER {teer} (it can still be requested during assessment)',
...
const ko: Dict = {
  ...
  'rpt.r.langNone': '{prov}는 TEER {teer} 직종의 등록 단계에서 어학 성적을 요구하지 않음(심사 중 요청 가능)',

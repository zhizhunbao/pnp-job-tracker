...
const zh: Dict = {
  ...
  'rpt.c.listedHit': '你的职业(NOC {noc})在 {prov} 公开清单「{label}」上;当地在招 {open} 岗,其中 {named} 个是省提名清单岗',
  ...
  'rpt.j.open': '{prov} 当前在招 {open} 岗', 'rpt.j.openNamed': '{prov} 当前在招 {open} 岗,其中 {named} 个是省提名清单岗',
...
const en: Dict = {
  ...
  'rpt.c.listedHit': 'Your occupation (NOC {noc}) is on the {prov} published list "{label}"; {open} open postings there, {named} hitting the named stream',
  ...
  'rpt.j.open': '{open} open postings in {prov} right now', 'rpt.j.openNamed': '{open} open postings in {prov} right now, {named} hitting a named stream',
...
const ko: Dict = {
  ...
  'rpt.c.listedHit': '내 직업(NOC {noc})이 {prov} 공개 목록 "{label}"에 있습니다. 현지 채용 {open}건 중 {named}건이 지정 스트림 해당',

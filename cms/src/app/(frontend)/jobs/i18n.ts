...
const zh: Dict = {
  ...
  'pulse.entry': '就业把脉',
  'pulse.h1.down': '{occ} 近 14 天新发岗位环比 {n}',
  'pulse.h1.flat': '{occ} 近 14 天新发岗位与前期持平',
  'pulse.h1.up': '最难看的 {occ},近 14 天新发岗位也环比 {n}',
  'pulse.card.total': '全国在架岗位', 'pulse.card.total.tip': '全站在架有效岗位总数,与职位板同一口径',
  'pulse.v.nopr': ',且不在省提名清单',
  'pulse.card.new14': '近14天新发', 'pulse.card.mom14': '较前14天 {n}',
  'pulse.card.days': '平均在架天数', 'pulse.card.pnp': '省提名命中率',
  'pulse.card.new14.tip': '全国近 14 天发布的岗位数,环比 = 与前 14 天相比',
  'pulse.card.days.tip': '只按实测下架的岗算(发布日到下架日);样本不足的职业不计入',
  'pulse.card.pnp.tip': '在架岗中命中省提名职业清单的比例;粗筛信号,不等于资格认定',
  'pulse.unit.days': '{n} 天',
  'pulse.s2': '降温榜', 'pulse.s3': '升温榜',
  'pulse.s2.note': '新发在跌、提名机会也少的职业',
  'pulse.s3.note': '新发在涨、提名机会也多的职业',
  'pulse.board.tip': '入榜门槛:全国在架 ≥100;按新发环比、省提名命中率、薪资对比中位数综合排序',
  'pulse.col.occ': '职业', 'pulse.col.open': '在架', 'pulse.col.mom': '14 天新发环比',
  'pulse.col.hit': '提名命中率', 'pulse.col.gap': 'vs ESDC 中位', 'pulse.col.verdict': '判决',
  'pulse.col.mom.tip': '近 14 天新发岗位数 ÷ 前 14 天新发岗位数 − 1;前 14 天不足 5 个岗不算',
  'pulse.v.dive': '14 天新发腰斩,环比 {n}', 'pulse.v.shrink': '14 天新发在萎缩,环比 {n}',
  'pulse.v.flat': '14 天新发与前期持平', 'pulse.v.grow': '14 天新发在扩,环比 {n}',
  'pulse.s4': '省份照妖镜', 'pulse.s4.rank': '{prov} 职业榜前 20', 'pulse.s4.note': '在架 ≥10 的职业',
  'pulse.s4.streams': '该省提名通道', 'pulse.s4.drill': '看 {prov} 完整统计',
  'pulse.chart.show': '展开分布图', 'pulse.chart.hide': '收起分布图',
  'pulse.s5': '抽选尺子',
  'pulse.dr.note': '近 {n} 期 {min}–{max} 分,低于 {min} 没进过',
  'pulse.s6.t': '看完还想来?岗位在这', 'pulse.s6.s': '全加拿大全职业,每日更新',
  'pulse.s7.t': '下一轮把脉别错过', 'pulse.s7.s': '每周一封邮件,只发数字变化',
  'pulse.s7.sub': '订阅周报', 'pulse.s7.share': '分享本页', 'pulse.s7.copied': '链接已复制',
...
const en: Dict = {
  ...
  'pulse.card.pnp.tip': 'Share of open postings on a provincial nominee occupation list. A rough signal, not an eligibility ruling',
  'pulse.unit.days': '{n} days',
  'pulse.s2': 'Cooling down', 'pulse.s3': 'Heating up',
  'pulse.s2.note': 'Postings falling, few PNP-list hits',
  'pulse.s3.note': 'Postings rising, real PNP-list hits',
  'pulse.board.tip': 'Entry bar: 100+ open postings Canada-wide; ranked by posting momentum, PNP-list hit rate and wage vs ESDC median',
  'pulse.col.occ': 'Occupation', 'pulse.col.open': 'Open', 'pulse.col.mom': '14d posting change',
  'pulse.col.hit': 'PNP hit rate', 'pulse.col.gap': 'vs ESDC median', 'pulse.col.verdict': 'Verdict',
  ...
  'pulse.v.dive': 'Postings halved in 14d, {n}', 'pulse.v.shrink': 'Postings shrinking in 14d, {n}',
  'pulse.v.flat': 'Postings flat over 14d', 'pulse.v.grow': 'Postings up in 14d, {n}',
  'pulse.s4': 'Province check', 'pulse.s4.rank': '{prov} top 20 occupations', 'pulse.s4.note': 'Occupations with 10+ open postings',
  'pulse.s4.streams': 'Nominee streams here', 'pulse.s4.drill': 'Full {prov} statistics',
  'pulse.chart.show': 'Show distribution chart', 'pulse.chart.hide': 'Hide distribution chart',
  'pulse.s5': 'Draw yardstick',
  'pulse.dr.note': 'Last {n} draws {min}–{max}. Nobody got in below {min}',
  'pulse.s6.t': 'Still here? The jobs are this way', 'pulse.s6.s': 'Every occupation, Canada-wide, updated daily',
  'pulse.s7.t': 'Do not miss the next pulse', 'pulse.s7.s': 'One email a week, numbers only',
  'pulse.s7.sub': 'Get the weekly email', 'pulse.s7.share': 'Share this page', 'pulse.s7.copied': 'Link copied',
...
const ko: Dict = {
  ...
  'pulse.card.pnp.tip': '게시 중 공고 가운데 주정부 지명 직업 목록에 오른 비율. 참고 신호이며 자격 판정이 아닙니다',
  'pulse.unit.days': '{n}일',
  'pulse.s2': '하락세 직업', 'pulse.s3': '상승세 직업',
  'pulse.s2.note': '신규 공고가 줄고 PNP 기회도 적은 직업',
  'pulse.s3.note': '신규 공고가 늘고 PNP 기회도 많은 직업',
  'pulse.board.tip': '기준: 전국 게시 100건 이상; 신규 공고 증감·PNP 목록 적중률·임금 중위값 대비로 종합 정렬',
  'pulse.col.occ': '직업', 'pulse.col.open': '게시', 'pulse.col.mom': '14일 신규 증감률',
  'pulse.col.hit': 'PNP 적중률', 'pulse.col.gap': 'vs ESDC 중위', 'pulse.col.verdict': '진단',
  'pulse.col.mom.tip': '최근 14일 신규 공고 수를 직전 14일 신규 공고 수로 나눈 뒤 1을 뺀 값. 직전 14일이 5건 미만이면 계산하지 않음',
  'pulse.v.dive': '14일 신규 반토막, {n}', 'pulse.v.shrink': '14일 신규 감소, {n}',
  'pulse.v.flat': '14일 신규 보합', 'pulse.v.grow': '14일 신규 증가, {n}',
  'pulse.s4': '주별 진단', 'pulse.s4.rank': '{prov} 직업 상위 20', 'pulse.s4.note': '게시 10건 이상 직업',
  'pulse.s4.streams': '이 주의 지명 스트림', 'pulse.s4.drill': '{prov} 전체 통계 보기',
  'pulse.chart.show': '분포 차트 펼치기', 'pulse.chart.hide': '분포 차트 접기',
  'pulse.s5': '추첨 잣대',
  'pulse.dr.note': '최근 {n}회 {min}–{max}점, {min}점 미만은 초청 없음',
  'pulse.s6.t': '그래도 보시겠다면, 공고는 여기', 'pulse.s6.s': '캐나다 전역 전 직업, 매일 갱신',
  'pulse.s7.t': '다음 진단을 놓치지 마세요', 'pulse.s7.s': '주 1회 이메일, 숫자 변화만',
  'pulse.s7.sub': '주간 메일 구독', 'pulse.s7.share': '이 페이지 공유', 'pulse.s7.copied': '링크가 복사되었습니다',

...
const zh: Dict = {
  ...
  'ps.extraHint': '语言和总经验已从上方条件带入；这里只补充当前目标省的计分项，未选择的项目按 0 分。',
  'ps.extraN': '{n} 项',
...
const en: Dict = {
  ...
  'ps.extraHint': 'Language and total experience are carried over from your answers above. Only factors used by the current target province appear here; unanswered items count as zero.',
  'ps.extraN': '{n} items',
...
const ko: Dict = {
  ...
  'ps.extraHint': '언어와 총 경력은 위 답변에서 가져옵니다. 현재 목표 주의 점수 항목만 표시하며, 선택하지 않은 항목은 0점으로 계산합니다.',
  'ps.extraN': '{n}개',

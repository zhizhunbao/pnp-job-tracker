...
const zh: Dict = {
  ...
  'fact.verdict': '判定', 'act.channel': '通道',
  ...
  'ch.ee.on': '能进类别抽选: {cats}', 'ch.ee.more': '{first} 等 {n} 类', 'ch.ee.gen': '能走通用抽选(拼分数)', 'ch.ee.no': '走不了(TEER {teer})',
...
const en: Dict = {
  ...
  'fact.verdict': 'Verdict', 'act.channel': 'Routes',
  ...
  'ch.ee.on': 'Category draws: {cats}', 'ch.ee.more': '{first} +{n}', 'ch.ee.gen': 'General draws (CRS points)', 'ch.ee.no': 'Not eligible (TEER {teer})',
...
const ko: Dict = {
  ...
  'fact.verdict': '판정', 'act.channel': '경로',
  ...
  'ch.ee.on': '카테고리 추첨 가능: {cats}', 'ch.ee.more': '{first} 등 {n}종', 'ch.ee.gen': '일반 추첨 가능(점수제)', 'ch.ee.no': '불가(TEER {teer})',

...
const zh: Dict = {
  ...
  'dir.title': '雇主名录',
  'dir.col.employer': '雇主', 'dir.col.skilled': '高技能岗获批(近两年)', 'dir.col.quarter': '最近季度', 'dir.col.skilled.tip': '高薪(High Wage)与全球人才(Global Talent)股别的 LMIA 获批职位数——不含农业/低薪季节工;想找愿意办技能类工作担保的雇主,看这个数',

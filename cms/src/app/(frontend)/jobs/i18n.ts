...
const zh: Dict = {
  ...
  'gr.sp.5': '常年办 LMIA', 'gr.sp.4': '近期办过 LMIA', 'gr.sp.3': '办过 LMIA', 'gr.sp.2': '早年办过 LMIA',
...
const en: Dict = {
  ...
  'gr.sp.5': 'LMIA every year', 'gr.sp.4': 'Recent LMIA', 'gr.sp.3': 'Has LMIA record', 'gr.sp.2': 'LMIA years ago',
  ...
  'pulse.nav.boards': 'Occupation boards',
...
const ko: Dict = {
  ...
  'gr.sp.5': 'LMIA 상시', 'gr.sp.4': '최근 LMIA', 'gr.sp.3': 'LMIA 이력', 'gr.sp.2': '수년 전 LMIA',

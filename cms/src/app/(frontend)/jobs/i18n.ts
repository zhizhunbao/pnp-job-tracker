...
const zh: Dict = {
  ...
  'pulse.col.sponsorRate': '担保率',
  'pulse.total': '共 {n} 个职业', 'pulse.totalEmp': '共 {n} 家', 'pulse.hitEmp': '符合 {m} 家(共 {n} 家)',
  'se.allStreams': '全部清单', 'se.allOcc': '全部职业', 'se.empty': '没有匹配的雇主', 'se.skilledOnly': '只看技能类获批',
  'pulse.s4': '分省概览',
  ...
  'se.col.lmia': 'LMIA 获批(近两年)', 'se.col.alias': '中文名', 'se.col.w1': 'LMIA 最近一季', 'se.col.w2': 'LMIA 近半年', 'se.col.w4': 'LMIA 近一年',
...
const en: Dict = {
  ...
  'pulse.col.sponsorRate': 'Sponsor rate',
  'pulse.total': '{n} occupations', 'pulse.totalEmp': '{n} employers', 'pulse.hitEmp': '{m} of {n} employers',
  'se.allStreams': 'All lists', 'se.allOcc': 'All occupations', 'se.empty': 'No matching employers', 'se.skilledOnly': 'Skilled approvals only',
  ...
  'se.col.lmia': 'LMIA approved (2 yrs)', 'se.col.alias': 'Alias', 'se.col.w1': 'LMIA last quarter', 'se.col.w2': 'LMIA 6 months', 'se.col.w4': 'LMIA 1 year',
...
const ko: Dict = {
  ...
  'pulse.col.sponsorRate': '스폰서 비율',
  'pulse.total': '총 {n}개 직업', 'pulse.totalEmp': '총 {n}곳', 'pulse.hitEmp': '{m}곳(총 {n}곳)',
  'se.allStreams': '전체 목록', 'se.allOcc': '모든 직업', 'se.empty': '일치하는 고용주가 없습니다', 'se.skilledOnly': '숙련 승인만',
  'pulse.s4': '주별 개요',
  ...
  'se.col.lmia': 'LMIA 승인(2년)', 'se.col.alias': '한국어 이름', 'se.col.w1': 'LMIA 최근 분기', 'se.col.w2': 'LMIA 6개월', 'se.col.w4': 'LMIA 1년',

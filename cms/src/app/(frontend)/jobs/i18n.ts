...
const ko: Dict = {
  ...
  'up.advisor': '오늘 AI 어드바이저 무료 사용 횟수 소진',
  'up.jobtext': '오늘 JD 발췌 무료 사용 횟수 소진',
  ...
  'dir.col.employer': '고용주', 'dir.col.region': '지역', 'dir.col.skilled': '숙련 승인(2년)', 'dir.col.streams': '스트림', 'dir.col.quarter': '최신 분기', 'dir.tech': '테크', 'dir.col.skilled.tip': 'High Wage / Global Talent 스트림의 승인 LMIA 포지션 수 — Primary Agriculture / Low Wage 계절성 고용 제외; 숙련 스폰서를 찾는다면 이 숫자를 참고하세요.',

...
const zh: Dict = {
  ...
  'home.g.career': '职业规划', 'home.g.career.n': '你这行值多少钱',
  ...
  'rpt.p.bestAll': '{prov} 最合适:你这行在其公开清单「{label}」上,当地在招 {open} 岗',
  'rpt.p.secondAll': '{prov} 次选:你这行也在其公开清单「{label}」上,当地在招 {open} 岗',
  ...
  'quiz.kin': '同一类里还在招的职业', 'quiz.openN': '{n} 在招', 'quiz.jobsN': '{n} 岗', 'quiz.nextN': '选好了({n} 个职业),下一步', 'quiz.moreNocs': '更多职业', 'quiz.step1': '你的处境', 'quiz.step2': '职业', 'quiz.step3': '目标省',
...
const en: Dict = {
  ...
  'quiz.kin': 'Also hiring in the same group', 'quiz.openN': '{n} open', 'quiz.jobsN': '{n} jobs', 'quiz.nextN': 'Next — {n} selected', 'quiz.moreNocs': 'More occupations', 'quiz.step1': 'You', 'quiz.step2': 'Occupation', 'quiz.step3': 'Province',
...
const ko: Dict = {
  ...
  'quiz.kin': '같은 분류에서 채용 중인 직업', 'quiz.openN': '채용중 {n}건', 'quiz.jobsN': '{n}건', 'quiz.nextN': '{n}개 선택 완료 — 다음', 'quiz.moreNocs': '직업 더 보기', 'quiz.step1': '현재 상황', 'quiz.step2': '직업', 'quiz.step3': '희망 주',

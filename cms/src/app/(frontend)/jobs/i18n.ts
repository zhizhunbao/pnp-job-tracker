...
const zh: Dict = {
  ...
  'mkt.search': '搜职业、城市', 'mkt.more': '更多筛选', 'mkt.chan': '通道', 'mkt.chan.all': '全部职业', 'mkt.chan.pnp': '省提名清单上的职业', 'mkt.chan.ee': 'EE 类别覆盖的职业', 'mkt.chan.occOnly': '通道筛选只在横轴=职业时生效', 'mkt.y2.off': '不显示', 'mkt.medLink': '各省中位', 'mkt.sort': '排序', 'mkt.sort.desc': '从高到低', 'mkt.sort.asc': '从低到高',
...
const ko: Dict = {
  ...
  'mkt.search': '직업·도시 검색', 'mkt.more': '필터 더보기', 'mkt.chan': '경로', 'mkt.chan.all': '전체 직업', 'mkt.chan.pnp': 'PNP 목록에 있는 직업', 'mkt.chan.ee': 'EE 카테고리 해당 직업', 'mkt.chan.occOnly': '경로 필터는 X축이 직종일 때만 적용', 'mkt.y2.off': '숨기기', 'mkt.medLink': '주별 중위', 'mkt.sort': '정렬', 'mkt.sort.desc': '높은 순', 'mkt.sort.asc': '낮은 순',

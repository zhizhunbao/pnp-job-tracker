...
const zh: Dict = {
  ...
  'pnpdraws.title': '本省最近抽选 · {label}', 'pnpdraws.scale': '{scale} 省自评分制,非 CRS', 'pnpdraws.min': '最低 {score} 分', 'pnpdraws.inv': '{n} 份邀请',
  ...
  'fact.provStreams': '{n} 条省提名具名通道(点上方「PNP」列看命中)',
  'fact.salYrNote': '年薪折算:时薪×2080 · 日薪×260 · 周×52 · 双周×26 · 月×12;帖面为区间时取中点',
  ...
  'fact.scoreNote': '本站评分(满分 100,移民价值视角),与列表「评分」列同源;粗筛信号,非资格认定', 'score.base': '基准', 'score.indemand': '紧缺大类', 'score.low': '省具名通道', 'score.direct': '第一方雇主', 'score.exp': '经验', 'score.prov': '省份(非 ON)', 'score.total': '合计', 'score.stored': '入库',
  ...
  'match.r.teer.channel': 'TEER {teer},且命中具名通道「{stream}」',
...
const en: Dict = {
  ...
  'pnpdraws.title': 'Recent draws · {label}', 'pnpdraws.scale': '{scale} — provincial scale, not CRS', 'pnpdraws.min': 'min {score}', 'pnpdraws.inv': '{n} invitations',
  ...
  'fact.provStreams': '{n} provincial named streams (see the PNP column for hits)',
  'fact.salYrNote': 'Annualized: hourly ×2080 · daily ×260 · weekly ×52 · biweekly ×26 · monthly ×12; midpoint of ranges',
  ...
  'fact.scoreNote': 'Site score (out of 100, immigration-value lens), same formula as the Score column; a coarse signal, not an eligibility ruling', 'score.base': 'Baseline', 'score.indemand': 'In-demand group', 'score.low': 'Named PNP stream', 'score.direct': 'First-party employer', 'score.exp': 'Experience', 'score.prov': 'Province (non-ON)', 'score.total': 'Total', 'score.stored': 'stored',
  ...
  'match.r.teer.channel': 'TEER {teer}, and hits named stream "{stream}"',
...
const ko: Dict = {
  ...
  'pnpdraws.title': '해당 주 최근 추첨 · {label}', 'pnpdraws.scale': '{scale} — 주 자체 점수제, CRS 아님', 'pnpdraws.min': '최저 {score}점', 'pnpdraws.inv': '초청 {n}건',
  ...
  'fact.provStreams': '주 지명 스트림 {n}개 (PNP 열에서 해당 여부 확인)',
  'fact.salYrNote': '연봉 환산: 시급×2080 · 일급×260 · 주급×52 · 격주×26 · 월급×12; 구간은 중간값',
  ...
  'fact.scoreNote': '본 사이트 점수(100점 만점, 이민 가치 관점), 목록 「점수」 열과 동일 산식; 대략적 신호이며 자격 판정 아님', 'score.base': '기준', 'score.indemand': '부족 대분류', 'score.low': '주 지정 채널', 'score.direct': '직접 고용주', 'score.exp': '경력', 'score.prov': '주(ON 외)', 'score.total': '합계', 'score.stored': '저장값',
  ...
  'match.r.teer.channel': 'TEER {teer}이지만 지정 스트림 "{stream}" 해당',

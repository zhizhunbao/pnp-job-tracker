...
const zh: Dict = {
  ...
  'rec.prefix': '根据你最近浏览:', 'rec.cta': '看这些岗({n})', 'rec.build': '建档案精确匹配 →',
  // 大分类(数据值→显示)
...
const en: Dict = {
  ...
  'rec.prefix': 'Based on your recent browsing: ', 'rec.cta': 'See these jobs ({n})', 'rec.build': 'Build a profile for exact matching →',
...
const ko: Dict = {
  ...
  'rec.prefix': '최근 본 공고 기준: ', 'rec.cta': '이 공고 보기 ({n})', 'rec.build': '프로필 만들고 정확 매칭 →',

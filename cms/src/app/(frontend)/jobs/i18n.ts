...
const zh: Dict = {
  ...
  'pulse.unit.days': '{n} 天',
  'pulse.b1': '不在任何省紧缺清单', 'pulse.b1.note': '在架 ≥100;不在任何省具名紧缺清单——TEER 0-3 仍可走雇主担保类通道或联邦 EE,TEER 4-5 两者皆无、仅剩部分省的雇主担保通道',
...
const en: Dict = {
  ...
  'pulse.b1': 'Not on any provincial in-demand list', 'pulse.b1.note': '100+ open postings; on no named in-demand list. TEER 0-3 can still use employer-offer streams or federal EE; TEER 4-5 has neither, only employer-offer streams in some provinces',
...
const ko: Dict = {
  ...
  'pulse.unit.days': '{n}일',
  'pulse.b1': '어느 주 수요직업 목록에도 없음', 'pulse.b1.note': '게시 100건 이상; 수요직업 목록 미등재. TEER 0-3은 고용주 오퍼 스트림이나 연방 EE 가능, TEER 4-5는 둘 다 불가하며 일부 주의 고용주 오퍼 스트림만 남음',

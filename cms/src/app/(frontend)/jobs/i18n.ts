...
const zh: Dict = {
  ...
  'foot.disclaimer': '不构成移民或法律建议,我们不是持牌顾问(RCIC)',
  ...
  'rec.prefix': '根据你最近浏览:', 'rec.geoPrefix': '你所在的地区:', 'rec.cta': '看这些岗({n})', 'rec.cta0': '看这些岗', 'rec.build': '看你这行的报告', 'rec.seeAll': '看全部 {n} 个匹配岗', 'rec.notInterested': '不感兴趣',
  // 大分类(数据值→显示)
  ...
  'plan.pr.title': '拿 PR 评估', 'plan.pr.sub': '答 4 道基本题出粗版报告,答案随时可改',
  'plan.job.title': '找工作', 'plan.job.sub': '答 2 道题,看你这行在目标省的在招与薪资',
  'plan.career.title': '职业规划', 'plan.career.sub': '答 1 道题,看相邻职业的在招与薪资对照',
  'plan.pdf': '存为 PDF',
  'jd.rep.t': '你这行在 {prov}', 'jd.rep.open': '在招岗', 'jd.rep.elig': '其中粗筛可提名', 'jd.rep.med': '全国帖面中位年薪', 'jd.rep.go': '看这行的完整报告',
  'plan.prov.title': '选省份', 'plan.prov.sub': '答 1 道题,看哪个省对你这行最合适',
  'rpt.p.best': '{prov} 最合适:你这行在其公开清单「{label}」上,当地在招 {open} 岗,{named} 个命中具名通道',
  'rpt.p.second': '{prov} 次选:在招 {open} 岗,{named} 个命中具名通道',
  'rpt.p.screen': '{prov} 不公布职业清单,按 TEER {teer} 粗筛可走,当地在招 {open} 岗',
  'rpt.p.rank': '{n} 个省的完整顺序与每省差什么',
  'rpt.g.noOffer': '还没有 offer,雇主担保类通道谈不上',
  ...
  'plan.toReport': '出报告', 'plan.back': '改答案', 'plan.answered': '已答 {n}/4', 'plan.qn': '第 {n} 题,共 4 题', 'plan.prev': '上一题', 'plan.next': '下一题',
  'rpt.sec.ref': '依据与链接',
  'rpt.dest.jobs': '职位板', 'rpt.dest.pathways': '移民路径', 'rpt.dest.stats': '地区统计', 'rpt.dest.occ': '职业库', 'rpt.dest.site': '站内页面',
  'rpt.sec.c': '结论', 'rpt.sec.g': '还差什么', 'rpt.sec.n': '下一步', 'rpt.sec.a': '备选',
  'rpt.conf': '置信度', 'rpt.conf.low': '低', 'rpt.conf.mid': '中', 'rpt.conf.high': '高',
  'rpt.asOf': '数据日期 {d}', 'rpt.src': '出处',
  'rpt.c.listedHit': '你的职业(NOC {noc})在 {prov} 公开清单「{label}」上;当地在招 {open} 岗,其中 {named} 个命中具名通道',
  'rpt.c.listedMiss': '{prov} 公开清单查过:NOC {noc} 不在上面;当地 {open} 个在招岗走不了具名通道',
  ...
  'rpt.c.qc': '魁省走自己的甄选体系(不参加省提名),本报告不评估',
  ...
  'rpt.lock.score': '你的省估分分差与补分路径', 'rpt.lock.window': '时间窗:还赶得上几轮',
  ...
  'rpt.j.open': '{prov} 当前在招 {open} 岗', 'rpt.j.openNamed': '{prov} 当前在招 {open} 岗,其中 {named} 个命中具名通道',
  ...
  'rpt.j.sponsors': '有 {n} 家雇主发过命中具名通道的岗',
  // 卡⑥职业规划
...
const en: Dict = {
  ...
  'foot.disclaimer': 'Not immigration or legal advice; we are not RCICs',
  ...
  'rec.prefix': 'Based on your recent browsing: ', 'rec.geoPrefix': 'Jobs near you: ', 'rec.cta': 'See these jobs ({n})', 'rec.cta0': 'See these jobs', 'rec.build': 'Your occupation report', 'rec.seeAll': 'See all {n} matches', 'rec.notInterested': 'Not interested',
  ...
  'plan.pr.title': 'PR assessment', 'plan.pr.sub': '4 basic questions, first-pass report',
  'plan.job.title': 'Job search', 'plan.job.sub': '2 questions: openings and pay in your target province',
  'plan.career.title': 'Career planning', 'plan.career.sub': '1 question: neighbouring occupations compared',
  'plan.pdf': 'Save as PDF',
  'jd.rep.t': 'Your occupation in {prov}', 'jd.rep.open': 'Open postings', 'jd.rep.elig': 'Passing the PNP screen', 'jd.rep.med': 'Median posted pay, Canada', 'jd.rep.go': 'See the full report for this occupation',
  'plan.prov.title': 'Choose a province', 'plan.prov.sub': '1 question: which province fits your occupation',
  ...
  'rpt.g.noOffer': 'No job offer yet — employer-sponsored streams need one',
  ...
  'plan.toReport': 'See my report', 'plan.back': 'Change answers', 'plan.answered': '{n}/4 answered', 'plan.qn': 'Question {n} of 4', 'plan.prev': 'Previous', 'plan.next': 'Next',
  'rpt.sec.ref': 'Sources and links',
  'rpt.dest.jobs': 'Job board', 'rpt.dest.pathways': 'Pathways', 'rpt.dest.stats': 'Regional stats', 'rpt.dest.occ': 'Occupations', 'rpt.dest.site': 'On this site',
  'rpt.sec.c': 'Conclusions', 'rpt.sec.g': 'What is missing', 'rpt.sec.n': 'Next steps', 'rpt.sec.a': 'Alternatives',
  ...
  'rpt.lock.score': 'Your provincial score gap and how to close it', 'rpt.lock.window': 'Time window: how many rounds you can still catch',
...
const ko: Dict = {
  ...
  'foot.disclaimer': '이민 또는 법률 자문이 아니며, 당사는 RCIC가 아닙니다',
  ...
  'rec.prefix': '최근 본 공고 기준: ', 'rec.geoPrefix': '내 지역: ', 'rec.cta': '이 공고 보기 ({n})', 'rec.cta0': '이 공고 보기', 'rec.build': '내 직종 리포트', 'rec.seeAll': '전체 {n}개 매칭 보기', 'rec.notInterested': '관심 없음',
  ...
  'plan.pr.title': 'PR 평가', 'plan.pr.sub': '기본 4문항으로 1차 보고서, 답은 언제든 수정',
  'plan.job.title': '구직', 'plan.job.sub': '2문항: 희망 주의 채용과 급여 확인',
  'plan.career.title': '커리어 설계', 'plan.career.sub': '1문항: 인접 직업 대조',
  'plan.pdf': 'PDF로 저장',
  'jd.rep.t': '{prov}의 내 직종', 'jd.rep.open': '채용 중', 'jd.rep.elig': '주 지명 1차 통과', 'jd.rep.med': '전국 공고 중위 연봉', 'jd.rep.go': '이 직종의 전체 리포트 보기',
  'plan.prov.title': '주 선택', 'plan.prov.sub': '1문항: 내 직종에 맞는 주 확인',
  ...
  'rpt.g.noOffer': '잡오퍼 없음 — 고용주 보증 스트림 불가',
  ...
  'plan.toReport': '보고서 보기', 'plan.back': '답 수정', 'plan.answered': '{n}/4 답변', 'plan.qn': '4문항 중 {n}번', 'plan.prev': '이전', 'plan.next': '다음',
  'rpt.sec.ref': '출처와 링크',
  'rpt.dest.jobs': '채용 보드', 'rpt.dest.pathways': '이민 경로', 'rpt.dest.stats': '지역 통계', 'rpt.dest.occ': '직업 목록', 'rpt.dest.site': '사이트 내 페이지',
  'rpt.sec.c': '결론', 'rpt.sec.g': '부족한 것', 'rpt.sec.n': '다음 단계', 'rpt.sec.a': '대안',
  ...
  'rpt.c.qc': '퀘벡주는 자체 선발 제도를 운영하므로(PNP 불참) 본 보고서에서 평가하지 않습니다',
  ...
  'rpt.lock.score': '내 주 점수 격차와 보완 경로', 'rpt.lock.window': '체류 기간 내 남은 회차',

...
const zh: Dict = {
  ...
  'pulse.total': '共 {n} 个职业', 'pulse.totalEmp': '共 {n} 家', 'pulse.topEmp': '前 {m} 家(共 {n} 家)',
  'pulse.s4': '分省概览',
  ...
  'dir.title': '雇主名录',
  'dir.col.employer': '雇主', 'dir.col.skilled': '技能类获批(近两年)', 'dir.col.quarter': '最近季度', 'dir.col.skilled.tip': '高薪(High Wage)与全球人才(Global Talent)股别的 LMIA 获批职位数——不含农业/低薪季节工;想找愿意办技能类工作担保的雇主,看这个数',
  ...
  'se.title': '在招担保雇主',
  'se.chip.aip': 'AIP 指定', 'se.where.sep': '、',
  'se.col.open': '在招', 'se.col.where': '所在地', 'se.where.multi': '{n} 省',
  'se.col.lmia': 'LMIA 获批(近两年)', 'se.col.named': 'PNP 担保记录', 'se.col.alias': '中文名', 'se.col.grade': '担保档', 'se.col.w1': 'LMIA 最近一季', 'se.col.w2': 'LMIA 近半年', 'se.col.w4': 'LMIA 近一年', 'se.col.streams': '命中省清单',
  'se.grp.aip': 'AIP 指定雇主', 'se.grp.lmia': 'LMIA 获批雇主(近两年)', 'se.grp.named': 'PNP 担保记录雇主', 'pulse.nav.boards': '职业榜',
...
const en: Dict = {
  ...
  'pulse.b1': 'Not-in-demand occupations',
  ...
  'pulse.b1a': 'Excluded in some provinces',
  ...
  'pulse.total': '{n} occupations', 'pulse.totalEmp': '{n} employers', 'pulse.topEmp': 'Top {m} of {n} employers',
  ...
  'dir.col.employer': 'Employer', 'dir.col.skilled': 'Skilled approvals (2y)', 'dir.col.quarter': 'Latest quarter', 'dir.col.skilled.tip': 'Approved LMIA positions in High Wage / Global Talent streams — excludes Primary Agriculture / Low Wage seasonal hiring; this is the number that matters for skilled sponsorship',
  ...
  'se.chip.aip': 'AIP designated', 'se.where.sep': ', ',
  'se.col.open': 'Open jobs', 'se.col.where': 'Location', 'se.where.multi': '{n} provinces',
  'se.col.lmia': 'LMIA approved (2 yrs)', 'se.col.named': 'PNP sponsorship record', 'se.col.alias': 'Alias', 'se.col.grade': 'Sponsor grade', 'se.col.w1': 'LMIA last quarter', 'se.col.w2': 'LMIA 6 months', 'se.col.w4': 'LMIA 1 year', 'se.col.streams': 'Provincial lists hit',
  'se.grp.aip': 'AIP designated employers', 'se.grp.lmia': 'LMIA-approved employers (2 yrs)', 'se.grp.named': 'Employers with PNP sponsorship records', 'pulse.nav.boards': 'Occupation boards',
...
const ko: Dict = {
  ...
  'pulse.total': '총 {n}개 직업', 'pulse.totalEmp': '총 {n}곳', 'pulse.topEmp': '상위 {m}곳(총 {n}곳)',
  'pulse.s4': '주별 개요',
  ...
  // B4-01 디렉터리
  'dir.title': '고용주 디렉터리',
  'dir.col.employer': '고용주', 'dir.col.skilled': '숙련 승인(2년)', 'dir.col.quarter': '최신 분기', 'dir.col.skilled.tip': 'High Wage / Global Talent 스트림의 승인 LMIA 포지션 수 — Primary Agriculture / Low Wage 계절성 고용 제외; 숙련 스폰서를 찾는다면 이 숫자를 참고하세요.',
  ...
  'se.chip.aip': 'AIP 지정', 'se.where.sep': '、',
  'se.col.open': '채용 중', 'se.col.where': '지역', 'se.where.multi': '{n}개 주',
  'se.col.lmia': 'LMIA 승인(2년)', 'se.col.named': 'PNP 스폰서 이력', 'se.col.alias': '한국어 이름', 'se.col.grade': '스폰서 등급', 'se.col.w1': 'LMIA 최근 분기', 'se.col.w2': 'LMIA 6개월', 'se.col.w4': 'LMIA 1년', 'se.col.streams': '해당 주 목록',
  'se.grp.aip': 'AIP 지정 고용주', 'se.grp.lmia': 'LMIA 승인 고용주(2년)', 'se.grp.named': 'PNP 스폰서 이력 고용주', 'pulse.nav.boards': '직업 보드',

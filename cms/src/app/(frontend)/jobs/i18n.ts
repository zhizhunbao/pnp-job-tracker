...
const zh: Dict = {
  ...
  'dp.sum.occ': '职业', 'dp.sum.status': '当前情况', 'dp.sum.provN': '{first}、{second} 等 {n} 省', 'dp.sum.edu': '学历', 'dp.sum.age': '年龄', 'dp.sum.clb': '语言',
...
const en: Dict = {
  ...
  'dp.sum.occ': 'Occupation', 'dp.sum.status': 'Current situation', 'dp.sum.provN': '{first}, {second} +{n} total', 'dp.sum.edu': 'Education', 'dp.sum.age': 'Age', 'dp.sum.clb': 'Language',
...
const ko: Dict = {
  ...
  'dp.sum.occ': '직업', 'dp.sum.status': '현재 상황', 'dp.sum.provN': '{first}, {second} 외 총 {n}곳', 'dp.sum.edu': '학력', 'dp.sum.age': '나이', 'dp.sum.clb': '언어',

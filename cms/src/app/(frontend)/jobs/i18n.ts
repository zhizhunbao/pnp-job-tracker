...
const zh: Dict = {
  ...
  'res.title': '官方资源导航', 'res.sub': '加拿大移民官方入口一页汇总:官方来源,可自行核实', 'res.go': '官方页', 'res.entry': '官方资源',
  'res.note': '以上均为政府/官方机构页面,内容以官方发布为准;本站仅做整理归类,不控制其内容。链接失效或有补充请反馈。',
  'res.cat.federal': '联邦移民', 'res.cat.pnp': '各省提名(PNP)', 'res.cat.wage': '工资与职业数据', 'res.cat.lmia': 'LMIA 与雇主担保', 'res.cat.authority': '权威与合规',
...
const en: Dict = {
  ...
  'res.title': 'Official resources', 'res.sub': 'Canadian immigration — official links in one place, verify for yourself', 'res.go': 'Official', 'res.entry': 'Official resources',
  ...
  'res.cat.federal': 'Federal immigration', 'res.cat.pnp': 'Provincial nominees (PNP)', 'res.cat.wage': 'Wage & occupation data', 'res.cat.lmia': 'LMIA & employer sponsorship', 'res.cat.authority': 'Authority & compliance',
...
const ko: Dict = {
  ...
  'res.title': '공식 자료 안내', 'res.sub': '캐나다 이민 공식 링크 한 페이지 모음, 직접 확인하세요', 'res.go': '공식', 'res.entry': '공식 자료',
  'res.note': '모두 정부/공식 기관 페이지이며 공식 발표가 우선합니다. 본 사이트는 정리만 하며 내용을 관리하지 않습니다.',
  'res.cat.federal': '연방 이민', 'res.cat.pnp': '주 지명(PNP)', 'res.cat.wage': '임금·직업 데이터', 'res.cat.lmia': 'LMIA·고용주 지원', 'res.cat.authority': '권위·규정',

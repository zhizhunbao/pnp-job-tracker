...
const zh: Dict = {
  ...
  'col.pnp': 'PNP', 'col.ee': 'EE 类别', 'col.aip': 'AIP', 'col.lmia': '外劳记录', 'col.eligibility': '身份预筛', 'col.status': '状态', 'col.firstSeen': '首次收录', 'col.lastSeen': '更新时间', 'col.closedAt': '下架时间', 'col.score': '评分',
...
const en: Dict = {
  ...
  'col.pnp': 'PNP', 'col.ee': 'EE category', 'col.aip': 'AIP', 'col.lmia': 'LMIA history', 'col.eligibility': 'Visa flags', 'col.status': 'Status', 'col.firstSeen': 'First seen', 'col.lastSeen': 'Updated', 'col.closedAt': 'Closed', 'col.score': 'Score',
...
const ko: Dict = {
  ...
  'col.pnp': 'PNP', 'col.ee': 'EE 카테고리', 'col.aip': 'AIP', 'col.lmia': 'LMIA 이력', 'col.eligibility': '비자 플래그', 'col.status': '상태', 'col.firstSeen': '최초 수집', 'col.lastSeen': '업데이트 시각', 'col.closedAt': '마감일', 'col.score': '점수',
  ...
  'fact.scoreNote': '본 사이트 점수(100점 만점, 이민 가치 관점), 목록 「점수」 열과 동일한 산식; 자격 판정이 아닌 대략적인 신호입니다. 이 점수는 모든 사용자에게 동일하게 적용되며, 개인화된 분석은 「나의 매칭」(프로필 필요)을 이용하세요.', 'score.base': '기준', 'score.indemand': '수요 직종 그룹', 'score.low': 'PNP 직종 목록 포함', 'score.direct': '직접 고용주', 'score.exp': '경력', 'score.prov': '주(ON 제외)', 'score.total': '합계', 'score.stored': '저장됨',

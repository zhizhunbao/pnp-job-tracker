...
const zh: Dict = {
  ...
  'pulse.card.days': '平均在架天数', 'pulse.card.pnp': '省提名清单岗',
  ...
  'pulse.unit.days': '{n} 天',
  'pulse.b1': '无省提名通道', 'pulse.b1.note': '在架 ≥100 的职业;剩余路径为联邦 EE 或法语类别',
  'pulse.b2': '有通道,岗位收缩中', 'pulse.b2.note': '在架 ≥100,按跌幅排序',
  'pulse.b3': '有通道,岗位增长中', 'pulse.b3.note': '在架 ≥100,按涨幅排序',
  'pulse.provs.none': '无', 'pulse.provs.none.tip': '不在任何省提名清单;仅剩联邦 EE 或法语类别路径',
  'pulse.col.occ': '职业', 'pulse.col.open': '在架', 'pulse.col.mom': '14 天新增环比',
  'pulse.col.provs': '可提名省份', 'pulse.col.provs.tip': '该职业当前有省提名清单命中在架岗的省份;粗筛信号,不等于资格认定',
...
const en: Dict = {
  ...
  'pulse.card.days': 'Avg days open', 'pulse.card.pnp': 'PNP-list jobs open',
  ...
  'pulse.b1': 'No provincial nominee pathway', 'pulse.b1.note': '100+ open postings; remaining routes are federal EE or the French stream',
  'pulse.b2': 'Pathway open, postings contracting', 'pulse.b2.note': '100+ open postings, steepest decline first',
  'pulse.b3': 'Pathway open, postings growing', 'pulse.b3.note': '100+ open postings, strongest growth first',
  'pulse.provs.none': 'None', 'pulse.provs.none.tip': 'On no provincial nominee list — the only routes left are federal CRS points or the French stream',
  'pulse.col.occ': 'Occupation', 'pulse.col.open': 'Open', 'pulse.col.mom': '14d posting change',
  'pulse.col.provs': 'PNP provinces', 'pulse.col.provs.tip': 'Provinces where this occupation currently has open postings hitting a nominee occupation list. A rough signal, not an eligibility ruling',
...
const ko: Dict = {
  ...
  'pulse.card.days': '평균 게시 일수', 'pulse.card.pnp': 'PNP 목록 공고',
  ...
  'pulse.unit.days': '{n}일',
  'pulse.b1': '주정부 지명 경로 없음', 'pulse.b1.note': '게시 100건 이상; 남은 경로는 연방 EE 또는 프랑스어 계열',
  'pulse.b2': '경로 있음, 공고 감소세', 'pulse.b2.note': '게시 100건 이상, 감소폭 순',
  'pulse.b3': '경로 있음, 공고 증가세', 'pulse.b3.note': '게시 100건 이상, 증가폭 순',
  'pulse.provs.none': '없음', 'pulse.provs.none.tip': '어느 주 지명 목록에도 없음 — 남은 길은 연방 CRS 점수나 프랑스어 스트림뿐',
  'pulse.col.occ': '직업', 'pulse.col.open': '게시', 'pulse.col.mom': '14일 신규 증감률',
  'pulse.col.provs': 'PNP 가능 주', 'pulse.col.provs.tip': '이 직업이 현재 지명 직업 목록에 해당하는 공고를 보유한 주. 참고 신호이며 자격 판정이 아닙니다',

...
const zh: Dict = {
  ...
  'pulse.unit.days': '{n} 天',
  'pulse.b1': '不在任何省紧缺清单', 'pulse.b1.note': '在架 ≥100;不在任何省具名紧缺清单,仍可能走雇主担保类通用通道或联邦 EE(TEER 0-3)',
  'pulse.b2': '紧缺清单在列,岗位收缩中', 'pulse.b2.note': '在架 ≥100,按跌幅排序',
  'pulse.b3': '紧缺清单在列,岗位增长中', 'pulse.b3.note': '在架 ≥100,按涨幅排序',
  'pulse.provs.none': '无', 'pulse.provs.none.tip': '不在任何省具名紧缺清单;仍可能走雇主担保类通用通道(如 ON/AB/BC)或联邦 EE(TEER 0-3)',
  'pulse.provs.n': '{n} 省',
  ...
  'pulse.col.pnpProvs': '可提名省份', 'pulse.col.pnpProvs.tip': '按各省规则(排除式省默认可、具名清单、雇主担保类)逐省判定的可走省提名省份;QC 不属 PNP;粗筛信号,不等于资格认定',
...
const en: Dict = {
  ...
  'pulse.b1': 'Not on any provincial in-demand list', 'pulse.b1.note': '100+ open postings; on no named in-demand list — general employer-offer streams or federal EE (TEER 0-3) may still apply',
  'pulse.b2': 'On an in-demand list, postings contracting', 'pulse.b2.note': '100+ open postings, steepest decline first',
  'pulse.b3': 'On an in-demand list, postings growing', 'pulse.b3.note': '100+ open postings, strongest growth first',
  'pulse.provs.none': 'None', 'pulse.provs.none.tip': 'On no named provincial in-demand list — general employer-offer streams (e.g. ON/AB/BC) or federal EE (TEER 0-3) may still apply',
  ...
  'pulse.col.pnpProvs': 'PNP-eligible provinces', 'pulse.col.pnpProvs.tip': 'Provinces where an employer-offer PNP route applies (exclusion-based default, named list, or employer-sponsored stream). Excludes QC. A rough signal, not an eligibility ruling',
...
const ko: Dict = {
  ...
  'pulse.unit.days': '{n}일',
  'pulse.b1': '어느 주 수요직업 목록에도 없음', 'pulse.b1.note': '게시 100건 이상; 주정부 수요직업 목록 미등재 — 고용주 오퍼 기반 일반 스트림이나 연방 EE(TEER 0-3)는 가능할 수 있음',
  'pulse.b2': '수요직업 목록 등재, 공고 감소세', 'pulse.b2.note': '게시 100건 이상, 감소폭 순',
  'pulse.b3': '수요직업 목록 등재, 공고 증가세', 'pulse.b3.note': '게시 100건 이상, 증가폭 순',
  'pulse.provs.none': '없음', 'pulse.provs.none.tip': '어느 주 수요직업 목록에도 없음 — 고용주 오퍼 일반 스트림(ON/AB/BC 등)이나 연방 EE(TEER 0-3)는 가능할 수 있음',
  'pulse.provs.n': '{n}개 주',
  ...
  'pulse.col.pnpProvs': 'PNP 가능 주', 'pulse.col.pnpProvs.tip': '고용주 오퍼 기반 PNP 경로가 적용되는 주(제외식 주 기본 가능, 지정 목록, 고용주 후원 스트림). QC 제외. 참고 신호이며 자격 판정이 아닙니다',

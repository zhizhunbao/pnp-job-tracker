...
const zh: Dict = {
  ...
  'occ.kin': '相关职业', 'occ.kinHint': '根据已选方向推荐',
  ...
  'ps.title': '省提名自评打分', 'ps.extraTitle': '再回答几个问题', 'ps.extraYou': '该省还需要这些条件',
  'ps.pickProvinceTitle': '选择具体省份', 'ps.pickProvinceHint': '各省采用不同的提名和计分制度，多个省不能合并成一个分数。请选择一个省继续。',
  'ps.extraHint': '一次只回答一题；选完自动进入下一题，全部完成后再显示估分。',
  'ps.extraN': '{n} 项', 'ps.progress': '已答 {done}/{total}', 'ps.questionN': '第 {current}/{total} 题',
  'ps.complete': '已完成 {n} 个问题', 'ps.edit': '修改答案', 'ps.q.meet': '你是否符合：{condition}',
  'ps.yes': '是', 'ps.no': '否', 'ps.confirm': '确认', 'ps.previous': '上一题',
...
const en: Dict = {
  ...
  'dp.basicCount': 'Basics {done}/{total}',
  ...
  'occ.kin': 'Related occupations', 'occ.kinHint': 'based on your selection',
  ...
  'ps.title': 'PNP self-assessment score', 'ps.extraTitle': 'A few more questions', 'ps.extraYou': 'Additional factors used by this province',
  ...
  'ps.extraHint': 'Answer one question at a time. Your estimate appears after all questions are complete.',
  'ps.extraN': '{n} items', 'ps.progress': '{done}/{total} answered', 'ps.questionN': 'Question {current}/{total}',
  'ps.complete': '{n} additional questions completed', 'ps.edit': 'Edit answers', 'ps.q.meet': 'Does this apply to you: {condition}',
  'ps.yes': 'Yes', 'ps.no': 'No', 'ps.confirm': 'Confirm', 'ps.previous': 'Previous',
...
const ko: Dict = {
  ...
  'occ.kin': '연관 직업', 'occ.kinHint': '선택한 방향 기준 추천',
  ...
  'ps.title': '주정부 이민 자가 점수', 'ps.extraTitle': '몇 가지 추가 질문', 'ps.extraYou': '이 주에서 추가로 필요한 조건',
  'ps.pickProvinceTitle': '구체적인 주 선택', 'ps.pickProvinceHint': '주마다 지명 및 점수 제도가 달라 여러 주를 하나의 점수로 합칠 수 없습니다. 계속하려면 한 주를 선택하세요.',
  'ps.extraHint': '한 번에 한 질문씩 답하세요. 모든 질문을 완료하면 예상 점수가 표시됩니다.',
  'ps.extraN': '{n}개', 'ps.progress': '{done}/{total} 답변', 'ps.questionN': '질문 {current}/{total}',
  'ps.complete': '추가 조건 {n}개 완료', 'ps.edit': '답변 수정', 'ps.q.meet': '다음 조건에 해당하나요: {condition}',
  'ps.yes': '예', 'ps.no': '아니요', 'ps.confirm': '확인', 'ps.previous': '이전 질문',

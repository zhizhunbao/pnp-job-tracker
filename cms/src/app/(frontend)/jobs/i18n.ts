...
const zh: Dict = {
  ...
  'dp.planBelowLine': '估分 {v},低于最近抽选线 {line}', 'dp.planCoarse': '按职业粗筛', 'dp.planCoarseSub': '职业:{occ};答完 8 题出个人初评', 'dp.planCoarseNote': '按职业粗筛,非资格认定;答完 8 题按你的条件排出个人通道', 'dp.planGateSame': '以上通道门槛相同:{s}', 'dp.planGate': '门槛', 'dp.planWhy': '推荐原因', 'dp.planWhyMet': '其余门槛已达标', 'dp.planPath': '通道', 'dp.planOpen': '在招', 'dp.planJobsN': '{n} 岗',
  ...
  'dp.planCommonGate': '以下通道同差:{s}', 'dp.planOnlyCommon': '无额外缺口',
  // #306:tier 是攒够门槛所需,排队与审批不在内
  'dp.planNoQueue': '以上时长为攒够门槛所需,不含排队与审批',
  // #318 已排除组 / #323 操作列 / #325 带岗语境
  'dp.planExcluded': '已排除', 'dp.act': '操作', 'dp.actGo': '去投递', 'dp.planJobProvRow': '本岗所在省',
  'dp.provCtxNone': '目标省未选;这份岗在{jobProv}', 'dp.occCtx': '初评按你档案的职业({occ})评估,不按本岗职业',
...
const en: Dict = {
  ...
  'dp.planTierGrad1': 'About 3–6 months after graduation and permit', 'dp.planTierGrad2': 'About 12 months after graduation and permit', 'dp.planTierGrad3': 'About 24 months after graduation and permit',
  'dp.planCommonGate': 'All routes below still need: {s}', 'dp.planOnlyCommon': 'No other gap',
  'dp.planNoQueue': 'Times cover building the thresholds only, not queues or processing',
  'dp.planExcluded': 'Ruled out', 'dp.act': 'Action', 'dp.actGo': 'Apply', 'dp.planJobProvRow': 'This job’s province',
  'dp.provCtxNone': 'No target province chosen; this job is in {jobProv}', 'dp.occCtx': 'Assessed on your profile occupation ({occ}), not this job’s',
...
const ko: Dict = {
  ...
  'dp.planBelowLine': '추정 {v}점, 최근 커트라인 {line} 미만', 'dp.planCoarse': '직업 기준 사전 선별', 'dp.planCoarseSub': '직업: {occ}; 8문항 완료 시 개인 평가 제공', 'dp.planCoarseNote': '직업 기준 사전 선별로 자격 판정이 아님; 8문항 완료 시 조건에 맞춰 경로 정렬', 'dp.planGateSame': '모든 경로의 관문 동일: {s}', 'dp.planGate': '관문', 'dp.planWhy': '추천 이유', 'dp.planWhyMet': '나머지 요건 충족', 'dp.planPath': '경로', 'dp.planOpen': '채용 중', 'dp.planJobsN': '{n}건',
  ...
  'dp.planTierGrad1': '졸업·워크퍼밋 후 약 3–6개월', 'dp.planTierGrad2': '졸업·워크퍼밋 후 약 12개월', 'dp.planTierGrad3': '졸업·워크퍼밋 후 약 24개월',
  'dp.planCommonGate': '아래 통로 공통 부족: {s}', 'dp.planOnlyCommon': '추가 부족 없음',
  'dp.planNoQueue': '위 기간은 요건 충족 기준이며 대기·심사 기간은 제외',
  'dp.planExcluded': '제외됨', 'dp.act': '작업', 'dp.actGo': '지원하기', 'dp.planJobProvRow': '이 공고의 주',
  'dp.provCtxNone': '목표 주 미선택; 이 공고는 {jobProv}', 'dp.occCtx': '초평은 프로필 직업({occ}) 기준이며 이 공고 직업 기준이 아님',

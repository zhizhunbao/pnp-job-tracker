...
const zh: Dict = {
  ...
  'dir.note.lmia': '「雇过外国人」的历史记录,不代表现在能或愿意担保你。',
  ...
  'quiz.openN': '{n} 在招', 'quiz.jobsN': '{n} 岗',
  // 入口全屏页的信任栏(Frank「像钓鱼网站」):全是库内真数与官方来源署名,不写宣传语
  'quiz.tr.jobs': '个在招职位', 'quiz.tr.named': '岗命中省提名清单', 'quiz.tr.lmia': '家雇主有外劳雇佣记录',
  'quiz.tr.src': '数据来自 Job Bank、IRCC、ESDC、StatCan 的公开发布,每日抓取核对。', 'quiz.payoff': '答完立刻看到:各省在招数、其中可提名数、中位年薪',
...
const en: Dict = {
  ...
  'dir.note.lmia': 'A record of having hired foreign workers — not a sign they can or will sponsor you now.',
  ...
  'quiz.openN': '{n} open', 'quiz.jobsN': '{n} jobs',
  'quiz.tr.jobs': 'open jobs', 'quiz.tr.named': 'on provincial PNP lists', 'quiz.tr.lmia': 'employers with LMIA records',
  'quiz.tr.src': 'Sourced from public Job Bank, IRCC, ESDC and StatCan releases, refreshed daily.', 'quiz.payoff': 'You will see: openings by province, how many are PNP-eligible, median pay',
...
const ko: Dict = {
  ...
  'dir.note.lmia': '외국인을 고용한 이력일 뿐, 지금 스폰서가 가능하거나 하겠다는 뜻은 아닙니다.',
  ...
  'quiz.openN': '채용중 {n}건', 'quiz.jobsN': '{n}건',
  'quiz.tr.jobs': '개 채용중', 'quiz.tr.named': '건 주정부 지명 목록 해당', 'quiz.tr.lmia': '개 고용주 LMIA 기록 보유',
  'quiz.tr.src': 'Job Bank·IRCC·ESDC·StatCan 공개 자료를 매일 수집·대조합니다.', 'quiz.payoff': '답하면 바로: 주별 채용 수, 그중 지명 가능 수, 중위 연봉',

...
const zh: Dict = {
  ...
  'quiz.openN': '{n} 在招', 'quiz.jobsN': '{n} 岗', 'quiz.payoff': '答完立刻看到:各省在招数、其中可提名数、中位年薪',
...
const en: Dict = {
  ...
  'quiz.openN': '{n} open', 'quiz.jobsN': '{n} jobs', 'quiz.payoff': 'You will see: openings by province, how many are PNP-eligible, median pay',
...
const ko: Dict = {
  ...
  'quiz.openN': '채용중 {n}건', 'quiz.jobsN': '{n}건', 'quiz.payoff': '답하면 바로: 주별 채용 수, 그중 지명 가능 수, 중위 연봉',

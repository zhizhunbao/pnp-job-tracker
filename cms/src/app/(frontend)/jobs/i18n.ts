...
const zh: Dict = {
  ...
  'dp.planTitle': '你的初步方案', 'dp.planHint': '先按职业、语言、经验和目标省给出可走方向；具体岗位和雇主留到下一步验证。',
  'dp.planTier0': '优先核对', 'dp.planTier1': '约需积累 3–6 个月', 'dp.planTier2': '约需积累 12 个月', 'dp.planTier3': '约需积累 24 个月',
  'dp.planBlocked.language': '语言未达门槛', 'dp.planBlocked.selfEmployed': '自雇经历不计',
  'dp.planBlocked.offer': '要先有 offer', 'dp.planBlocked.statusInCanada': '要人在加拿大', 'dp.planBlocked.credentialCanada': '要加拿大学历',
  ...
  'tv.build': '填写个人条件', 'tv.ask': '{co} 这份工作能帮我拿身份吗?', 'tv.err': '数据暂不可用',
  'tv.lockN': '{n} 条结论已锁',
  'tv.g.occ': '职业匹配', 'tv.g.emp': '雇主资质', 'tv.g.you': '个人条件', 'tv.g.youCard': '个人条件', 'tv.filled': '已填写',
...
const en: Dict = {
  ...
  'dp.planTitle': 'Your initial pathway plan', 'dp.planHint': 'See viable directions from your occupation, language, experience, and target province first. Verify a specific job and employer afterward.',
  ...
  'dp.planBlocked.offer': 'Needs a job offer first', 'dp.planBlocked.statusInCanada': 'Needs to be in Canada', 'dp.planBlocked.credentialCanada': 'Needs a Canadian credential',
  ...
  'tv.build': 'Fill in my profile', 'tv.ask': 'Can this job at {co} get me PR?', 'tv.err': 'Data unavailable right now',
  'tv.lockN': '{n} conclusions locked',
  'tv.g.occ': 'Occupation', 'tv.g.emp': 'Employer', 'tv.g.you': 'You', 'tv.g.youCard': 'Your verdict', 'tv.filled': 'Provided',
...
const ko: Dict = {
  ...
  'dp.planTitle': '나의 1차 경로 계획', 'dp.planHint': '직업·언어·경력·희망 주를 기준으로 가능한 방향을 먼저 보여 드립니다. 특정 공고와 고용주는 다음 단계에서 검증합니다.',
  ...
  'dp.planBlocked.offer': '잡 오퍼가 먼저', 'dp.planBlocked.statusInCanada': '캐나다 체류 필요', 'dp.planBlocked.credentialCanada': '캐나다 학력 필요',
  ...
  'tv.build': '개인 조건 입력', 'tv.ask': '{co}의 이 일자리로 영주권을 받을 수 있나요?', 'tv.err': '지금은 데이터를 불러올 수 없습니다',
  'tv.lockN': '{n}개 결론 잠김',
  'tv.g.occ': '직업 적합성', 'tv.g.emp': '고용주 자격', 'tv.g.you': '개인 조건', 'tv.g.youCard': '개인 조건', 'tv.filled': '입력 완료',

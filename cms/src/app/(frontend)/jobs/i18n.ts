...
const zh: Dict = {
  ...
  'sl.needProv': '先在上面选目标省份', 'sl.date': '抽选日', 'sl.stream': '通道', 'sl.cutoff': '分数线', 'sl.you': '你', 'sl.cutoffN': '分数线 {n}',
...
const en: Dict = {
  ...
  'sl.needProv': 'Pick your target province above first', 'sl.date': 'Draw date', 'sl.stream': 'Stream', 'sl.cutoff': 'Cutoff', 'sl.you': 'You', 'sl.cutoffN': 'Cutoff {n}',
...
const ko: Dict = {
  ...
  'sl.needProv': '위에서 목표 주를 먼저 선택하세요', 'sl.date': '선발일', 'sl.stream': '스트림', 'sl.cutoff': '커트라인', 'sl.you': '나', 'sl.cutoffN': '커트라인 {n}',

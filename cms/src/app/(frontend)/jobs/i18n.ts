...
const zh: Dict = {
  ...
  'occ.selected': '已选 {n}/3', 'occ.resultN': '找到 {n} 个职业', 'occ.noResult': '没有找到匹配职业,换个关键词试试',
  'plan.reset': '清空重填',
  ...
  'quiz.q2': '你做过或想找什么工作?', 'quiz.q2sub': '学生或暂未工作,请选择想找的方向;最多 3 个', 'quiz.q2ph': '搜职业方向,如程序员、厨师、护理员',
  ...
  'ps.title': '省提名自评打分', 'ps.extraTitle': '补充条件估分', 'ps.extraYou': '该省还需要这些条件',
  'ps.pickProvinceTitle': '选择具体省份', 'ps.pickProvinceHint': '各省采用不同的提名和计分制度，多个省不能合并成一个分数。请选择一个省继续。',
  'ps.extraHint': '上方语言和总经验范围已按保守下界预填；请在这里确认官方表需要的精确档位，未选择的项目按 0 分。',
  'ps.extraN': '{n} 项',
...
const en: Dict = {
  ...
  'occ.selected': '{n}/3 selected', 'occ.resultN': '{n} occupations found', 'occ.noResult': 'No matching occupation. Try another keyword.',
  ...
  'quiz.q2': 'What work have you done or want to pursue?', 'quiz.q2sub': 'Students and job seekers can choose a target direction; pick up to 3', 'quiz.q2ph': 'Search a direction, e.g. programmer, cook, nurse aide',
  ...
  'ps.title': 'PNP self-assessment score', 'ps.extraTitle': 'Additional questions for an estimate', 'ps.extraYou': 'Additional factors used by this province',
  ...
  'ps.extraHint': 'Your language and experience ranges are prefilled at their conservative lower bounds. Confirm the exact bands required by this official grid; unanswered items count as zero.',
  'ps.extraN': '{n} items',
...
const ko: Dict = {
  ...
  'occ.selected': '{n}/3개 선택', 'occ.resultN': '직업 {n}개 찾음', 'occ.noResult': '일치하는 직업이 없습니다. 다른 검색어를 입력해 보세요.',
  'plan.reset': '전체 지우기',
  ...
  'quiz.q2': '해 본 일이나 찾고 싶은 일은 무엇인가요?', 'quiz.q2sub': '학생·구직자는 원하는 방향을 선택하세요; 최대 3개', 'quiz.q2ph': '직무 방향 검색: 프로그래머, 요리사, 요양보호사 등',
  ...
  'ps.title': '주정부 이민 자가 점수', 'ps.extraTitle': '추가 조건 예상 점수', 'ps.extraYou': '이 주에서 추가로 필요한 조건',
  'ps.pickProvinceTitle': '구체적인 주 선택', 'ps.pickProvinceHint': '주마다 지명 및 점수 제도가 달라 여러 주를 하나의 점수로 합칠 수 없습니다. 계속하려면 한 주를 선택하세요.',
  'ps.extraHint': '위에서 선택한 언어·경력 범위는 보수적인 하한값으로 미리 입력됩니다. 공식 점수표에 필요한 정확한 구간을 확인하세요. 미선택 항목은 0점입니다.',
  'ps.extraN': '{n}개',

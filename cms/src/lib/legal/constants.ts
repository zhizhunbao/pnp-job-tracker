...
import type { LangCode, LegalDoc, LegalPage } from './types'
  ...
  privacy: {
    ...
    en: {
      ...
      sections: [
        ...
        {
          h: '6. Your rights and account deletion',
          body: [
  ...
  terms: {
    ...
    en: {
      ...
      sections: [
        ...
        {
          h: '5. Data sources and intellectual property',
          body: [
        ...
        {
          h: '6. Employer / platform takedown',
          body: [
  ...
  disclaimer: {
    ...
    en: {
      ...
      sections: [
        ...
        {
          h: '3. Flags and matches are mechanical comparisons, not eligibility rulings',
          body: [
    ...
    ko: {
      ...
      sections: [
        ...
        {
          h: '3. 표시와 매칭은 기계적 비교이며 자격 판정이 아님',
          body: [

...
import {
  ...
  RECENT_ON_GRADUATE, REQ_FACTOR, REQ_UNIT, ROW_KEY_RE, ROW_SEQ_MAX, SCORE_FACTOR, SECTOR_FEDERAL, SECTOR_GOVERNMENT, SECTOR_PUBLIC,
  SEP, SINK, SLOT,
...
export function employerVerdict(input: EmployerVerdictIn): EmployerVerdict {
  if (input.facts.sector === SECTOR_PUBLIC || input.facts.sector === SECTOR_GOVERNMENT
    || input.facts.sector === SECTOR_FEDERAL) {

...
import {
  ...
  COLS_PILOT_OCCUPATIONS, COLS_PILOT_QUOTA, COLS_PNP_DRAWS, COLS_PTE_AUDIO, COLS_PTE_QUESTIONS, COLS_PTE_TYPES, COLS_PNP_OCCUPATIONS, COLS_PNP_OPS_STATS,
  ...
  TBL_NOC_DESCRIPTIONS, TBL_NOC_OPENINGS, TBL_PILOT_COMMUNITIES, TBL_PILOT_OCCUPATIONS, TBL_PILOT_QUOTA, TBL_PTE_AUDIO, TBL_PTE_QUESTIONS, TBL_PTE_TYPES,

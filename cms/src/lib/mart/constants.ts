 ...
 */
export const COLS_EMPLOYER_POOL = ['key', 'slug', 'name', 'industry', 'province', 'city', 'locations', 'designated', 'designated_programs', 'designated_provinces', 'open_jobs_total', 'hist_jobs', 'provinces_active', 'cities_active', 'website_known', 'lmia_skilled_total', 'lmia_last_quarter', 'sector', 'district', 'broads', 'ees', 'designated_places', 'category', 'fetched']
 ...
 */
export const COLS_COMPANIES_PLAIN = ['name', 'website', 'website_source', 'careers_url', 'email', 'region', 'sectors', 'address', 'description', 'source', 'sector', 'lmia_positions', 'lmia_lmias', 'lmia_last_quarter', 'lmia_streams', 'lmia_positions_skilled', 'lmia_positions_4q', 'lmia_positions_2q', 'lmia_positions_1q', 'lmia_nocs']
 ...
 */
export const COLS_JOBS_COALESCE = ['description', 'eligibility_flag', 'eligibility_quote', 'grade_channel', 'score_detail', 'jd_formatted', 'jd_formatted_at', 'valid_through']

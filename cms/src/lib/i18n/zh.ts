...
export const siteZh = {
  ...
  'pulse.s4': '各省宏观统计', 'pulse.s4j': '招聘对比', 'pulse.m.key': '指标', 'pulse.m.thru': '至 {mon}',
  ...
  'pulse.m.pop': '总人口(人)', 'pulse.m.npr': '临时居民(人)', 'pulse.m.workOnly': '其中仅工签(人)', 'pulse.m.studyOnly': '其中仅学签(人)', 'pulse.m.workStudy': '其中工签学签双持(人)', 'pulse.m.asylum': '其中难民申请人(人)', 'pulse.m.other': '其中其他许可及家属(人)', 'pulse.m.studyNew': '学签新签(人)', 'pulse.m.gdp': 'GDP(百万加元)', 'pulse.m.unemp': '失业率(%)', 'pulse.m.alloc': '省提名配额(个)', 'pulse.m.issued': '已发提名(个)', 'pulse.m.remaining': '剩余名额(个)', 'pulse.m.prAll': 'PR 获批(人)', 'pulse.m.prPnp': '其中省提名(人)', 'pulse.m.eeInvites': 'EE 邀请(人)', 'pulse.m.comp': '名额竞争(比)', 'pulse.m.pnpTarget': '省提名接纳目标(人)', 'pulse.m.unpub': '未公布', 'pulse.m.unreleased': '未发布', 'pulse.m.notCollected': '本站未收录',
  'pulse.s5': '近期抽选',

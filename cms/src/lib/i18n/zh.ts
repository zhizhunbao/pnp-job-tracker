...
export const siteZh = {
  ...
  'de.lmia': '有 LMIA 记录', 'de.stars': '{n} 星', 'de.entryN': '入门 {n}%', 'de.designated': '指定雇主',
  ...
  'loading': '更新中…',
  'nav.coop': '校内板', 'coop.title': '校内板', 'coop.sub': '{school} {board} {n} 条在招', 'coop.empty': '暂无岗位', 'coop.kind': '类型', 'coop.view': '看详情', 'origin.hireac': 'HireAC',

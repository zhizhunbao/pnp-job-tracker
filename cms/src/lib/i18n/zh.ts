...
export const siteZh = {
  ...
  'pulse.s4': '各省宏观统计', 'pulse.s4j': '招聘对比', 'pulse.m.key': '指标', 'pulse.m.geo': '地区', 'pulse.m.thru': '至 {mon}',
  ...
  'pulse.m.pop': '总人口(人)', 'pulse.m.npr': '临时居民(人)', 'pulse.m.workOnly': '其中仅工签(人)', 'pulse.m.studyOnly': '其中仅学签(人)', 'pulse.m.workStudy': '其中工签学签双持(人)', 'pulse.m.asylum': '其中难民申请人(人)', 'pulse.m.other': '其中其他许可及家属(人)', 'pulse.m.studyNew': '学签新签(人)', 'pulse.m.gdp': 'GDP(百万加元)', 'pulse.m.unemp': '失业率(%)', 'pulse.m.alloc': '省提名配额(个)', 'pulse.m.issued': '已发提名(个)', 'pulse.m.remaining': '剩余名额(个)', 'pulse.m.prAll': 'PR 获批(人)', 'pulse.m.prPnp': '其中省提名(人)', 'pulse.m.eeInvites': 'EE 邀请(人)', 'pulse.m.comp': '名额竞争(在库 ÷ 配额)', 'pulse.m.pnpTarget': '省提名接纳目标(人)', 'pulse.m.useRate': '配额用尽率(已发 ÷ 配额)', 'pulse.m.pnpShare': '省提名依赖度(省提名 ÷ PR)', 'pulse.m.nprShare': '临时居民占比(临时居民 ÷ 人口)', 'pulse.m.yoy': '同比 {a}/{b}', 'pulse.m.unpub': '未公布', 'pulse.m.unreleased': '未发布', 'pulse.s4.byInd': '按指标', 'pulse.s4.byGeo': '按省', 'pulse.v.ca': '全国 {y} 同比 {p}', 'pulse.v.caFlat': '全国 {y} 持平', 'pulse.v.up': '{prov} {p} 领涨', 'pulse.v.down': '{prov} {p} 领跌', 'pulse.v.sep': ',', 'pulse.i.comp': '竞争', 'pulse.i.alloc': '配额', 'pulse.i.useRate': '用尽率', 'pulse.i.pnpShare': '依赖度', 'pulse.i.npr': '临时居民', 'pulse.i.studyNew': '学签', 'pulse.i.prAll': 'PR', 'pulse.i.nprShare': '占比', 'pulse.i.unemp': '失业率', 'pulse.i.pop': '人口', 'pulse.m.notCollected': '本站未收录',
  'pulse.s5': '近期抽选',

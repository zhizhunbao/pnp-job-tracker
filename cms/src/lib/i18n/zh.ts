...
export const siteZh = {
  ...
  'pulse.sector.public': '公共部门', 'pulse.sector.government': '政府部门', 'pulse.pilot.aip': 'AIP 指定雇主', 'pulse.pilot.rcip': 'RCIP 指定雇主', 'pulse.pilot.fcip': 'FCIP 指定雇主',   'pulse.id.nowp': '没工签', 'pulse.id.pgwp': '有工签',

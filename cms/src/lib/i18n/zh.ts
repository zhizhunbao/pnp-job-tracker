...
export const siteZh = {
  ...
  'de.colName': '雇主', 'de.colBroad': '大分类', 'de.colEe': 'EE 类别', 'de.colSector': '雇主类型', 'de.colLmia': 'LMIA', 'de.colProv': '省', 'de.colCity': '市', 'de.colDistrict': '区', 'de.allSector': '全部雇主类型', 'de.colWhere': '地点', 'de.colOpen': '在招', 'de.colDesignated': '指定雇主',

...
export const siteZh = {
  ...
  'pulse.sector.public': '公立机构', 'pulse.sector.government': '省市政府', 'pulse.sector.federal': '联邦机关', 'pulse.pilot.aipLocal': 'AIP 本地雇主', 'pulse.pilot.aipChain': 'AIP 连锁雇主', 'pulse.pilot.rcip': 'RCIP 指定雇主', 'pulse.pilot.fcip': 'FCIP 指定雇主',   'pulse.id.nowp': '没工签', 'pulse.id.pgwp': '有工签',

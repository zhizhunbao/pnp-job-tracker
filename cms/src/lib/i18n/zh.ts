...
export const pteZh = {
  ...
  'pte.home.start': '开始练习', 'pte.home.progress': '总体进度', 'pte.home.total': '总题目', 'pte.home.done': '已练', 'pte.home.left': '剩余', 'pte.home.recent': '最近 7 天考过', 'pte.home.all': '全部题单',
  'pte.countWin': '近 {win} 天考过 {n} 题', 'pte.countAll': '共 {n} 题',

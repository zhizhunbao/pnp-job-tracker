...
export const jobsZh = {
  ...
  'act.ai': 'AI 整理', 'act.aiNote': '只搬运原帖信息,未添加', 'act.aiQuota': '今日 AI 次数已用完', 'act.aiQuotaLogin': '请登录', 'act.seeOrig': '看原文', 'act.seeFmt': '看整理版',   // 2026-09-16 Frank「去掉箭头」:正文区右上角切换钮,不再是下拉展开 'act.aiWorking': 'AI 整理中…', 'act.aiFail': 'AI 整理没成功',

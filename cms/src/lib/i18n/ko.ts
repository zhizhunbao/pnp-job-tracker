...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.s4': '주별 거시 통계', 'pulse.s4j': '주별 채용 비교', 'pulse.m.key': '지표', 'pulse.m.geo': '지역', 'pulse.m.thru': '{mon}까지',
  ...
  'pulse.m.pop': '총인구(명)', 'pulse.m.npr': '임시 거주자(명)', 'pulse.m.workOnly': '그중 워크퍼밋만(명)', 'pulse.m.studyOnly': '그중 학생비자만(명)', 'pulse.m.workStudy': '그중 두 비자 동시(명)', 'pulse.m.asylum': '그중 난민 신청자(명)', 'pulse.m.other': '그중 기타 허가·가족(명)', 'pulse.m.studyNew': '신규 학생비자(명)', 'pulse.m.gdp': 'GDP(백만 CAD)', 'pulse.m.unemp': '실업률(%)', 'pulse.m.alloc': '주정부 지명 할당(개)', 'pulse.m.issued': '발급된 지명(개)', 'pulse.m.remaining': '잔여 할당(개)', 'pulse.m.prAll': 'PR 승인(명)', 'pulse.m.prPnp': '그중 PNP(명)', 'pulse.m.eeInvites': 'EE 초청(명)', 'pulse.m.comp': '정원 경쟁(체류자 ÷ 할당)', 'pulse.m.pnpTarget': 'PNP 승인 목표(명)', 'pulse.m.useRate': '할당 소진율(발급 ÷ 할당)', 'pulse.m.pnpShare': 'PNP 의존도(PNP ÷ PR)', 'pulse.m.nprShare': '임시 거주자 비중(임시 거주자 ÷ 인구)', 'pulse.m.yoy': '전년 대비 {a}/{b}', 'pulse.m.unpub': '미공개', 'pulse.m.unreleased': '미발표', 'pulse.s4.byInd': '지표별', 'pulse.s4.byGeo': '주별', 'pulse.v.ca': '전국 {y} 전년 대비 {p}', 'pulse.v.caFlat': '전국 {y} 보합', 'pulse.v.up': '{prov} {p} 최대 상승', 'pulse.v.down': '{prov} {p} 최대 하락', 'pulse.v.sep': ', ', 'pulse.i.comp': '경쟁', 'pulse.i.alloc': '할당', 'pulse.i.useRate': '소진율', 'pulse.i.pnpShare': 'PNP 의존도', 'pulse.i.npr': '임시 거주자', 'pulse.i.studyNew': '학생비자', 'pulse.i.prAll': 'PR', 'pulse.i.nprShare': '비중', 'pulse.i.unemp': '실업률', 'pulse.i.pop': '인구', 'pulse.m.notCollected': '미수록',
  'pulse.s5': '최근 추첨',

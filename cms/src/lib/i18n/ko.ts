...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'de.title': '지정 고용주 명단', 'de.bnSub': '지정 고용주와 채용 중 고용주', 'de.count': '{n}개사', 'de.colName': '고용주', 'de.colWhere': '소재지', 'de.colProgram': '제도',
  ...
  'pulse.rules.title': '{prov} 스트림 요건', 'pulse.rules.loading': '불러오는 중…', 'pulse.rules.empty': '미수록', 'pulse.rules.more': '자료실',

...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.m.pop': '총인구(명)', 'pulse.m.npr': '임시 거주자(명)', 'pulse.m.workOnly': '그중 워크퍼밋만(명)', 'pulse.m.studyOnly': '그중 학생비자만(명)', 'pulse.m.workStudy': '그중 두 비자 동시(명)', 'pulse.m.asylum': '그중 난민 신청자(명)', 'pulse.m.other': '그중 기타 허가·가족(명)', 'pulse.m.studyNew': '신규 학생비자(명)', 'pulse.m.gdp': 'GDP(백만 CAD)', 'pulse.m.unemp': '실업률(%)', 'pulse.m.alloc': '주정부 지명 할당(개)', 'pulse.m.issued': '발급된 지명(개)', 'pulse.m.remaining': '잔여 할당(개)', 'pulse.m.prAll': 'PR 승인(명)', 'pulse.m.prPnp': '그중 PNP(명)', 'pulse.m.eeInvites': 'EE 초청(명)', 'pulse.m.comp': '정원 경쟁(비율)', 'pulse.m.pnpTarget': 'PNP 승인 목표(명)', 'pulse.m.unpub': '미공개', 'pulse.m.notCollected': '미수록',
  'pulse.s5': '최근 추첨',

...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'de.colName': '고용주', 'de.colWhere': '지역', 'de.colStar': '등급', 'de.colOpen': '채용 중', 'de.colDesignated': '지정 고용주',
  'de.lmia': 'LMIA 기록 있음', 'de.stars': '{n}성', 'de.entryN': '입문 {n}%', 'de.designated': '지정 고용주',
  ...
  'loading': '업데이트 중…',
  'nav.coop': '교내 채용', 'coop.title': '교내 채용', 'coop.sub': '{school} {board} 채용 {n}건', 'coop.empty': '공고 없음', 'coop.kind': '유형', 'coop.view': '상세', 'origin.hireac': 'HireAC',

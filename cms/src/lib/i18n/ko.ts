...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'de.title': '지정 고용주 명단', 'de.count': '{n}개사', 'de.colName': '고용주', 'de.colWhere': '소재지', 'de.colProgram': '제도',
...
export const pteKo: Record<keyof typeof pteZh, string> = {
  ...
  'pte.disclaimer': '수험생 기억으로 정리한 자료',
  ...
  'pte.soon': '준비 중',
  'pte.nav.home': 'PTE 홈', 'pte.nav.RA': '소리 내어 읽기', 'pte.nav.RS': '문장 따라 말하기', 'pte.nav.ASQ': '짧게 답하기', 'pte.nav.WFD': '받아쓰기',
  'pte.home.start': '연습 시작', 'pte.home.progress': '전체 진도', 'pte.home.total': '총 문제', 'pte.home.done': '연습함', 'pte.home.left': '남음', 'pte.home.seen7': '최근 7일 출제', 'pte.home.recent': '최근 출제', 'pte.home.all': '전체 문제',
  ...
  'pte.dict.close': '닫기', 'pte.dict.loading': '검색 중', 'pte.dict.none': '없음', 'pte.dict.src': '뜻풀이 출처: Free Dictionary API',
}

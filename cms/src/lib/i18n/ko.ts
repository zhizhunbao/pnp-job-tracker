...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'de.title': '고용주', 'de.bnSub': '지정 자격, 채용 중, LMIA 기록', 'de.count': '{n}개사', 'de.hits': '{n}개사 일치',
  'de.colName': '고용주', 'de.colWhere': '소재지', 'de.colStar': '등급', 'de.colOpen': '채용 중', 'de.colDesignated': '지정 고용주',
  'de.colLmia': '숙련 LMIA', 'de.colWage': '임금 수준', 'de.stars': '{n}성', 'de.entryN': '입문 {n}%', 'de.designated': '지정 고용주',
  'de.qPh': '고용주 검색', 'de.allGroup': '업종 선택', 'de.entry': '무경력 지원 가능', 'de.sep': ', ',
  'de.need': '업종을 선택하면 고용주가 표시됩니다', 'de.emptyFiltered': '현재 조건에 맞는 고용주가 없습니다',

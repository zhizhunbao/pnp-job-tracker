...
export const pteKo: Record<keyof typeof pteZh, string> = {
  ...
  'pte.home.start': '연습 시작', 'pte.home.progress': '전체 진도', 'pte.home.total': '총 문제', 'pte.home.done': '연습함', 'pte.home.left': '남음', 'pte.home.recent': '최근 7일 출제', 'pte.home.all': '전체 문제',
  'pte.countWin': '최근 {win}일 출제 {n}문제', 'pte.countAll': '총 {n}문제',

...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.m.pop': '총인구(명)', 'pulse.m.npr': '임시 거주자(명)', 'pulse.m.workOnly': '그중 워크퍼밋만(명)', 'pulse.m.studyOnly': '그중 학생비자만(명)', 'pulse.m.workStudy': '그중 두 비자 동시(명)', 'pulse.m.asylum': '그중 난민 신청자(명)', 'pulse.m.other': '그중 기타 허가·가족(명)', 'pulse.m.studyNew': '신규 학생비자(명)', 'pulse.m.gdp': 'GDP(백만 CAD)', 'pulse.m.unemp': '실업률(%)', 'pulse.m.alloc': '주정부 지명 할당(개)', 'pulse.m.issued': '발급된 지명(개)', 'pulse.m.remaining': '잔여 할당(개)', 'pulse.m.prAll': 'PR 승인(명)', 'pulse.m.prPnp': '그중 PNP(명)', 'pulse.m.eeInvites': 'EE 초청(명)', 'pulse.m.comp': 'PR 정원 경쟁', 'pulse.m.pnpTarget': 'PNP 승인 목표(명)', 'pulse.m.useRate': '할당 소진율', 'pulse.m.pnpShare': 'PNP 의존도', 'pulse.m.nprShare': '임시 거주자 비중', 'pulse.m.na': '해당 없음', 'pulse.m.rec': '추천', 'pulse.m.inclAip': 'AIP 포함', 'pulse.m.compFormula': '학생비자 + 워크퍼밋 소지자 ÷ 해당 연도 PNP 할당', 'pulse.r.yes': '추천', 'pulse.r.mid': '보통', 'pulse.r.no': '비추천', 'pulse.m.yoy': '전년 대비 {a}/{b}', 'pulse.m.unreleased': '미발표', 'pulse.i.comp': '경쟁', 'pulse.i.alloc': '할당', 'pulse.i.useRate': '소진율', 'pulse.i.pnpShare': 'PNP 의존도', 'pulse.i.npr': '임시 거주자', 'pulse.i.studyNew': '학생비자', 'pulse.i.prAll': 'PR', 'pulse.i.nprShare': '비중', 'pulse.i.unemp': '실업률', 'pulse.i.pop': '인구', 'pulse.i.prPnp': 'PNP PR', 'pulse.i.eeInvites': 'EE 초청', 'pulse.i.pnpTarget': 'PNP 목표', 'pulse.i.gdp': 'GDP', 'pulse.m.notCollected': '미수록',
  'pulse.s5': '최근 추첨',

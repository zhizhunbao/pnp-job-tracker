...
export const jobsKo: Record<keyof typeof jobsZh, string> = {
  ...
  'co.similar': '유사 고용주', 'co.similarSub': '같은 주·유사 직무',
  ...
  'filter.num': '급여·점수', 'filter.salary': '급여', 'filter.score': '점수', 'filter.more': '필터 더보기',
  'filter.picked': '선택됨',
  ...
  'co.stage.queued': '대기 중', 'co.stage.find': '사이트 찾기', 'co.stage.fetch': '사이트 수집', 'co.stage.facts': '내용 정리', 'co.stage.trans': '번역',
...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.city.dliN': 'DLI 학교', 'city.facts': '개요', 'city.byInd': '업종 분포', 'city.byIndCol': '업종', 'city.channel': '전용 채널', 'city.school': '학교', 'city.schoolType': '유형', 'city.pub': '공립', 'city.priv': '사립', 'city.kind.all': '전체', 'city.kind.university': '대학교', 'city.kind.college': '칼리지', 'city.none': '수록되지 않은 도시입니다', 'city.latest': '최신 채용', 'city.topEmp': '주요 고용주',

...
export const jobsKo: Record<keyof typeof jobsZh, string> = {
  ...
  'co.grades': '고용주 신호',
  'co.crumb': '회사', 'co.basic': '기본 정보', 'co.name': '회사명', 'co.sector': '유형', 'co.gov': '정부 기관', 'co.wellKnown': '유명 기업', 'co.notFound': '이 회사를 찾을 수 없습니다 — 채용 목록에서 제거되었을 수 있습니다.', 'co.openJobs': '채용 중 공고',

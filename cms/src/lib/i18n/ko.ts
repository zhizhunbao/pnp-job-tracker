...
export const reportKo: Record<keyof typeof reportZh, string> = {
  ...
  'case.official': '공식 원문', 'case.asOf': '{d} 확인',
  ...
  'dp.cases': '자주 있는 사례', 'dp.casesSub': '흔한 상황별 경로 판정', 'dp.caseAnswer': '전체 사례',
...
export const jobsKo: Record<keyof typeof jobsZh, string> = {
  ...
  'filter.geo': '지역', 'filter.src': '출처', 'filter.statusexp': '상태 / 경력', 'filter.status': '상태', 'filter.exp': '경력', 'filter.drawer': '필터',
  'emp.full': '정규직', 'emp.part': '파트타임',
  ...
  'all.broad': '전체 대분류', 'all.occ': '직무 전체',
  'all.source': '출처 전체', 'all.exp': '경력 무관',
  'all.ee': '카테고리 전체', 'all.status': '상태 전체', 'all.origin': '채널 전체',
  'filter.num': '급여·점수', 'filter.score': '점수', 'filter.more': '필터 더보기',
  'filter.picked': '선택됨',
  ...
  'col.company': '회사명', 'col.title': '직책', 'col.noc': '직무', 'col.accessibility': '경력 수준',
  ...
  'col.pnp': 'PNP', 'col.ee': 'EE 카테고리', 'col.aip': 'AIP', 'col.pilot': '시범 커뮤니티', 'col.lmia': 'LMIA 이력', 'col.eligibility': '비자 플래그', 'col.status': '상태', 'col.firstSeen': '최초 수집', 'col.lastSeen': '마지막 확인', 'col.closedAt': '마감일', 'col.score': '이민 경로',
  ...
  'eelist.source': '출처: Express Entry 카테고리 기반 선발', 'eelist.your': '이 직무', 'eelist.loading': 'EE 목록 로딩 중…', 'eelist.count': '{n}개 직업',
  ...
  'broad.矿业': '광업', 'broad.制造': '제조', 'broad.高管': '고위 경영진', 'broad.人力资源': '인사', 'broad.行政文员': '행정 사무', 'broad.客户服务': '고객 서비스', 'broad.财会金融': '재무 회계', 'broad.科研': '과학 연구', 'broad.公共服务': '공공 서비스', 'broad.文体艺术': '예술 스포츠', 'broad.酒店旅游': '호텔 관광', 'broad.零售销售': '리테일 영업', 'broad.机修技工': '정비 수리', 'broad.运输物流': '운송 물류', 'broad.农林矿业': '농림 광업',
  ...
  'fact.nocCode': 'NOC 코드', 'fact.nocTitle': '공식 직업명', 'fact.nocDuties': '공식 주요 업무(NOC)', 'fact.nocReqs': '취업 요건(NOC)',
  ...
  'ee.dormantTip': '이 EE 카테고리의 최근 추첨은 {d}로 12개월이 넘었습니다. 직업의 카테고리 소속은 유효하지만 현재 활성 경로는 아닙니다.',
  'eefed.cat': '직업 카테고리',
...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'acct.toReg': '무료 가입', 'acct.toLogin': '이미 계정이 있으신가요?',
  ...
  'pulse.s4': '주', 'pulse.s4j': '주별 채용 비교', 'pulse.m.key': '지표', 'pulse.m.geo': '지역', 'pulse.m.thru': '{mon}까지',
  ...
  'pulse.m.pop': '총인구', 'pulse.m.npr': '임시 거주자', 'pulse.m.workOnly': '워크퍼밋만', 'pulse.m.studyOnly': '학생비자만', 'pulse.m.workStudy': '두 비자 동시', 'pulse.m.asylum': '난민 신청자', 'pulse.m.other': '기타 허가·가족', 'pulse.m.studyNew': '학생비자', 'pulse.m.work': '워크퍼밋', 'pulse.m.gdp': 'GDP(백만 CAD)', 'pulse.m.unemp': '실업률(%)', 'pulse.m.minWage': '법정 최저임금($/시간)', 'pulse.m.alloc': '할당', 'pulse.m.issued': '발급된 지명(개)', 'pulse.m.remaining': '잔여 할당(개)', 'pulse.m.prAll': 'PR 승인', 'pulse.m.prPnp': 'PNP', 'pulse.m.prEcon': '경제이민', 'pulse.m.prFamily': '가족초청', 'pulse.m.prRefugee': '난민·보호대상', 'pulse.m.prOtherCat': '기타', 'pulse.m.prCec': '경험이민 CEC', 'pulse.m.prFsw': '전문인력 FSW', 'pulse.m.prFst': '기능인력 FST', 'pulse.m.prCaregiver': '케어기버', 'pulse.m.prAgriFood': '농식품 파일럿', 'pulse.m.prRnip': '지방·북부', 'pulse.m.prAtlantic': '대서양 이민', 'pulse.m.prEmpp': 'EMPP', 'pulse.m.prBusiness': '비즈니스', 'pulse.m.prTr2pr': 'TR to PR', 'pulse.m.prSpouse': '배우자·파트너', 'pulse.m.prChildren': '자녀', 'pulse.m.prPgp': '부모·조부모', 'pulse.m.prExtFamily': '기타 친족', 'pulse.m.prGar': '정부지원 난민', 'pulse.m.prPsr': '민간후원 난민', 'pulse.m.prBsr': '혼합후원 난민', 'pulse.m.prProtected': '국내 보호대상', 'pulse.m.eeInvites': 'EE 초청', 'pulse.m.eeInvCec': '경험이민 CEC', 'pulse.m.eeInvFrench': '프랑스어', 'pulse.m.eeInvHealth': '보건', 'pulse.m.eeInvPnp': 'PNP', 'pulse.m.eeInvGeneral': '일반 라운드', 'pulse.m.eeInvTrade': '기능직', 'pulse.m.eeInvStem': 'STEM', 'pulse.m.eeInvEdu': '교육', 'pulse.m.eeInvAgri': '농식품', 'pulse.m.eeInvPhys': '의사', 'pulse.m.eeInvMgr': '고위 관리자', 'pulse.m.eeInvTransport': '운수', 'pulse.m.eeInvMilitary': '군인', 'pulse.m.eeInvFsw': '전문인력 FSW', 'pulse.m.eeInvFst': '기능인력 FST', 'pulse.m.eeInvOther': '기타 라운드', 'pulse.m.eeTarget': 'EE 수용 목표', 'pulse.m.fedEe': '연방 EE', 'pulse.m.eePool': 'EE 풀 인원', 'pulse.i.fedEe': 'EE', 'pulse.m.comp': 'PR 정원 경쟁', 'pulse.m.pnpTarget': 'PNP 할당', 'pulse.m.useRate': '할당 소진율', 'pulse.m.pnpShare': 'PNP 비중', 'pulse.m.nprShare': '임시 거주자 비중', 'pulse.m.na': '해당 없음', 'pulse.m.rec': '추천', 'pulse.m.compFormula': '학생비자 + 워크퍼밋 소지자 ÷ 해당 연도 PNP 할당', 'pulse.r.yes': '추천', 'pulse.r.no': '비추천', 'pulse.m.yoy': '전년 대비 {a}/{b}', 'pulse.m.flat': '보합', 'pulse.m.unreleased': '미발표', 'pulse.i.comp': '경쟁', 'pulse.i.alloc': '할당', 'pulse.i.useRate': '소진율', 'pulse.i.pnpShare': 'PNP 의존도', 'pulse.i.npr': '임시 거주자', 'pulse.i.studyNew': '학생비자', 'pulse.i.work': '워크퍼밋', 'pulse.i.prAll': 'PR', 'pulse.i.nprShare': '비중', 'pulse.i.unemp': '실업률', 'pulse.i.minWage': '최저임금', 'pulse.i.pop': '인구', 'pulse.i.prPnp': 'PNP PR', 'pulse.i.eeInvites': 'EE 초청', 'pulse.i.pnpTarget': 'PNP 목표', 'pulse.i.gdp': 'GDP',
  'pulse.s5': '최근 추첨',
  ...
  'de.colCategory': '회사 분류', 'de.allCategory': '전체 분류', 'cocat.tech': '테크',
  'cocat.health': '의료·헬스케어', 'cocat.education': '교육', 'cocat.finance': '금융·보험',
  'cocat.professional': '전문 서비스', 'cocat.construction': '건설', 'cocat.manufacturing': '제조',
  'cocat.retail': '소매·도매', 'cocat.hospitality': '외식·숙박', 'cocat.transport': '운송·물류',
  'cocat.energy': '에너지·광업', 'cocat.agriculture': '농림어업', 'cocat.realestate': '부동산',
  'cocat.media': '미디어·레저', 'cocat.services': '생활·기타 서비스', 'cocat.hospital': '병원',
  'cocat.healthauth': '보건청', 'cocat.university': '대학교', 'cocat.college': '칼리지',
  'cocat.schoolboard': '교육청·초중고', 'cocat.transit': '대중교통', 'cocat.utility': '공공 유틸리티',
  'cocat.crown': '공기업', 'cocat.public-other': '기타 공공기관', 'cocat.gov-admin': '일반 행정',
  'cocat.gov-police': '경찰·비상 대응', 'cocat.gov-defence': '국방', 'cocat.gov-tax': '재정·세무',
  'cocat.gov-justice': '사법', 'cocat.gov-parks': '공원·천연자원', 'cocat.gov-infra': '교통·인프라',
  ...
  'stats.bnProvs': '대상 주 수', 'stats.bnBroads': '직업 대분류 수',
  // B4-01 디렉터리
  'dir.title': '고용주 디렉터리',
  ...
  'dir.occ.title': '수요 직업 리스트', 'dir.occ.sub': '각 주 노미니 프로그램의 직업 리스트',
  ...
  // C6-01 타임라인
  'tl.title': '추첨 및 정책 타임라인', 'tl.sub': '주정부 추첨과 연방 EE 추첨 타임라인',
  ...
  'news.entry': '이민 소식',
  'news.title': '이민 정책 동향', 'news.bnSub': '연방 및 주정부 이민 공지',
  ...
  'pulse.sector.public': '공공 기관', 'pulse.sector.government': '주 정부', 'pulse.sector.municipal': '시·군 정부', 'pulse.sector.indigenous': '원주민 정부', 'pulse.sector.federal': '연방 기관', 'pulse.pilot.aip': 'AIP 지정 고용주', 'pulse.chain': '체인', 'pulse.chain.tip': '매장별로 지정됩니다. 지원 전 해당 매장을 확인하세요.', 'pulse.pilot.rcip': 'RCIP 지정 고용주', 'pulse.pilot.fcip': 'FCIP 지정 고용주',   'pulse.id.nowp': '취업허가 없음', 'pulse.id.pgwp': '취업허가 있음',

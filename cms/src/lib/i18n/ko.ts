...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'de.colName': '고용주', 'de.colSector': '유형', 'de.colLmia': 'LMIA', 'de.colProv': '주', 'de.colCity': '도시', 'de.colDistrict': '구역', 'de.allSector': '전체 유형', 'de.colWhere': '지역', 'de.colOpen': '채용 중', 'de.colDesignated': '지정 고용주',

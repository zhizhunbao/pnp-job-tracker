...
export const siteKo: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.sector.public': '공공 기관', 'pulse.sector.government': '주·시 정부', 'pulse.sector.federal': '연방 기관', 'pulse.pilot.aipLocal': 'AIP 지역 고용주', 'pulse.pilot.aipChain': 'AIP 체인 고용주', 'pulse.pilot.rcip': 'RCIP 지정 고용주', 'pulse.pilot.fcip': 'FCIP 지정 고용주',   'pulse.id.nowp': '취업허가 없음', 'pulse.id.pgwp': '취업허가 있음',

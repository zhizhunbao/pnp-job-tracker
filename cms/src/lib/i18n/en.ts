...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.city.dliN': 'DLI schools', 'city.facts': 'Overview', 'city.byInd': 'By industry', 'city.byIndCol': 'Industry', 'city.channel': 'Dedicated channels', 'city.school': 'School', 'city.schoolType': 'Type', 'city.pub': 'Public', 'city.priv': 'Private', 'city.none': 'City not covered yet', 'pulse.city.dliGrad': 'PGWP eligible',
  ...
  'stats.title': '{prov} job statistics', 'stats.catTitle': '{prov} · {cat} job statistics', 'stats.openJobs': 'Open jobs', 'stats.new7d': 'Posted in last 7 days', 'stats.medWage': 'Median wage (ESDC)', 'stats.wageLowH': 'Low hourly', 'stats.wageMedH': 'Median hourly', 'stats.wageHighH': 'High hourly', 'stats.medSalary': 'Median posted salary', 'stats.named': 'In-demand list jobs', 'stats.topCities': 'Top cities', 'stats.streams': 'Streams hit', 'stats.byCat': 'By occupation group', 'stats.entry': 'Region stats', 'stats.toJobs': 'See these jobs', 'stats.caliber': 'Methodology', 'stats.noList.tip': 'This province currently publishes no PNP occupation list (e.g. OINP after its 2026-06 redesign) — eligibility runs on TEER and other conditions. Not missing data.', 'stats.naQc.tip': 'Quebec does not take part in the PNP — it runs its own selection system.', 'stats.provIndex': 'Choose a province', 'stats.compare': 'Compare provinces (Pro)', 'stats.pickProv': 'Pick 2–4 provinces', 'stats.myNoc': 'Highlight by my profile', 
}

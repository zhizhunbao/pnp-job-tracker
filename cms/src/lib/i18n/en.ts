...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.m.pop': 'Population (people)', 'pulse.m.npr': 'Temporary residents (people)', 'pulse.m.workOnly': 'of which work permit only (people)', 'pulse.m.studyOnly': 'of which study permit only (people)', 'pulse.m.workStudy': 'of which both permits (people)', 'pulse.m.asylum': 'of which asylum claimants (people)', 'pulse.m.other': 'of which other permits and family (people)', 'pulse.m.studyNew': 'New study permits (people)', 'pulse.m.gdp': 'GDP (C$ millions)', 'pulse.m.unemp': 'Unemployment rate (%)', 'pulse.m.alloc': 'PNP allocation (spots)', 'pulse.m.issued': 'Nominations issued (spots)', 'pulse.m.remaining': 'Remaining allocation (spots)', 'pulse.m.prAll': 'PR admissions (people)', 'pulse.m.prPnp': 'of which PNP (people)', 'pulse.m.eeInvites': 'EE invitations (people)',

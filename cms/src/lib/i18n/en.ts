...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'de.colName': 'Employer', 'de.colSector': 'Type', 'de.colProv': 'Province', 'de.colCity': 'City', 'de.allSector': 'All types', 'de.colWhere': 'Location', 'de.colOpen': 'Open', 'de.colDesignated': 'Designated',

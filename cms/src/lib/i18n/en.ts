...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.s4': 'Provincial statistics', 'pulse.s4j': 'Hiring by province', 'pulse.m.key': 'Indicator', 'pulse.m.geo': 'Region', 'pulse.m.thru': 'to {mon}',
  ...
  'pulse.m.pop': 'Population (people)', 'pulse.m.npr': 'Temporary residents (people)', 'pulse.m.workOnly': 'of which work permit only (people)', 'pulse.m.studyOnly': 'of which study permit only (people)', 'pulse.m.workStudy': 'of which both permits (people)', 'pulse.m.asylum': 'of which asylum claimants (people)', 'pulse.m.other': 'of which other permits and family (people)', 'pulse.m.studyNew': 'New study permits (people)', 'pulse.m.gdp': 'GDP (C$ millions)', 'pulse.m.unemp': 'Unemployment rate (%)', 'pulse.m.alloc': 'PNP allocation (spots)', 'pulse.m.issued': 'Nominations issued (spots)', 'pulse.m.remaining': 'Remaining allocation (spots)', 'pulse.m.prAll': 'PR admissions (people)', 'pulse.m.prPnp': 'of which PNP (people)', 'pulse.m.eeInvites': 'EE invitations (people)', 'pulse.m.comp': 'Competition (pool ÷ quota)', 'pulse.m.pnpTarget': 'PNP admissions target (people)', 'pulse.m.useRate': 'Quota used (issued ÷ quota)', 'pulse.m.pnpShare': 'PNP share of PR (PNP ÷ PR)', 'pulse.m.nprShare': 'Temporary resident share (TR ÷ population)', 'pulse.m.yoy': 'YoY {a}/{b}', 'pulse.m.unpub': 'Not published', 'pulse.m.unreleased': 'Not yet released', 'pulse.s4.byInd': 'By indicator', 'pulse.s4.byGeo': 'By province', 'pulse.v.ca': 'Canada {y} {p} YoY', 'pulse.v.caFlat': 'Canada {y} flat', 'pulse.v.up': '{prov} {p} leads gains', 'pulse.v.down': '{prov} {p} leads declines', 'pulse.v.sep': ', ', 'pulse.i.comp': 'Competition', 'pulse.i.alloc': 'Quota', 'pulse.i.useRate': 'Quota used', 'pulse.i.pnpShare': 'PNP share', 'pulse.i.npr': 'Temp residents', 'pulse.i.studyNew': 'Study permits', 'pulse.i.prAll': 'PR', 'pulse.i.nprShare': 'TR share', 'pulse.i.unemp': 'Unemployment', 'pulse.i.pop': 'Population', 'pulse.m.notCollected': 'Not collected',

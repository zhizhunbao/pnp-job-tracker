...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.city.dliN': 'DLI schools', 'city.facts': 'Overview', 'city.byInd': 'By industry', 'city.byIndCol': 'Industry', 'city.channel': 'Dedicated channels', 'city.school': 'School', 'city.schoolType': 'Type', 'city.pub': 'Public', 'city.priv': 'Private', 'city.kind.all': 'All', 'city.kind.university': 'University', 'city.kind.college': 'College', 'city.none': 'City not covered yet', 'city.latest': 'Latest jobs', 'city.topEmp': 'Top employers',

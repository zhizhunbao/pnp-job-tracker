...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'de.colName': 'Employer', 'de.colGroup': 'EE category', 'de.colSector': 'Type', 'de.colLmia': 'LMIA', 'de.colProv': 'Province', 'de.colCity': 'City', 'de.colDistrict': 'District', 'de.allSector': 'All types', 'de.colWhere': 'Location', 'de.colOpen': 'Open', 'de.colDesignated': 'Designated',

...
export const jobsEn: Record<keyof typeof jobsZh, string> = {
  ...
  'act.ai': 'AI-organized', 'act.aiNote': 'rearranged from the posting, nothing added', 'act.aiQuota': 'Daily AI quota used up — resets tomorrow', 'act.aiQuotaLogin': 'Sign in for more daily uses', 'act.fmtTab': 'Organized', 'act.origTab': 'Original', 'act.aiWorking': 'AI organizing, showing original…', 'act.aiFail': 'AI organizing failed',
...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'de.colName': 'Employer', 'de.colBroad': 'Category', 'de.colEe': 'EE category', 'de.colSector': 'Type', 'de.colLmia': 'LMIA', 'de.colProv': 'Province', 'de.colCity': 'City', 'de.colLocs': 'Hiring in', 'de.colDistrict': 'District', 'de.allSector': 'All types', 'de.colWhere': 'Location', 'de.colOpen': 'Open', 'de.colDesignated': 'Designated',

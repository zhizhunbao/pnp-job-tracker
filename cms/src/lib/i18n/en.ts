...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.sector.public': 'Public institution', 'pulse.sector.government': 'Provincial or municipal', 'pulse.sector.federal': 'Federal government', 'pulse.pilot.aipLocal': 'AIP local employers', 'pulse.pilot.aipChain': 'AIP chain employers', 'pulse.col.aipProvs': 'Provinces', 'pulse.pilot.rcip': 'RCIP designated employers', 'pulse.pilot.fcip': 'FCIP designated employers',   'pulse.id.nowp': 'No work permit', 'pulse.id.pgwp': 'Work permit',

...
export const jobsEn: Record<keyof typeof jobsZh, string> = {
  ...
  'act.f.role': 'Job description', 'act.f.reqs': 'Hard requirements', 'act.f.pay': 'Pay & benefits', 'act.f.hours': 'Schedule & location', 'act.f.loc': 'Work location', 'act.f.apply': 'How to apply', 'act.f.none': 'Not mentioned in posting',

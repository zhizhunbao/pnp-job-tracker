...
export const jobsEn: Record<keyof typeof jobsZh, string> = {
  ...
  'act.ai': 'AI-organized', 'act.aiNote': 'rearranged from the posting, nothing added', 'act.aiQuota': 'Daily AI quota used up — resets tomorrow', 'act.aiQuotaLogin': 'Sign in for more daily uses', 'act.seeOrig': 'View original', 'act.seeFmt': 'View organized',   // 2026-09-16 去箭头:正文区右上角切换钮 'act.aiWorking': 'AI organizing…', 'act.aiFail': 'AI organizing failed',

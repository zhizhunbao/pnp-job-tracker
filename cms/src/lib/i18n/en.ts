...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'de.title': 'Employers', 'de.bnSub': 'Designated status, open jobs and LMIA record', 'de.count': '{n} employers', 'de.hits': '{n} matched',
  'de.colName': 'Employer', 'de.colWhere': 'Location', 'de.colStar': 'Rating', 'de.colOpen': 'Open', 'de.colDesignated': 'Designated',
  'de.colLmia': 'Skilled LMIA', 'de.colWage': 'Pay index', 'de.stars': '{n} stars', 'de.entryN': 'Entry {n}%', 'de.designated': 'Designated',
  'de.qPh': 'Search employer', 'de.allGroup': 'Pick an industry', 'de.entry': 'No experience needed', 'de.sep': ', ',
  'de.need': 'Pick an industry to see employers', 'de.emptyFiltered': 'No employer matches these filters',

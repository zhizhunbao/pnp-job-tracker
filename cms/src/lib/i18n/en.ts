...
export const jobsEn: Record<keyof typeof jobsZh, string> = {
  ...
  'co.crumb': 'Company', 'co.basic': 'Basic info', 'co.name': 'Company name', 'co.sector': 'Type', 'co.gov': 'Government', 'co.wellKnown': 'Well-known', 'co.notFound': 'This company was not found — it may have been removed from the active listings.', 'co.openJobs': 'Open positions',
  ...
  'co.similar': 'Similar employers', 'co.similarSub': 'same province, similar roles',

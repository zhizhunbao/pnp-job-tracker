...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'de.lmia': 'Has LMIA record', 'de.stars': '{n} stars', 'de.entryN': 'Entry {n}%', 'de.designated': 'Designated',
  ...
  'loading': 'Updating…',
  'nav.coop': 'Campus board', 'coop.title': 'Campus board', 'coop.sub': '{school} {board}, {n} open', 'coop.empty': 'No postings', 'coop.kind': 'Type', 'coop.view': 'View', 'origin.hireac': 'HireAC',

...
export const reportEn: Record<keyof typeof reportZh, string> = {
  ...
  'case.official': 'Official text', 'case.asOf': 'as of {d}',
  ...
  'dp.cases': 'Common cases', 'dp.casesSub': 'Pathway verdicts for common situations', 'dp.caseAnswer': 'Full case',
...
export const jobsEn: Record<keyof typeof jobsZh, string> = {
  ...
  'filter.geo': 'Location', 'filter.src': 'Source', 'filter.statusexp': 'Status / level', 'filter.status': 'Status', 'filter.exp': 'Level', 'filter.drawer': 'Filters',
  'emp.full': 'Full-time', 'emp.part': 'Part-time',
  ...
  'all.broad': 'All major groups', 'all.occ': 'All occupations',
  'all.source': 'All sources', 'all.exp': 'All levels',
  'all.ee': 'All categories', 'all.status': 'All status', 'all.origin': 'All channels',
  'filter.num': 'Pay & score', 'filter.score': 'Score', 'filter.more': 'More filters',
  ...
  'col.company': 'Company', 'col.title': 'Title', 'col.noc': 'Occupation', 'col.accessibility': 'Level',
  ...
  'col.pnp': 'PNP', 'col.ee': 'EE category', 'col.aip': 'AIP', 'col.pilot': 'Pilot community', 'col.lmia': 'LMIA history', 'col.eligibility': 'Visa flags', 'col.status': 'Status', 'col.firstSeen': 'First seen', 'col.lastSeen': 'Last seen', 'col.closedAt': 'Closed', 'col.score': 'Pathway',
  ...
  'eelist.source': 'Source: Express Entry category-based selection', 'eelist.your': 'This job', 'eelist.loading': 'Loading EE list…', 'eelist.count': '{n} occupations',
  ...
  'broad.矿业': 'Mining', 'broad.制造': 'Manufacturing', 'broad.高管': 'Senior executives', 'broad.人力资源': 'Human resources', 'broad.行政文员': 'Administration', 'broad.客户服务': 'Customer service', 'broad.财会金融': 'Finance & accounting', 'broad.科研': 'Science & research', 'broad.公共服务': 'Public services', 'broad.文体艺术': 'Arts & sport', 'broad.酒店旅游': 'Hotels & tourism', 'broad.零售销售': 'Retail & sales', 'broad.机修技工': 'Mechanics & repair', 'broad.运输物流': 'Transport & logistics', 'broad.农林矿业': 'Agriculture & mining',
  ...
  'fact.nocCode': 'NOC code', 'fact.nocTitle': 'Official title', 'fact.nocDuties': 'Official main duties (NOC)', 'fact.nocReqs': 'Employment requirements (NOC)',
  ...
  'rm.arch.title': 'My resume', 'rm.arch.meta': 'Saved {d}, {n} chars', 'rm.arch.empty': 'Save your resume in a job match to reuse it',
  ...
  'ee.dormantTip': 'Last draw for this EE category was {d} — over 12 months ago. The occupation still belongs to the category, but it is not an active pathway right now.',
  'eefed.cat': 'category',
...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'acct.toReg': 'Sign up free', 'acct.toLogin': 'Have an account?',
  ...
  'home.policy': 'Policy updates', 'pulse.news.region': 'Region', 'pulse.news.title': 'Title', 'home.stats.more': 'Full stats',
  ...
  'pulse.s4': 'Provinces', 'pulse.s4j': 'Hiring by province', 'pulse.m.key': 'Indicator', 'pulse.m.geo': 'Region', 'pulse.m.thru': 'to {mon}',
  'pulse.m.mon1': 'Jan', 'pulse.m.mon2': 'Feb', 'pulse.m.mon3': 'Mar', 'pulse.m.mon4': 'Apr', 'pulse.m.mon5': 'May', 'pulse.m.mon6': 'Jun', 'pulse.m.mon7': 'Jul', 'pulse.m.mon8': 'Aug', 'pulse.m.mon9': 'Sep', 'pulse.m.mon10': 'Oct', 'pulse.m.mon11': 'Nov', 'pulse.m.mon12': 'Dec', 'pulse.m.table': 'Table', 'pulse.m.chart': 'Trend', 'pulse.m.recent': 'Last 5 years', 'pulse.m.more': 'Last 10 years', 'pulse.m.all': 'All', 'pulse.m.index': 'Index: first year with data = 100',
  'pulse.m.pop': 'Population', 'pulse.m.npr': 'Temporary residents', 'pulse.m.workOnly': 'Work permit only', 'pulse.m.studyOnly': 'Study permit only', 'pulse.m.workStudy': 'Both permits', 'pulse.m.asylum': 'Asylum claimants', 'pulse.m.other': 'Other permits and family', 'pulse.m.studyNew': 'Study permits', 'pulse.m.work': 'Work permits', 'pulse.m.gdp': 'GDP (C$ millions)', 'pulse.m.unemp': 'Unemployment rate (%)', 'pulse.m.minWage': 'Statutory minimum wage ($/h)', 'pulse.m.alloc': 'Quotas', 'pulse.m.issued': 'Nominations issued (spots)', 'pulse.m.remaining': 'Remaining allocation (spots)', 'pulse.m.prAll': 'PR admissions', 'pulse.m.prPnp': 'PNP', 'pulse.m.prEcon': 'Economic', 'pulse.m.prFamily': 'Sponsored family', 'pulse.m.prRefugee': 'Refugees and protected', 'pulse.m.prOtherCat': 'All other', 'pulse.m.prCec': 'Canadian Experience', 'pulse.m.prFsw': 'Skilled Worker', 'pulse.m.prFst': 'Skilled Trade', 'pulse.m.prCaregiver': 'Caregiver', 'pulse.m.prAgriFood': 'Agri-Food Pilot', 'pulse.m.prAtlantic': 'Atlantic Immigration', 'pulse.m.prRnip': 'Rural and Northern', 'pulse.m.prEmpp': 'EMPP', 'pulse.m.prBusiness': 'Business', 'pulse.m.prTr2pr': 'TR to PR Pathway', 'pulse.m.prSpouse': 'Spouse or partner', 'pulse.m.prChildren': 'Children', 'pulse.m.prPgp': 'Parents and grandparents', 'pulse.m.prExtFamily': 'Extended family', 'pulse.m.prGar': 'Government-assisted refugees', 'pulse.m.prPsr': 'Privately sponsored refugees', 'pulse.m.prBsr': 'Blended sponsorship refugees', 'pulse.m.prProtected': 'Protected in Canada', 'pulse.m.eeInvites': 'EE invitations', 'pulse.m.eeInvCec': 'Canadian Experience', 'pulse.m.eeInvFrench': 'French proficiency', 'pulse.m.eeInvHealth': 'Healthcare', 'pulse.m.eeInvPnp': 'PNP', 'pulse.m.eeInvGeneral': 'General rounds', 'pulse.m.eeInvTrade': 'Trades', 'pulse.m.eeInvStem': 'STEM', 'pulse.m.eeInvEdu': 'Education', 'pulse.m.eeInvAgri': 'Agri-food', 'pulse.m.eeInvPhys': 'Physicians', 'pulse.m.eeInvMgr': 'Senior managers', 'pulse.m.eeInvTransport': 'Transport', 'pulse.m.eeInvMilitary': 'Military', 'pulse.m.eeInvFsw': 'Skilled Worker', 'pulse.m.eeInvFst': 'Skilled Trade', 'pulse.m.eeInvOther': 'Other rounds', 'pulse.m.eeTarget': 'EE admissions target', 'pulse.m.fedEe': 'Federal EE', 'pulse.m.eePool': 'EE pool size', 'pulse.i.fedEe': 'EE', 'pulse.m.comp': 'PR spot competition', 'pulse.m.pnpTarget': 'PNP quota', 'pulse.m.useRate': 'Quota used', 'pulse.m.pnpShare': 'PNP share of PR', 'pulse.m.nprShare': 'Temporary resident share', 'pulse.m.na': 'N/A', 'pulse.m.rec': 'Pick', 'pulse.m.compFormula': 'Study + work permit holders ÷ PNP allocation for the year', 'pulse.r.yes': 'Recommended', 'pulse.r.no': 'Not recommended', 'pulse.m.yoy': 'YoY {a}/{b}', 'pulse.m.flat': 'Flat', 'pulse.m.unreleased': 'Not yet released', 'pulse.i.comp': 'Competition', 'pulse.i.alloc': 'Quota', 'pulse.i.useRate': 'Quota used', 'pulse.i.pnpShare': 'PNP share', 'pulse.i.npr': 'Temp residents', 'pulse.i.studyNew': 'Study permits', 'pulse.i.work': 'Work permits', 'pulse.i.prAll': 'PR', 'pulse.i.nprShare': 'TR share', 'pulse.i.unemp': 'Unemployment', 'pulse.i.minWage': 'Min wage', 'pulse.i.pop': 'Population', 'pulse.i.prPnp': 'PNP PR', 'pulse.i.eeInvites': 'EE invites', 'pulse.i.pnpTarget': 'PNP target', 'pulse.i.gdp': 'GDP',
  ...
  'cocat.professional': 'Professional services', 'cocat.construction': 'Construction', 'cocat.manufacturing': 'Manufacturing',
  'cocat.retail': 'Retail & wholesale', 'cocat.hospitality': 'Food & lodging', 'cocat.transport': 'Transport & logistics',
  'cocat.energy': 'Energy & mining', 'cocat.agriculture': 'Agriculture & fishing', 'cocat.realestate': 'Real estate',
  'cocat.media': 'Media & recreation', 'cocat.services': 'Personal & other services', 'cocat.hospital': 'Hospital',
  'cocat.healthauth': 'Health authority', 'cocat.university': 'University', 'cocat.college': 'College',
  'cocat.schoolboard': 'School board', 'cocat.transit': 'Public transit', 'cocat.utility': 'Utility',
  'cocat.crown': 'Crown corporation', 'cocat.public-other': 'Other public body', 'cocat.gov-admin': 'General administration',
  'cocat.gov-police': 'Police & emergency', 'cocat.gov-defence': 'Defence', 'cocat.gov-tax': 'Finance & revenue',
  'cocat.gov-justice': 'Justice', 'cocat.gov-parks': 'Parks & natural resources', 'cocat.gov-infra': 'Transport & infrastructure',
  ...
  'stats.bnProvs': 'provinces covered', 'stats.bnBroads': 'occupation groups',
  // B4-01 directory
  ...
  'dir.occ.title': 'In-demand occupation lists', 'dir.occ.sub': 'Occupation lists of provincial streams',
  ...
  // C6-01 timeline
  'tl.title': 'Draws & policy timeline', 'tl.sub': 'Provincial and EE draws, one timeline',
  ...
  'news.title': 'Immigration policy updates', 'news.bnSub': 'Federal and provincial notices',
  ...
  'pulse.nav.se': 'Employers', 'pulse.nav.occ': 'Occupations', 'pulse.nav.prov': 'Provinces', 'pulse.nav.pr': 'PR', 'pulse.spr': 'PR', 'pulse.pr.approved': 'Admissions', 'pulse.nav.draws': 'Draws', 'pulse.nav.news': 'Policy', 'pulse.nav.top': 'Top',
  // 2026-09-04 pulse page rebuild (docs/design/把脉页重构-20260904.md): six-section nav + per-industry tables + city / trend sections
  'pulse.nav.city': 'Cities',
  'pulse.city': 'Cities',
  // 2026-09-11 city section redesign (docs/design/把脉页城市段-20260911.md): search + four tables
  'pulse.city.main': 'Top cities', 'pulse.city.dli': 'Study schools', 'pulse.city.qs': 'QS rank',
  ...
  'pulse.sector.public': 'Public institution', 'pulse.sector.government': 'Provincial government', 'pulse.sector.municipal': 'Municipal government', 'pulse.sector.indigenous': 'Indigenous government', 'pulse.sector.federal': 'Federal government', 'pulse.pilot.aip': 'AIP designated employers', 'pulse.chain': 'Chain', 'pulse.chain.tip': 'Designated per location. Confirm the store before applying.', 'pulse.pilot.rcip': 'RCIP designated employers', 'pulse.pilot.fcip': 'FCIP designated employers',   'pulse.id.nowp': 'No work permit', 'pulse.id.pgwp': 'Work permit',

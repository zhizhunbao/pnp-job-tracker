...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.rules.title': '{prov} stream rules', 'pulse.rules.loading': 'Loading…', 'pulse.rules.empty': 'Not collected yet', 'pulse.rules.more': 'Resource library', 'pulse.rules.round': 'This draw', 'pulse.rules.pathway': 'Stream eligibility', 'pulse.rules.provAll': 'All provincial rules',

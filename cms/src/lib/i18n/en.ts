...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'de.title': 'Designated employers', 'de.count': '{n} employers', 'de.colName': 'Employer', 'de.colWhere': 'Location', 'de.colProgram': 'Program',
...
export const pteEn: Record<keyof typeof pteZh, string> = {
  ...
  'pte.home.start': 'Start practicing', 'pte.home.progress': 'Progress', 'pte.home.total': 'Questions', 'pte.home.done': 'Done', 'pte.home.left': 'Left', 'pte.home.recent': 'Seen in the last 7 days', 'pte.home.all': 'All questions',
  'pte.countWin': '{n} questions seen in the last {win} days', 'pte.countAll': '{n} questions',

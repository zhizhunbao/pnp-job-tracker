...
export const siteEn: Record<keyof typeof siteZh, string> = {
  ...
  'pulse.m.pop': 'Population', 'pulse.m.npr': 'Temporary residents', 'pulse.m.workOnly': 'of which work permit only', 'pulse.m.studyOnly': 'of which study permit only', 'pulse.m.workStudy': 'of which both permits', 'pulse.m.asylum': 'of which asylum claimants', 'pulse.m.other': 'of which other permits and family', 'pulse.m.studyNew': 'New study permits', 'pulse.m.gdp': 'GDP (C$ millions)', 'pulse.m.unemp': 'Unemployment rate', 'pulse.m.alloc': 'PNP allocation', 'pulse.m.issued': 'Nominations issued', 'pulse.m.remaining': 'Remaining allocation', 'pulse.m.prAll': 'PR admissions', 'pulse.m.prPnp': 'of which PNP', 'pulse.m.eeInvites': 'EE invitations',

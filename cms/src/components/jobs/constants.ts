...
/**
 * 职位页分享图的画布宽(px)。1200×630 是各家分享卡的通用比例,
 * 改了微信/小红书/TG 会自己裁一刀。
 */
 ...
 */
export const OG_TITLE_LEN = 90

/**
 * 公司名进图前截到这么多字符。
 */
export const OG_COMPANY_LEN = 60

/**
 * 薪资原文进图前截到这么多字符。
 */
export const OG_SALARY_LEN = 40
 ...
 */
export const OG_BRAND_SIZE = 34

/**
 * 顶栏域名小注的字号(px)。
 */
export const OG_DOMAIN_SIZE = 22

/**
 * 顶栏品牌字与域名小注之间的间距(px)。
 */
export const OG_BRAND_GAP = 12

/**
 * 职位名的字号(px)。
 */
export const OG_TITLE_SIZE = 58

/**
 * 职位名的行高倍数(职位名常占两行,行距按字号的这个倍数)。
 */
export const OG_TITLE_LH = 1.2

/**
 * 公司名的字号(px)。
 */
export const OG_COMPANY_SIZE = 34

/**
 * 公司名距职位名的上边距(px)。
 */
export const OG_COMPANY_TOP = 18

/**
 * 地点与薪资两块之间的间距(px)。
 */
export const OG_META_GAP = 24

/**
 * 地点薪资那一行距公司名的上边距(px)。
 */
export const OG_META_TOP = 14

/**
 * 地点与薪资的字号(px)。
 */
export const OG_META_SIZE = 28

/**
 * 信号胶囊(PNP-eligible / TEER n)之间的间距(px)。
 */
export const OG_CHIP_GAP = 12

/**
 * 信号胶囊那一行距地点薪资行的上边距(px)。
 */
export const OG_CHIP_TOP = 22

/**
 * 信号胶囊的字号(px)。
 */
export const OG_CHIP_SIZE = 24
 ...
 * 页脚距上方分隔线的内衬(px)。
 */
export const OG_FOOT_TOP = 22

/**
 * 页脚两行小字的字号(px)。
 */
export const OG_FOOT_SIZE = 24

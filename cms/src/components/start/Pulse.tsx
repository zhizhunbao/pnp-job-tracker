...
import { MarketChart, useMarketStats } from '@/components/stats'
...
import { SponsorCard, sponsorEmployerCols, hasVerdictSignal, type SponsorKind } from '@/components/employers'
  ...
  const pnpProvsCell = (o: OccRow) => {
    ...
    return (
      <span style={{ display: 'block' }}>
        ...
        {/* 「先省内工作 6 个月」灰行 08-08 Frank 拍删(细则归 PNP 弹框 whyCond,榜上只留可走面) */}
      </span>
    )
  }

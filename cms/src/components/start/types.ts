...
/**
 * 一个抽选类别的门槛清单(人工核定表 draw_checklists.json 的一格,mart 拼进 pnp_draws.checklist)。
 */
 ...
 * 门槛清单;null = 没写。
 */
export type MaybeChecklist = Checklist | null

/**
 * `checklistTextOf` 的入参。
 */
export type ChecklistTextIn = {
  /**
   * 一条。
   */
  item: ChecklistItem

...
import {
  BOX_LS_KEY, BTN_SEL, DOCK_BTN, DOCK_GAP, DOCK_LS_KEY, DRAG_SLOP, EV_W_DOCK_DRAG, EV_W_DRAG, EV_W_RESIZE,
  EVT_POINTERCANCEL, EVT_POINTERMOVE, EVT_POINTERUP, GRAB_MOVE, PATH_ROOT, POINTER_MOUSE, SELECT_NONE, TEXT_NONE,
} from './constants'
import {

...
import { quizToProfile, OccPicker, ProvincePicker, QuizStyle, QuizTitle, pickL, type L } from '@/components/quiz'
...
import { TripleVerdictPanel, ConditionGrid, PnpScoreCard } from '@/components/jobs'
...
/** 热门职业一行(与 lib/jobs/queries.loadTopNocs 的返回对齐) */
export type TopNoc = {

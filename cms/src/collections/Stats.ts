...
export const Stats: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'wageLowHourly', type: 'number', admin: { description: 'ESDC 低位时薪(官方工资带下端,同口径桶内中位;2026-09-11 把脉页时薪三件)' } },
    { name: 'wageMedHourly', type: 'number', admin: { description: 'ESDC 中位时薪(同上)' } },
    { name: 'wageHighHourly', type: 'number', admin: { description: 'ESDC 高位时薪(同上)' } },

...
export const Jobs: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'broad', type: 'text', index: true, admin: { description: '大分类(本站浏览分类,etl/noc_buckets.py)' } },
    ...
    { name: 'pilotEmployer', type: 'checkbox', defaultValue: false, admin: { description: '雇主在其所在试点社区的官方指定雇主名单(批B;比城市命中强一级)' } },
    { name: 'pilotOcc', type: 'text', admin: { description: '岗位 NOC × 社区在收清单(yes|no|空=判不了);RCIP 要求 offer 职业在社区清单内' } },
    ...
    { name: 'lastSeen', type: 'date' },
    {
      ...
      defaultValue: 'open',
      index: true,
      options: ['open', 'closed', 'campus'],
      admin: { description: 'open 在招 / closed 下架 / campus 校内板帖(2026-09-13:只进 /coop 页,不上职位板与统计;枚举 DDL docs/sql/jobs-status-campus.sql)' },
    },

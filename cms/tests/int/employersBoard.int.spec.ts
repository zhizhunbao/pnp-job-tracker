...
describe('行构造器', () => {
  it('numeric 列的字符串收成数,可空数值保 null,jsonb 清单成数组', () => {
    const r = toPoolRow({
      key: 'shopify', slug: 'shopify', name: 'Shopify', industry: 'IT', sector: null, province: 'ON', city: 'Ottawa', district: 'Kanata', broads: ['IT', '商务'], ees: ['STEM'], website: 'https://www.shopify.com', x_status: null, x_alias_zh: null, x_alias_ko: null, x_trans_v: null, x_industry: '金融', designated_places: null, city_zh: '渥太华', city_ko: null, trans_v: 1,
  ...
  it('三源独有雇主:slug / 行业 / 季度 为 null 不折空串以外的东西', () => {
    const r = toPoolRow({
      key: 'n:acme', slug: null, name: 'Acme', industry: null, sector: 'municipal', province: 'NB', city: '', district: null, broads: null, ees: null, website: 'shopify.com', x_status: 'done', x_alias_zh: '艾克米', x_alias_ko: null, x_trans_v: 1, x_industry: null, designated_places: ['AIP|NB'], city_zh: null, city_ko: null, trans_v: null, locations: null, designated: true,

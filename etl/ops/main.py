...
STEPS = [
    ...
    # 省提名名额公告哨兵(2026-08-14;沿革:原 ircc 役末步,月→周无害)。
    # 2026-08-31 修断链:watch_prov_allocations.py 已被批B 全溶进 pnp/functions,
    # 跨域走对方域门(域间禁 import),--only 点名 pnp 门的 TOOLS 键
    ["python", "etl/pnp/main.py", "--only", "watch_allocations"],

...
读哪些:raw/httpx/jobbank/<日期>/details/<posting_id>.html 中、对应 posting 还没 detail_fetched 的
...
IN  : data/raw/httpx/jobbank/<日期>/details/<posting_id>.html  (+ processed/jobbank/postings.json)
...
IN_SNAP_ROOT = _paths.RAW_HTTPX_JOBBANK                      # 详情原始 HTML 在各 <日期>/details/ 下

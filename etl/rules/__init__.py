"""
rules 域:联邦试点申请人门槛库(quote-anchored 规则抓取)—— 2026-09-06 立域
(Frank「这种不同省的规则也需要一个单独模块维护吧」)。
...
入口固定 etl/rules/main.py,步骤清单在 main.py 里。
"""
META = {
    "role": "rules",           # 一域一容器(docker-compose 的 rules service)

...
AB_TOURISM_NOTE = ("雇主须属合格旅游酒店行业(官方表 1 的 WCB 行业码)或行业协会成员(表 2);本表只列表 3 的职业,"
                   "其中保洁 / 洗衣 / 娱乐项目负责人这几个哪行都有的码不收。")
"""旅游酒店表的口径说明(雇主行业条件本站判不了,写进注)。"""

AB_TOURISM_GENERIC = {"65310", "65311", "65312", "65320", "54100"}
"""旅游酒店表 3 里不收的通用码(保洁 65310 / 65311 / 65312、洗衣干洗 65320、娱乐项目负责人 54100):写字楼、医院、学校、
社区中心都有,「雇主须属旅游酒店业」这条本站判不了,按码收会把医院保洁也标成旅游酒店通道(2026-09-24 首跑 175 条,
照 NS 建筑去掉通用杂工码的先例,宁可留空)。"""

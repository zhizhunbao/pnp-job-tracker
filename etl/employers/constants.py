...
K_NOC = "noc"
"""jobs 行的职业码(公司行业兜底按它查桶级大类,2026-09-23 大类重排起;见 BROAD_CATEGORY)。"""
...
2026-09-23 大类重排 27 → 23 后,本表的键是**桶级大类**(noc.bucket_broad_of,重排前那一层),不再是 jobs 行的大类:
新大类把会计 / 金融、零售 / 销售、农业 / 矿业各并成一个,并完说不清公司做什么生意;按桶级查,兜底结果与重排前逐家相同。"""

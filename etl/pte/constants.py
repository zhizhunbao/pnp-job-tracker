...
MART_TYPE_ROWS = (
    {"code": "RA", "section": "Speaking", "seq": 1, "nameZh": "朗读", "nameEn": "Read Aloud",
     "nameKo": "소리 내어 읽기", "audio": False, "weight": 16},
    {"code": "RS", "section": "Speaking", "seq": 2, "nameZh": "复述句子", "nameEn": "Repeat Sentence",
     "nameKo": "문장 따라 말하기", "audio": True, "weight": 19},
    {"code": "DI", "section": "Speaking", "seq": 3, "nameZh": "描述图片", "nameEn": "Describe Image",
     "nameKo": "이미지 묘사", "audio": False, "weight": 5},
    {"code": "RTS", "section": "Speaking", "seq": 4, "nameZh": "情景应答", "nameEn": "Respond to a Situation",
     "nameKo": "상황 대응", "audio": True, "weight": 3},
    {"code": "ASQ", "section": "Speaking", "seq": 5, "nameZh": "简答题", "nameEn": "Answer Short Question",
     "nameKo": "짧게 답하기", "audio": True, "weight": 0.5},
    {"code": "SWT", "section": "Writing", "seq": 6, "nameZh": "总结书面文本", "nameEn": "Summarize Written Text",
     "nameKo": "글 요약", "audio": False, "weight": 4},
    {"code": "EMAIL", "section": "Writing", "seq": 7, "nameZh": "写邮件", "nameEn": "Write Email",
     "nameKo": "이메일 쓰기", "audio": False, "weight": 7},
    {"code": "RWFIB", "section": "Reading", "seq": 8, "nameZh": "读写填空", "nameEn": "Reading & Writing: Fill in the Blanks",
     "nameKo": "읽기·쓰기 빈칸 채우기", "audio": False, "weight": 11},
    {"code": "RMCM", "section": "Reading", "seq": 9, "nameZh": "阅读多选", "nameEn": "Multiple Choice, Multiple Answers",
     "nameKo": "객관식(복수 정답)", "audio": False, "weight": 0.5},
    {"code": "ROP", "section": "Reading", "seq": 10, "nameZh": "段落排序", "nameEn": "Re-order Paragraphs",
     "nameKo": "문단 순서 배열", "audio": False, "weight": 2},
    {"code": "RFIB", "section": "Reading", "seq": 11, "nameZh": "阅读填空", "nameEn": "Reading: Fill in the Blanks",
     "nameKo": "읽기 빈칸 채우기", "audio": False, "weight": 6},
    {"code": "RMCS", "section": "Reading", "seq": 12, "nameZh": "阅读单选", "nameEn": "Multiple Choice, Single Answer",
     "nameKo": "객관식(단일 정답)", "audio": False, "weight": 0.5},
    {"code": "SST", "section": "Listening", "seq": 13, "nameZh": "总结口头文本", "nameEn": "Summarize Spoken Text",
     "nameKo": "듣기 요약", "audio": True, "weight": 4},
    {"code": "LMCM", "section": "Listening", "seq": 14, "nameZh": "听力多选", "nameEn": "Multiple Choice, Multiple Answers",
     "nameKo": "듣기 객관식(복수)", "audio": True, "weight": 0.5},
    {"code": "LFIB", "section": "Listening", "seq": 15, "nameZh": "听力填空", "nameEn": "Fill in the Blanks",
     "nameKo": "듣기 빈칸 채우기", "audio": True, "weight": 5},
    {"code": "LMCS", "section": "Listening", "seq": 16, "nameZh": "听力单选", "nameEn": "Multiple Choice, Single Answer",
     "nameKo": "듣기 객관식(단일)", "audio": True, "weight": 0.5},
    {"code": "SMW", "section": "Listening", "seq": 17, "nameZh": "选出缺失词", "nameEn": "Select Missing Word",
     "nameKo": "빠진 단어 고르기", "audio": True, "weight": 0.5},
    {"code": "HIW", "section": "Listening", "seq": 18, "nameZh": "找错词", "nameEn": "Highlight Incorrect Words",
     "nameKo": "틀린 단어 찾기", "audio": True, "weight": 5},
    {"code": "WFD", "section": "Listening", "seq": 19, "nameZh": "听写句子", "nameEn": "Write From Dictation",
     "nameKo": "받아쓰기", "audio": True, "weight": 13},
)
"""题型维度行:PTE Core 19 型全列(2026-09-03 Frank「人家这都带个分类」—— 菜单四栏全列,没题的灰字「整理中」),
三语名 + section + 考试序 + 题面是否音频 + 占分权重(总分 %,猩际 practice 页「占分权重」;<1% 记 0.5)。"""
...
NUM_DATE_SEP = "-"
"""首次领号排序:考过日 YYYY-MM-DD 去掉连字符当整数比大小(新的在前)。"""
...
DICT_CSV_K_DEFINITION = "definition"
"""csv 列:英文释义(行内以字面 `\\n` 分行;韩文等非中文界面用它 —— Frank 2026-09-04「如果是韩国人呢」)。"""

DICT_EXCH_SKIP = ("0", "1")
"""exchange 里不算词形的两个标记:0 = 指回原形,1 = 本词是原形的哪种变化。"""

D_K_DEFINITION = "definition"
"""字典行:英文释义(多义换行分隔;屈折形用原形的)。"""

D_K_FORMS = "forms"
"""字典行:词形变化(`p:took/d:taken/…`,码见前端 FORM_KEY;来自 exchange;空串 = 没有)。"""

DICT_NL = "\n"
"""释义多义之间的真换行(出库形)。"""

DICT_DOMAIN_RE = re.compile(r"^\[([^\]]{1,4})\]")
"""释义行首的领域标签(`[法] …`),出库时整个去掉(Frank 2026-09-04「这种也是多余」)。"""

WN_LEXICON = "oewn:2024"
"""WordNet 词库(Open English WordNet 2024,`python -m wn download oewn:2024` 落本机;派生词族用)。"""

WN_REL_DERIVATION = "derivation"
"""WordNet 的派生关系名(evolution ↔ evolve / evolutionary)。"""

WN_POS_KEEP = ("n", "v", "a")
"""词族只留三种词性:名词 / 动词 / 形容词(Frank 2026-09-04「只列名词动词形容词的形式就可以了」;副词与卫星形容词 s 折进 a)。"""

WN_POS_SAT = "s"
"""WordNet 的卫星形容词码,并进 a。"""

WN_POS_ADJ = "a"
"""形容词码。"""

D_K_FAMILY = "family"
"""字典行:派生词族 JSON 串 {n: [...], v: [...], a: [...]}(不含本词;空对象串 = 没有)。"""

P_DICT_WN_TPL = "  词族(WordNet):有派生 {hit} · 无 {miss}"
"""日志:词族收口。"""

...
聚合键 = norm_name(与 AIP 匹配同一把尺子)。批H2/批I3 时代靠 importlib 按路径拉 aip 的
实现(NORM_MODULE_NAME/PATH 两常量),那笔「待判的收拢账」2026-08-31 Frank 拍板结清:
norm_name 抽成基础设施叶 names 域,本域改正规 import,路径缝与两常量随之退役。"""

...
"""norm_name 宿主模块的 importlib 名(05c 数字开头,常规 import 拉不动)。"""

NORM_MODULE_PATH = Path(__file__).resolve().parent.parent / "clean" / "05c_flag_aip.py"
"""聚合键 = 05c 的 norm_name(与 AIP 匹配同一把尺子,mart join 时对 companies 用同一函数)——
住 clean/05c 单一来源,这里只拉不复制。"""

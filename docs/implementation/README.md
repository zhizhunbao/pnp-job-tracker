...
| [E8-02](E8-UI体验统一/02_全站弹窗化导航.md) | 全站弹窗化导航(定价先行,去「返回」) | 3 | 4 | [x] 定价/榜单/统计弹窗+去返回;/account 弹窗化留拍板 |
| [E8-03](E8-UI体验统一/03_移动自适应一揽子.md) | 移动自适应一揽子(375px 全站可用) | 4 | 4 | [~] 弹窗全屏+筛选抽屉+全页 375 走查 0 溢出✅;剩触控/登录态抽查 |
| [E8-04](E8-UI体验统一/04_字段内容质量与数据缺口.md) | 字段内容质量与数据缺口(每字段高质量+缺则抓) | 8 | 4 | [~] 数据盘点✅+公司事实段增强;剩 D1(公司落库 A/B)拍板 |
| [E6-12](E6-数据补强/12_薪资年化诚实护栏.md) | 薪资年化诚实护栏(计次价不年化+时薪>150 置空) | 1 | — | [x] |
| [L1-01](L1-用户目标层/01_landing页.md) | **Landing 页**(架构 v2.0 目标层:banner 首屏+七目标入口) | 4 | — | ☐ 设计定稿+效果图✅;剩根域路由 A/B 拍板 |
| [L2-01](L2-决策引擎/01_七目标决策树.md) | **七目标决策树**(答题与分析两态分离,画像=可叠加标签) | 6 | — | ☐ 设计定稿+画像卡效果图✅ |
| [L2-02](L2-决策引擎/02_题库.md) | **题库**(每卡一套题,四选一,基本+探索 → 报告) | 4 | — | ☐ 题单定稿 |
| [E13-00](E13-把脉首页/00_总设计与口径.md) | **把脉首页总设计**(三页合一+派生指标口径 v3) | — | — | [x] 定稿 |
| E13-01 | OG metadataBase 修复(分享卡 localhost bug) | 1 | — | [x] |
| E13-02 | ETL 派生指标(new14d/mom14d/avg_days_open/pulse_score+判死台账) | 4 | — | [x] |
| E13-03 | 把脉首页 S1-S7 + 三页合一 + /stats 索引与跨省对比退役 | 6 | — | [x] 2026-08-06 生产已验(title/301/OG 三件套) |
| E13-04 | 净值/净流失榜启用(台账稳态后)+ 排名中心 + AIP 雇主榜 | — | — | ☐ 约 9 月初 |
| [E14-01](E14-全市场数据三角/01_JVWS官方接入.md) | 全市场数据三角①:StatCan JVWS 官方接入(全市场分母) | 3 | — | [~] 数据面✅(raw+mart+DDL草稿+验算);seed接线待担保率口径拍板 |
| E14-02+ | Indeed MVP + LinkedIn 探针 + 担保率消费端 | — | — | ☐ 待排 |

...
| [E8-02](E8-UI体验统一/02_全站弹窗化导航.md) | 全站弹窗化导航(定价先行,去「返回」) | 3 | 4 | [~] 定价弹窗+去返回✅;剩榜单/统计弹窗化 |
| [E8-03](E8-UI体验统一/03_移动自适应一揽子.md) | 移动自适应一揽子(375px 全站可用) | 4 | 4 | [~] /jobs+弹窗全屏✅(375 实测 0 溢出);剩筛选折叠+其余页走查 |

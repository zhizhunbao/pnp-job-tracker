...
| 编号 | 工作项 | SP | Sprint | 状态 |
|---|---|---|---|---|
| [E1-01](E1-收尾与合流/01_分支合main与容器同步.md) | 分支合 main 与容器同步 | 2 | 0 | ☐ |
| [E1-02](E1-收尾与合流/02_EE抓取改httpx.md) | EE 类别抓取改 httpx | 1 | 0 | ☐ |
| [E1-03](E1-收尾与合流/03_postings原子写.md) | postings 原子写竞态修复 | 1 | 0 | ☐ |
...
| [E5-00](E5-商业化功能/00_用户档案与匹配层.md) | **用户档案与匹配层（付费墙头牌）** | 7 | 1-2 | ☐ |
| [E5-01](E5-商业化功能/01_定价与落地页.md) | 定价页 + 落地横幅 | 4 | 2 | ☐ |
| [E5-02](E5-商业化功能/02_榜单F8第一批.md) | 榜单 F8 第一批（rankings 维度 + 页面 + 抽选快报） | 4 | 2 | ☐ |
| [E5-03](E5-商业化功能/03_邮件职位提醒.md) | 邮件提醒（**匹配版**：命中我的路径才发信） | 5 | 3 | ☐ |
| [E5-04](E5-商业化功能/04_地区统计与城市对比v1.md) | 地区统计与城市对比 v1（三问之「去哪」） | 6 | 2-3 | ☐ |
| [E6-01](E6-数据补强/01_PE_AIP_RNIP_去重.md) | 数据补强：PE AIP / RNIP / 内容级去重（**已让位**，入学后再排） | 4 | — | ☐ |
| [E7-01](E7-运维与增长/01_监控告警与备份.md) | 监控告警 + 库备份 | 4 | 3 | ☐ |
| [E7-02](E7-运维与增长/02_Analytics埋点.md) | Analytics 与转化埋点 | 2 | 2 | ☐ |
| [E7-03](E7-运维与增长/03_SEO与冷启动获客.md) | SEO 基建 + 冷启动获客 | 3 | 3 | ☐ |

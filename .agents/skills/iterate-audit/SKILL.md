...
```bash
python .Codex/skills/iterate-audit/scripts/checkup.py --round <N> --out <scratchpad>/checkup-<N>.json
```
...
```bash
python .Codex/skills/iterate-audit/scripts/capture_desktop.py --out <scratchpad>/shots
python .Codex/skills/iterate-audit/scripts/capture_mobile.py --out <scratchpad>/shots
python .Codex/skills/iterate-audit/scripts/process_shots.py --src <scratchpad>/shots
```

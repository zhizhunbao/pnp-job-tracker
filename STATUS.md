...
> - **下轮队列(付费透镜序)**:GAP1③ JD 身份预筛(no sponsorship/must be PR 检测列,零新抓取;代码+DDL 备好交 Frank)→ E11-07 简历上传立项 → 节奏块喂 match/提醒(C6 二期,EE 历史入库);多雇主对比=Pro 候选;#65 余批顺手;微信群/Reddit 发布(Frank)。
>

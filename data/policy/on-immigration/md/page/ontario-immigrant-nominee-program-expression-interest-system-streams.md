---
source: https://www.ontario.ca/page/ontario-immigrant-nominee-program-expression-interest-system-streams
title: "Ontario Immigrant Nominee Program expression of interest system streams | ontario.ca"
fetched: 2026-06-19T18:16:09-04:00
---

# Ontario Immigrant Nominee Program expression of interest system streams

Learn how to apply for a nomination for permanent residence in Ontario if you are an international student, you have a job offer or you are a physician.
...
The Ontario Immigrant Nominee Program (OINP) uses an expression of interest (EOI) system to manage its applications for the following streams:

- [Employer Job Offer: Foreign Worker stream](https://www.ontario.ca/page/oinp-employer-job-offer-foreign-worker-stream)
- [Employer Job Offer: International Student stream](https://www.ontario.ca/page/oinp-employer-job-offer-international-student-stream)
- [Employer Job Offer: In-Demand Skills stream](https://www.ontario.ca/page/oinp-employer-job-offer-demand-skills-stream)
- [Masters Graduate stream](https://www.ontario.ca/page/oinp-masters-graduate-stream)
- [PhD Graduate stream](https://www.ontario.ca/page/oinp-phd-graduate-stream)
...
Note that expressions of interest or applications submitted under the OINP, where the Ontario Public Service (OPS) or an OPS entity is listed as the employer, will not be accepted. This is due to the OPS not currently participating in the OINP.
...
If you are applying under an Employer Job Offer stream (Foreign Worker, International Student, or In-Demand Skills), these are the steps to register an expression of interest:

1. Your employer must first register their business in the Employer Portal and provide information about your position by submitting a job offer in the portal (we call it a “job offer” even if you are already working in that position). Your employer can refer to the [Employer Portal User Guide](https://www.ontario.ca/page/how-use-employer-portal-ontario-immigrant-nominee-program) to learn more.
2. You will automatically receive an email with a job offer ID, which you will need in order to register your expression of interest.
3. Access the [e-Filing Portal](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/guest/index.html#!/) and select the stream under which your employer submitted your job offer. You will be prompted to input the job offer ID and your email address.

You will have 30 calendar days from the date of the job offer was submitted to register your expression of interest (EOI). If you do not register your EOI within 30 calendar days, the job offer will expire. If you still wish to register an expression of interest, your employer will need to submit a new job offer.

#### Masters or PhD Graduate streams

Access the [OINPe-filing portal](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/guest/index.html#!/) to create a profile and register an expression of interest for the stream you are interested in.
...
You can update your personal information in your expression of interest through the OINP e-filing portal at any time up until you receive an invitation to apply or your expression of interested is deleted.

Note that you will not be able to update your NOC and hourly wage as they will be pre-populated. If your employer needs to change the wage or the NOC code attributed to the job offer, they will need to withdraw the job offer and submit a new one. In that case, you will need to register a new expression of interest.
...
If you are a physician who is eligible to apply without a job offer, please [contact us](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/home/index.html#!/form) to begin the process of registering an Expression of Interest.

[Register an expression of interest](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/guest/index.html#!/)
...
If you are invited to apply, you will receive a notification in the [OINPe-Filing Portal](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/guest/index.html#!/). It is important to note that:
...
Please consult the [Applying to the Ontario Immigrant Nominee Program (OINP)](https://www.ontario.ca/page/applying-ontario-immigrant-nominee-program-oinp#section-2) page for instructions on how to apply after you receive an invitation to apply.

#### Deadline: Masters or PhD Graduate streams

Submit your application within 14 calendar days from the date we issued the invitation to apply.

#### Deadlines: Employer Job Offer streams

**Employer deadline:** submit the application for the approval of an employment position within 14 calendar days from the date we issued the invitation to apply

**Your deadlines as applicant**: submit your application and pay:

- **within 17 calendar days** from the date we issued the invitation to apply
- **after** your employer submits their application for approval of the employment position (you can work on your application any time during the 17 days, but cannot submit it until after your employer submits the application for approval of an employment position)
...
You will receive an email notification that your expression of interest has been removed from the selection pool. If you wish to register a new expression of interest under an Employer Job Offer stream (Foreign Worker, International Student, or In-Demand Skills), your employer must first submit a new job offer.

## Using a representative to apply

Authorizing a paid representative to assist you can be helpful but is not necessary. If you choose to use a representative, please follow the [steps on how to appoint one](https://www.ontario.ca/page/oinp-representatives#section-2). This will ensure you retain access to, and control of, your online application and allow you to change or end your authorization if need be. Applications submitted by self-appointed representatives are invalid and will be withdrawn by the OINP. Your application will be returned as incomplete and your application fee will be refunded.
...
##### Job offer: broad occupational category (prepopulated in the EOI based on job offer)
...
For more information about Fields of Study please review the [Statistics Canada website](https://www23.statcan.gc.ca/imdb/p3VD.pl?Function=getVD&TVD=1486451).

##### Canadian education experience

Credential must be for a post-secondary education credential from an [eligible Canadian institution](https://www.ontario.ca/page/oinp-employer-job-offer-international-student-stream#section-7) that takes at least one year to complete on a full-time basis.
...
You can check the status of your application through your account in the [OINPe-Filing Portal](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/guest/index.html#!/) at any time.

For regular updates on processing times, read [OINPApplication processing times and nominations issued](https://www.ontario.ca/page/oinp-application-processing-times-and-nominations-issued).

If you are nominated, your next step is to apply to the [federal government through Immigration, Refugees and Citizenship Canada (IRCC)](https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/provincial-nominees/application-process/paper.html) for permanent residence. IRCC makes the final decision on who becomes a permanent resident.
...
- family composition due to:marriage or common-law relationshipbirth of a childchange of custody of a childdivorce/separationdeath
...
- complete and save a [Change of Personal Information](https://forms.mgcs.gov.on.ca/en/dataset/009-0161) form
- send the completed form as an attachment via our [webform](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/home/index.html#!/form)
...
You can request an extension via our [webform](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/home/index.html#!/form). Please include the following documents:
...
1. Log into the OINP e-Filing Portal through your Ontario.ca Login.
...
Use our [Stream Selector Tool](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/home/index.html#!/selector) to identify which OINP stream you may be eligible for.

## Technical problems

If you are experiencing technical issues with applying online, please notify us via our [webform](https://www.ontarioimmigration.gov.on.ca/oinp_index/resources/app/home/index.html#!/form) and include:
...
Updated: May 29, 2026Published: April 28, 2021
